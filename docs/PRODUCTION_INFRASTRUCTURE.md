...
| 内部 | 5432 (PostgreSQL) | 127.0.0.1:5432 | 仅本机访问 |
| 内部 | 6379 (Redis) | 127.0.0.1:6379 | 仅本机访问 |
| 内部 | 9090 (Prometheus) | 127.0.0.1:9090 | 仅本机访问 |
| 内部 | 3001 (Grafana) | 127.0.0.1:3001 | 通过 Nginx 反代 |
| 内部 | 3100 (Loki) | 127.0.0.1:3100 | 仅本机访问 |
| 内部 | 16686 (Jaeger) | 127.0.0.1:16686 | 通过 Nginx 反代 |
