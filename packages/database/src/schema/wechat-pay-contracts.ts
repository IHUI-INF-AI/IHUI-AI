...
export const wechatPayContracts = pgTable(
  'wechat_pay_contracts',
  {
    ...
    outContractCode: varchar('out_contract_code', { length: 64 }),
    preEntrustwebId: varchar('pre_entrustweb_id', { length: 128 }),
    contractState: varchar('contract_state', { length: 30 }),
    contractExpiredAt: timestamp('contract_expired_at', { withTimezone: true }),
