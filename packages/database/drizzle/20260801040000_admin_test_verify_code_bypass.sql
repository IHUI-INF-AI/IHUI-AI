...
--
-- 目标:
--   admin 账号(email=[REDACTED-EMAIL] / phone=[REDACTED-PHONE])测试登录时
...
VALUES
  ('[REDACTED-EMAIL]', '123456', true, 'system admin email bypass'),
  ('[REDACTED-PHONE]', '123456', true, 'system admin phone bypass')
