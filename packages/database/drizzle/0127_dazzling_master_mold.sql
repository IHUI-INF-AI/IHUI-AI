CREATE TABLE IF NOT EXISTS "resource_github_projects" (
...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "t_course_recommend" (
	"id" bigserial PRIMARY KEY NOT NULL,
...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "t_course_recommend_log" (
	"id" bigserial PRIMARY KEY NOT NULL,
...
ALTER TABLE "orders" ADD COLUMN IF NOT EXISTS "updated_by" uuid;--> statement-breakpoint
ALTER TABLE "commission_flows" ADD COLUMN IF NOT EXISTS "updated_by" uuid;--> statement-breakpoint
ALTER TABLE "commission_flows" ADD COLUMN IF NOT EXISTS "updated_at" timestamp with time zone DEFAULT now() NOT NULL;--> statement-breakpoint
ALTER TABLE "withdrawal_flows" ADD COLUMN IF NOT EXISTS "updated_by" uuid;--> statement-breakpoint
ALTER TABLE "oauth_apps" ADD COLUMN IF NOT EXISTS "client_secret_hash" text;--> statement-breakpoint
...
ALTER TABLE "agent_tasks" ADD COLUMN IF NOT EXISTS "updated_by" uuid;--> statement-breakpoint
ALTER TABLE "oauth_private_keys" ADD COLUMN IF NOT EXISTS "encryption_key_id" varchar(256);--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "resource_github_projects_category_idx" ON "resource_github_projects" USING btree ("category");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "t_clazz_school_idx" ON "t_clazz" USING btree ("school_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "t_clazz_grade_idx" ON "t_clazz" USING btree ("grade_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "t_knowledge_point_parent_idx" ON "t_knowledge_point" USING btree ("parent_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "t_course_recommend_course_idx" ON "t_course_recommend" USING btree ("course_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "t_course_recommend_member_idx" ON "t_course_recommend" USING btree ("member_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "t_course_recommend_log_recommend_idx" ON "t_course_recommend_log" USING btree ("recommend_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "ix_agent_memory_episodic_user" ON "agent_memory_episodic" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "ix_agent_memory_episodic_session" ON "agent_memory_episodic" USING btree ("session_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "ix_agent_memory_episodic_importance" ON "agent_memory_episodic" USING btree ("importance_score");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "ix_agent_memory_procedural_user" ON "agent_memory_procedural" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "ix_agent_memory_procedural_tool" ON "agent_memory_procedural" USING btree ("tool_name");--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "ux_agent_memory_procedural_user_pattern_tool" ON "agent_memory_procedural" USING btree ("user_id","pattern","tool_name");--> statement-breakpoint
...
CREATE UNIQUE INDEX IF NOT EXISTS "token_flows_order_op_unique_idx" ON "token_flows" USING btree ("related_order_no","op_type");--> statement-breakpoint
