...
async function main() {
  ...
  console.info('[1/7] 导入 AI 行业分类...')
  await seedAiCategories()
  console.info('')

  // 2. 课程数据
  console.info('[2/7] 导入课程数据...')
  await seedLessons()
  console.info('')

  // 3. AI 教学资源
  console.info('[3/7] 导入 AI 教学资源...')
  await seedAiTutorials()
  console.info('')

  // 4. 2026-07 真实 AI 资讯(直播/考试/资讯/文章/问答/社区/知识库)
  console.info('[4/7] 导入 2026-07 真实 AI 资讯(WebSearch 抓取)...')
  await seedAiFresh2026()
  console.info('')

  // 5. 跨领域数据(8 领域 80 条:科技/教育/金融/医疗/机器人/AI 艺术/创业投资/政策法规)
  console.info('[5/7] 导入跨领域数据(8 领域 80 条)...')
  await seedCrossDomain()
  console.info('')

  // 6. RBAC 权限点(214 条权限码 + admin 角色绑定)
  console.info('[6/7] 导入 RBAC 权限点...')
  await seedPermissions()
  console.info('')

  // 7. 默认登录用户(test / admin)
  console.info('[7/7] 导入默认用户...')
  await seedUsers()
  console.info('')
