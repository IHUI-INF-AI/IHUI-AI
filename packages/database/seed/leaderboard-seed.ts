...
const llmGeneral: Entry[] = [
  {
    ...
    highlight: 'Anthropic 旗舰模型,综合能力全面领先',
  ...
  },
  {
    ...
    highlight: 'Opus 4.6 升级版,推理能力进一步提升',
  ...
  },
  {
    ...
    outputPrice: '$25',
    releaseDate: '2026-07-10',
    highlight: '非 thinking 版本,响应速度快,通用能力强',
  ...
  },
  {
    ...
    highlight: 'Meta 开源旗舰,1M 上下文,性价比极高',
  ...
  },
  {
    ...
    highlight: 'Meta 首代 Muse Spark,长文本理解优秀',
  ...
  },
  {
    ...
    highlight: 'Google 旗舰,2M 超长上下文,多模态融合',
  ...
  },
  {
    ...
    outputPrice: '开源',
    releaseDate: '2026-07-17',
    highlight: '月之暗面 2.8 万亿参数开源模型,国产之光',
  ...
  },
  {
    ...
    highlight: 'OpenAI 编程特化型号,代码生成强劲',
...
const llmCoding: Entry[] = [
  ...
  {
    modelId: 'claude-opus-4-7#coding',
    modelName: 'Claude Opus 4.7',
    vendor: 'Anthropic',
    category: 'llm',
    subcategory: 'coding',
  ...
  {
    modelId: 'claude-opus-4-8-thinking#coding',
  ...
  {
    modelId: 'claude-opus-4-8#coding',
  ...
  {
    modelId: 'claude-opus-4-6-thinking#coding',
    modelName: 'Claude Opus 4.6 Thinking',
    vendor: 'Anthropic',
    category: 'llm',
    subcategory: 'coding',
  ...
  {
    modelId: 'claude-opus-4-6#coding',
    modelName: 'Claude Opus 4.6',
    vendor: 'Anthropic',
    category: 'llm',
    subcategory: 'coding',
  ...
  {
    modelId: 'claude-sonnet-4-6#coding',
...
const llmReasoning: Entry[] = [
  ...
  {
    modelId: 'claude-opus-4-6-thinking#reasoning',
    modelName: 'Claude Opus 4.6 Thinking',
    vendor: 'Anthropic',
    category: 'llm',
    subcategory: 'reasoning',
  ...
  {
    modelId: 'claude-opus-4-7-thinking#reasoning',
    modelName: 'Claude Opus 4.7 Thinking',
    vendor: 'Anthropic',
    category: 'llm',
    subcategory: 'reasoning',
  ...
  {
    modelId: 'claude-opus-4-6#reasoning',
    modelName: 'Claude Opus 4.6',
    vendor: 'Anthropic',
    category: 'llm',
    subcategory: 'reasoning',
  ...
  {
    modelId: 'claude-opus-4-7#reasoning',
    modelName: 'Claude Opus 4.7',
    vendor: 'Anthropic',
    category: 'llm',
    subcategory: 'reasoning',
  ...
  {
    modelId: 'muse-spark-1-1#reasoning',
    modelName: 'Muse Spark 1.1',
    vendor: 'Meta',
    category: 'llm',
    subcategory: 'reasoning',
  ...
  {
    modelId: 'gemini-3-pro#reasoning',
    modelName: 'Gemini 3 Pro',
    vendor: 'Google',
    category: 'llm',
    subcategory: 'reasoning',
...
const imageModels: Entry[] = [
  ...
  {
    modelId: 'gpt-image-1-5-high-fidelity',
    modelName: 'GPT Image 1.5 High Fidelity',
    vendor: 'OpenAI',
    category: 'image',
    subcategory: null,
    arenaScore: 1240,
...
const videoModels: Entry[] = [
  ...
  {
    modelId: 'veo-3-1-audio-1080p',
    modelName: 'Veo 3.1 Audio 1080p',
    vendor: 'Google',
    category: 'video',
    subcategory: null,
    arenaScore: 1364,
  ...
  {
    modelId: 'veo-3-1-audio',
    modelName: 'Veo 3.1 Audio',
    vendor: 'Google',
    category: 'video',
    subcategory: null,
    arenaScore: 1364,
  ...
  {
    modelId: 'veo-3-1-fast-audio',
    modelName: 'Veo 3.1 Fast Audio',
    vendor: 'Google',
    category: 'video',
    subcategory: null,
    arenaScore: 1362,
  ...
  {
    modelId: 'veo-3-1-fast-audio-1080p',
    modelName: 'Veo 3.1 Fast Audio 1080p',
    vendor: 'Google',
    category: 'video',
    subcategory: null,
    arenaScore: 1360,
  ...
  {
    modelId: 'grok-imagine-video-720p',
    modelName: 'Grok Imagine Video 720p',
    vendor: 'SpaceXAI',
    category: 'video',
    subcategory: null,
    arenaScore: 1352,
...
const agentModels: Entry[] = [
  ...
  },
  {
    ...
    modelName: 'Claude Sonnet 5 High',
    vendor: 'Anthropic',
    category: 'agent',
    subcategory: null,
    arenaScore: 800,
...
const embeddingModels: Entry[] = [
  ...
  },
  {
    ...
    modelName: 'Gemini Embedding Exp',
    vendor: 'Google',
    category: 'embedding',
    subcategory: null,
    arenaScore: 1370,
