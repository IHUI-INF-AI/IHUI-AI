  ...
  const channels = [
    {
      ...
      category: 'AI 前沿发布',
      lecturer: 'AI 前沿观察',
      cover: 'https://images.ctfassets.net/kftzwdyauwt9/3T0kxQLJk1VcXVxMwXF97J/4345df401f2b08ed6a1eef88c9588d2e/OAI_ChatGPTWork_ModelBlog_OpenGraph_16x9_1200x630.png?w=1600&h=900&fit=fill',
      isLive: true,
      sort: 100,
    },
    {
      ...
      category: 'AI 工程师实战',
      lecturer: '王立铭',
      cover: 'https://cdn.sanity.io/images/4zrzovbb/website/2039cc549c023bc855671308211d20d3382828a9-2880x1620.jpg',
      isLive: true,
      sort: 99,
    },
    {
    ...
    },
    {
      ...
      category: 'AI 工程师实战',
      lecturer: '王立铭',
      cover: 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2f/Google_DeepMind_logo.svg/1024px-Google_DeepMind_logo.svg.png',
      isLive: false,
      sort: 97,
    },
    {
      ...
      category: 'AI 学术研究',
      lecturer: 'AI 前沿观察',
      cover: 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/33/Neural_network_example.svg/1280px-Neural_network_example.svg.png',
      isLive: false,
      sort: 96,
    },
    {
      ...
      cover: 'https://static.www.tencent.com/uploads/2026/07/06/10c8b5b34b4793c92e448b2656379b6e.png!article.cover',
      isLive: false,
      sort: 95,
    },
    {
      ...
      category: 'AI 前沿发布',
      lecturer: 'AI 前沿观察',
      cover: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/05/Shanghai_Oriental_Pearl_Tower.jpg/1280px-Shanghai_Oriental_Pearl_Tower.jpg',
      isLive: true,
      sort: 94,
    },
    {
    ...
    },
    {
      ...
      category: 'AI 产业应用',
      lecturer: 'AI 前沿观察',
      cover: 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2e/Atlas_%282024%29_DH1.jpg/1280px-Atlas_%282024%29_DH1.jpg',
      isLive: false,
      sort: 91,
    },
  ]
...
模型严格内部使用,永不公开部署。`,
      category: 'AI 安全与治理',
      author: 'OpenAI 官方',
      cover: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/4d/OpenAI_Logo.svg/1024px-OpenAI_Logo.svg.png',
      sort: 96,
      isPinned: false,
    },
    {
...
强大的记忆能力以及适配模型原生的层级化记忆系统,意味着 Agentic AI 正从模型能力逐步走向用户体验层面的范式跃迁。`,
      category: 'AI 学术前沿',
      author: '新智元',
      cover: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a6/Artificial_intelligence_logo.svg/1024px-Artificial_intelligence_logo.svg.png',
      sort: 93,
      isPinned: false,
    },
    {
...
AI Stack Weekly 观点:"硬件 GPU 性能每两年翻倍,超过摩尔定律"——黄仁勋法则继续在 AI 时代生效。`,
      ...
      cover: 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2f/SK_Hynix_logo.svg/1024px-SK_Hynix_logo.svg.png',
      sort: 89,
      isPinned: false,
    },
    {
...
阿里、字节、京东等大厂已开始在内部 AI 工具链中集成 GLM-5.2 作为 GPT-5.6 / Claude 的替代方案。`,
      category: 'AI 模型发布',
      author: '智谱 AI',
      cover: 'https://raw.githubusercontent.com/zai-org/GLM-5/refs/heads/main/resources/bench_52.png',
      sort: 87,
      isPinned: false,
    },
    {
...
- 企业客户可与 Azure 现有服务深度集成`,
      category: 'AI 产业动态',
      author: 'Microsoft 官方',
      cover: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/96/Microsoft_logo_%282012%29.svg/1024px-Microsoft_logo_%282012%29.svg.png',
      sort: 86,
      isPinned: false,
    },
    {
...
LinkedIn 报告同时指出,**AI 工程师将可能是十年内需求最高的工程岗位**。`,
      category: 'AI 产业动态',
      author: 'LinkedIn',
      cover: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/01/LinkedIn_Logo.svg/1280px-LinkedIn_Logo.svg.png',
      sort: 85,
      isPinned: false,
    },
  ]
...
async function seedResources() {
  ...
  for (const r of resourcesData) {
    ...
    await db.insert(resources).values({
      title: r.title,
      intro: r.intro,
      coverImage: r.title.includes('GPT') ? 'https://images.ctfassets.net/kftzwdyauwt9/3T0kxQLJk1VcXVxMwXF97J/4345df401f2b08ed6a1eef88c9588d2e/OAI_ChatGPTWork_ModelBlog_OpenGraph_16x9_1200x630.png?w=1600&h=900&fit=fill'
  : r.title.includes('Claude') ? 'https://cdn.sanity.io/images/4zrzovbb/website/2039cc549c023bc855671308211d20d3382828a9-2880x1620.jpg'
  : r.title.includes('Kimi') ? 'https://statics.moonshot.cn/kimi-blogs/kimi-k3/game-cases/01-open-world.png'
  : r.title.includes('Grok') ? 'https://x.ai/images/news/grok-4-5-og.png'
  : r.title.includes('DeepSeek') ? 'https://cdn.deepseek.com/images/deepseek-chat-open-graph-image.jpeg'
  : r.title.includes('混元') || r.title.includes('Hunyuan') ? 'https://static.www.tencent.com/uploads/2026/07/06/10c8b5b34b4793c92e448b2656379b6e.png!article.cover'
  : r.title.includes('GLM') || r.title.includes('智谱') ? 'https://raw.githubusercontent.com/zai-org/GLM-5/refs/heads/main/resources/bench_52.png'
