...
async function seedLive() {
  ...
  for (const c of cats) {
    ...
    if (ex) catMap[c.name] = ex.id
      ...
      const [ins] = await db.insert(liveCategories).values({ name: c.name, sort: c.sort, status: 1 }).returning({ id: liveCategories.id })
  ...
  // 2. 讲师
  const lecturers = [
    { name: 'AI 前沿观察', title: 'AI 行业分析师', avatar: 'https://api.dicebear.com/9.x/initials/svg?seed=AI' },
    { name: '王立铭', title: 'AI 科学家', avatar: 'https://api.dicebear.com/9.x/initials/svg?seed=WLM' },
    { name: 'TechCrunch 中文', title: '科技媒体', avatar: 'https://api.dicebear.com/9.x/initials/svg?seed=TC' },
  ]
  ...
  for (const l of lecturers) {
    ...
    if (ex) lectMap[l.name] = ex.id
      ...
      const [ins] = await db.insert(liveLecturers).values({ ...l, status: 1 }).returning({ id: liveLecturers.id })
  ...
  const channels = [
    {
      ...
      intro: 'OpenAI 于 2026 年 7 月 9 日正式发布 GPT-5.6 系列,Sol/Terra/Luna 三档分层,本场直播拆解 Sol 在 Coding Agent Index 上 80 分领先的实战表现。',
      category: 'AI 前沿发布',
      lecturer: 'AI 前沿观察',
      cover: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=OpenAI%20GPT-5.6%20Sol%20futuristic%20AI%20model%20launch%20dark%20tech%20stage&image_size=landscape_16_9',
      isLive: true,
      sort: 100,
    },
    {
      title: 'Claude Sonnet 5 智能体能力实战:从 0 到 1 搭建 Agent 工作流',
      intro: 'Anthropic 在 7 月 1 日发布 Claude Sonnet 5,号称迄今为止最具智能体能力的中端模型。本场演示 Sonnet 5 在 BrowseComp、OSWorld-Verified 等智能体评测中的突破。',
      category: 'AI 工程师实战',
      lecturer: '王立铭',
      cover: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=Anthropic%20Claude%20Sonnet%205%20agent%20workflow%20diagram%20dark%20modern&image_size=landscape_16_9',
      isLive: true,
      sort: 99,
    },
    {
      title: 'Kimi K3 2.8 万亿参数开源大模型深度拆解',
      intro: '月之暗面 7 月 17 日在 WAIC 2026 发布 Kimi K3,2.8 万亿参数,原生视觉理解,100 万 token 上下文。本场剖析它在编程、视觉、长程任务上的综合表现。',
      category: 'AI 前沿发布',
      lecturer: 'AI 前沿观察',
      cover: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=Moonshot%20Kimi%20K3%20open%20source%20LLM%202.8%20trillion%20parameters%20modern%20tech&image_size=landscape_16_9',
      isLive: true,
      sort: 98,
    },
    {
      title: 'Gemini 3.5 Pro 前端代码生成王者:从设计稿到生产级 UI',
      intro: 'Google DeepMind 7 月 17 日发布 Gemini 3.5 Pro,2M 上下文 + 全新"深度思考"模式,SVG 生成与前端页面一次成型。本场展示实际项目对比 Fable 5 的优势。',
      category: 'AI 工程师实战',
      lecturer: '王立铭',
      cover: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=Google%20Gemini%203.5%20Pro%20frontend%20code%20generation%20UI%20design%20modern&image_size=landscape_16_9',
      isLive: false,
      sort: 97,
    },
    {
      title: 'ICML 2026 杰出论文精读:扩散语言模型的灵活性陷阱与 A3C 时间检验奖',
      intro: 'ICML 2026 在首尔公布年度奖项,清华-阿里《The Flexibility Trap》与 MIT-Yale 扩散采样研究获杰出论文奖,DeepMind A3C 时隔十年再获时间检验奖。',
      category: 'AI 学术研究',
      lecturer: 'AI 前沿观察',
      cover: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=ICML%202026%20machine%20learning%20conference%20Seoul%20academic%20modern&image_size=landscape_16_9',
      isLive: false,
      sort: 96,
    },
    {
      title: '腾讯混元 Hy3 开源实战:295B MoE 在办公自动化场景的真实表现',
      intro: '腾讯 7 月 6 日发布混元 Hy3,Apache 2.0 协议开源,256K 上下文,WorkBuddy 任务解决率从 72% 提升到 90%。本场演示金融建模与前端设计场景。',
      category: 'AI 产业应用',
      lecturer: 'TechCrunch 中文',
      cover: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=Tencent%20Hunyuan%20Hy3%20AI%20model%20office%20automation%20enterprise%20modern&image_size=landscape_16_9',
      isLive: false,
      sort: 95,
    },
    {
      title: 'WAIC 2026 主论坛现场直播:理查德·萨顿强化学习主旨演讲',
      intro: '2026 WAIC 主论坛 7 月 17 日 14:00 启幕,强化学习之父理查德·萨顿做主旨演讲,凯文·凯利、约书亚·本吉奥、姚期智同台,主题"智能伙伴 共创未来"。',
      category: 'AI 前沿发布',
      lecturer: 'AI 前沿观察',
      cover: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=WAIC%202026%20Shanghai%20main%20forum%20Richard%20Sutton%20reinforcement%20learning%20modern&image_size=landscape_16_9',
      isLive: true,
      sort: 94,
    },
    {
      title: 'Grok 4.5 + Cursor 编码实战:在 1.5 万亿参数模型上做 Code Review',
      intro: 'xAI 7 月 8 日发布 Grok 4.5,SpaceX 600 亿美元收购 Cursor 后首次深度整合。本场展示 Grok 4.5 在大型 Next.js / Docker 项目重构中的实战表现。',
      category: 'AI 工程师实战',
      lecturer: '王立铭',
      cover: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=xAI%20Grok%204.5%20Cursor%20coding%20code%20review%20modern%20tech&image_size=landscape_16_9',
      isLive: false,
      sort: 93,
    },
    {
      title: 'DeepSeek V4 峰谷定价 + DSpark 加速:从 V3 迁移到 V4 实战',
      intro: '7 月 24 日 V3 API ID 永久停用。本场演示 V4 峰谷定价最优利用策略(19:00 - 次日 9:00 调用),DSpark 框架部署,V4-Flash 缓存命中 0.14 元 / 1M tokens。',
      category: 'AI 工程师实战',
      lecturer: 'TechCrunch 中文',
      cover: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=DeepSeek%20V4%20peak%20pricing%20DSpark%20migration%20enterprise%20modern&image_size=landscape_16_9',
      isLive: true,
      sort: 92,
    },
    {
      title: '智元远征 A3 Ultra 人形机器人:WAIC 2026 十大镇馆之宝',
      intro: '智元机器人全尺寸人形机器人远征 A3 Ultra 入选 WAIC 2026 十大"镇馆之宝",唯一入选的具身智能机器人。本场直击 208 款具身智能终端,300+ 台真机演示。',
      category: 'AI 产业应用',
      lecturer: 'AI 前沿观察',
      cover: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=Zhiyuan%20Yuanzheng%20A3%20Ultra%20humanoid%20robot%20WAIC%20modern%20tech&image_size=landscape_16_9',
      isLive: false,
      sort: 91,
    },
  ]
...
async function seedExam() {
  ...
  for (const c of cats) {
    ...
    if (ex) catMap[c.name] = ex.id
      ...
      const [ins] = await db.insert(examCategories).values({ name: c.name, sort: c.sort, status: 1 }).returning({ id: examCategories.id })
      catMap[c.name] = ins.id
    }
  }
  ...
  const papers = [
    {
      ...
      description: '覆盖 OpenAI、Anthropic、Google、Moonshot 四大厂商 7 月发布的旗舰模型核心参数、定价、推理能力、Agent 表现。',
      category: '大模型与 LLM',
      duration: 30,
      difficulty: 4,
      questions: [
        {
          ...
          answer: 'B',
          analysis: 'GPT-5.6 系列采用天体命名分层:Sol 旗舰($5/$30 per M)、Terra 均衡($2.50/$15,价格砍半)、Luna 轻量($1/$6)。Terra 性能与 GPT-5.5 相当但价格减半,主攻企业批量场景。',
          score: '10',
        },
        {
          type: 'single_choice',
          ...
          answer: 'C',
          analysis: '月之暗面 Kimi K3 在 2026 WAIC 大会发布,参数规模达 2.8 万亿,是目前全球参数最大的开源模型,原生支持视觉理解,具备 100 万 token 上下文窗口。',
          score: '10',
        },
        {
          type: 'multi_choice',
          ...
          answer: ['A', 'B', 'C'],
          analysis: 'Claude Sonnet 5 由 Anthropic 在 7 月 1 日发布,官方称"迄今为止最具智能体能力的 Sonnet 模型",可在浏览器/终端自主运行,部分任务接近 Opus 4.8 能力。但 D 错误:Sonnet 5 入门价 $3,9 月后涨价 50%。',
          score: '15',
        },
        {
          type: 'judgment',
          title: 'Google Gemini 3.5 Pro 推迟两个月发布是因为 DeepMind 选择了"质量优先于速度"的预训练策略。',
          options: [
            { key: 'true', text: '正确' },
            { key: 'false', text: '错误' },
          ],
          answer: true,
          analysis: '据 Geeky Gadgets 报道,DeepMind 放弃了原有的 2.5 Pro 基座,转而对 Gemini 3.5 Pro 进行全新预训练,发布时间从 6 月推迟至 7 月 17 日,体现质量优先决策。',
          score: '10',
        },
        {
          type: 'single_choice',
          ...
          answer: 'B',
          analysis: 'GPT-Red 是 OpenAI 2026 年 7 月 15 日披露的内部自动化红队模型,采用 self-play 强化学习,帮助 GPT-5.6 抗 prompt injection,直接攻击成功率从 13% 提升到 84%,但永不对外公开。',
          score: '10',
        },
      ],
    },
    {
      ...
      description: '聚焦 Qwen3.7-Max、Ornith-1.0、CodeBrain-1 等智能体模型在长程任务、自主编码、Terminal-Bench 2.0 等基准上的表现。',
      ...
      questions: [
        {
          ...
          answer: 'A',
          analysis: 'Qwen 团队披露 Qwen3.7-Max 在 35 小时的 kernel 优化任务中完成 1000+ 工具调用,实现 10 倍加速。',
          score: '10',
        },
        {
          type: 'single_choice',
          ...
          answer: 'C',
          analysis: 'Feeling AI 凭借 CodeBrain-1 在 Terminal-Bench 2.0 中以 72.9% 跃居全球第二,仅次于 OpenAI 5.3-Codex 的官配 Simple Codex,是中国 AI 在 Agentic 自主编码领域的突破。',
          score: '10',
        },
        {
          type: 'multi_choice',
          ...
          answer: ['A', 'B', 'C', 'D'],
          analysis: 'Ornith-1.0 由 DeepReinforce 团队开源,基于 Gemma 4 + Qwen 3.5 后训练,推出 9B/31B/35B/397B 四个版本,覆盖从边缘设备到旗舰推理。',
          score: '15',
        },
        {
          type: 'judgment',
          title: 'SWE-Together 是 2026 年发布的 AI 编码 agent 交互式评测基准,采用 pass@1 和 pass² 等指标。',
          options: [
            { key: 'true', text: '正确' },
            { key: 'false', text: '错误' },
          ],
          answer: true,
          analysis: 'SWE-Together 于 2026 年 7 月发布,包含 109 个真实软件工程任务,通过 pass@1、pass²、token 消耗、稳定性等指标评估 agent 的多轮调试与长程推理能力。Claude-Opus-4.8 暂列榜首(pass@1 52%)。',
          score: '10',
        },
      ],
    },
    {
      ...
      description: '覆盖腾讯混元 Hy3、DeepSeek V4、Qwen3.7-Max、CodeBrain-1 等中国 AI 生态 2026 年关键进展。',
      category: '大模型与 LLM',
      duration: 20,
      difficulty: 3,
      questions: [
        {
          ...
          answer: 'C',
          analysis: '腾讯混元 Hy3 在 2026 年 7 月 6 日发布,采用 Apache 2.0 协议开源,295B 总参数 / 21B 激活参数,256K 上下文,3.8B 多令牌预测层。',
          score: '10',
        },
        {
          type: 'single_choice',
          ...
          answer: 'B',
          analysis: 'DeepSeek V4 峰谷定价:高峰为早 9-12 点、下午 14-18 点,API 价格是平时的 2 倍,平时保持 V4 原价。官方称是为了调配资源提升服务稳定性。',
          score: '10',
        },
        {
          type: 'multi_choice',
          ...
          answer: ['A', 'B', 'C'],
          analysis: 'Cerebras 7 月 9 日宣布欧洲扩张:2026 年底启用首批算力、推进法国/北欧建设、2027 年底达 200 MW,部分算力将支持 OpenAI 工作负载。',
          score: '15',
        },
      ],
    },
  ...
  for (const p of papers) {
    ...
    for (let i = 0; i < p.questions.length; i++) {
      ...
      const [qex] = await db
        .select()
        .from(examQuestions)
        .where(eq(examQuestions.title, q.title))
      if (qex) continue
...
async function seedNews() {
  ...
  for (const c of cats) {
    ...
    if (ex) catMap[c.name] = ex.id
      ...
      const [ins] = await db.insert(newsCategories).values({ name: c.name, sort: c.sort, status: 1 }).returning({ id: newsCategories.id })
      catMap[c.name] = ins.id
    }
  }
  ...
  const articles = [
    {
      ...
      summary: 'OpenAI 于 2026 年 7 月 9 日发布 GPT-5.6 系列三款模型 Sol/Terra/Luna,采用天体命名分层,Sol 在 Coding Agent Index 以 80 分领先,价格仅约 Fable 5 的三分之一。',
...
OpenAI 将独立运行的 Codex 应用正式并入 ChatGPT 桌面客户端,Chat、Work、Codex 三大功能统一入口。同步推出 ChatGPT Work 智能体,可跨邮箱、日历、Slack、云盘、CRM 连续工作。`,
      category: 'AI 模型发布',
      author: 'AI 前沿观察',
      cover: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=OpenAI%20GPT-5.6%20Sol%20Terra%20Luna%20three%20tier%20model%20launch%20tech%20dark&image_size=landscape_16_9',
      sort: 100,
      isPinned: true,
    },
    {
      title: 'Claude Sonnet 5 发布:最具智能体能力的中端模型,3 美元起入门',
      summary: 'Anthropic 于 7 月 1 日发布 Claude Sonnet 5,智能体搜索评测 BrowseComp 与计算机使用评测 OSWorld-Verified 显著优于 Sonnet 4.6,部分任务接近 Opus 4.8。',
...
- Anthropic:用极致性价比抢占智能体赛道`,
      category: 'AI 模型发布',
      author: 'AI 前沿观察',
      cover: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=Anthropic%20Claude%20Sonnet%205%20agent%20autonomous%20tech%20dark%20modern&image_size=landscape_16_9',
      sort: 99,
      isPinned: true,
    },
    {
      title: 'Kimi K3 重磅发布:2.8 万亿参数,全球最大开源模型',
      summary: '月之暗面在 2026 WAIC 大会发布 Kimi K3,2.8 万亿参数,100 万 token 上下文,原生支持视觉理解,综合智能水平仅次于 Claude Fable 5 与 GPT-5.6 Sol。',
...
完整权重即将发布,模型架构、训练和评测细节将随模型技术报告陆续公布。`,
      category: 'AI 模型发布',
      author: '央视新闻',
      cover: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=Moonshot%20Kimi%20K3%20open%20source%202.8%20trillion%20parameters%20Shanghai%20WAIC%20modern%20tech&image_size=landscape_16_9',
      sort: 98,
      isPinned: true,
    },
    {
      title: 'Gemini 3.5 Pro 7 月 17 日发布:2M 上下文,前端代码生成王者',
      summary: '谷歌 DeepMind 放弃原 2.5 Pro 基座,全新预训练 Gemini 3.5 Pro,主打"质量优先于速度",SVG 与前端页面一次生成,精度极高。',
...
谷歌同时基于同一底座推出图像模型 Nano Banana Pro,对标 OpenAI 的 GPT-Image 2。`,
      category: 'AI 模型发布',
      author: 'AI 前沿观察',
      cover: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=Google%20Gemini%203.5%20Pro%20frontend%20SVG%20code%20generation%20modern%20dark&image_size=landscape_16_9',
      sort: 97,
      isPinned: false,
    },
    {
      title: 'OpenAI 推出 GPT-Red:自动化红队加固 GPT-5.6 抗 prompt injection',
      summary: 'GPT-Red 是 OpenAI 内部自动化红队模型,采用 self-play 强化学习,帮助 GPT-5.6 抗 prompt injection,直接攻击成功率从 13% 提升到 84%,永不对外公开。',
      content: `# GPT-Red
...
模型严格内部使用,永不公开部署。`,
      category: 'AI 安全与治理',
      author: 'OpenAI 官方',
      cover: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=OpenAI%20GPT-Red%20red%20teaming%20security%20prompt%20injection%20dark%20tech&image_size=landscape_16_9',
      sort: 96,
      isPinned: false,
    },
    {
      title: '腾讯混元 Hy3 正式开源:295B MoE,Apache 2.0 协议,办公任务解决率提升至 90%',
      summary: '腾讯 7 月 6 日发布混元 Hy3,采用混合专家架构,295B 总参数 / 21B 激活参数,256K 上下文,WorkBuddy 任务解决率从 72% 提升到 90%,已接入 WorkBuddy、元宝、ima 等业务。',
      content: `# 腾讯混元 Hy3
...
已接入腾讯 WorkBuddy、元宝、ima 等业务。在编程、办公、金融、前端设计、游戏开发等生产力场景进步显著,工具调用稳定性达到生产级标准。`,
      category: 'AI 产业动态',
      author: '腾讯混元',
      cover: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=Tencent%20Hunyuan%20Hy3%20MoE%20open%20source%20office%20automation%20modern%20dark&image_size=landscape_16_9',
      sort: 95,
      isPinned: false,
    },
    {
      title: 'ICML 2026 杰出论文揭晓:扩散语言模型灵活性陷阱与 A3C 时间检验奖',
      summary: '清华-阿里《The Flexibility Trap》与 MIT-Yale 扩散采样研究获杰出论文奖,DeepMind A3C 时隔十年再获时间检验奖。',
...
获奖论文反映出机器学习研究的两大持续焦点:扩散范式在语言模型与生成采样中的理论深化,以及强化学习经典方法的长期影响力。`,
      category: 'AI 学术前沿',
      author: '机器之心',
      cover: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=ICML%202026%20Seoul%20conference%20machine%20learning%20academic%20modern&image_size=landscape_16_9',
      sort: 94,
      isPinned: false,
    },
    {
      title: 'CodeBrain-1 跻身全球 Terminal-Bench 2.0 第二:中国 AI 在 Agentic 编码领域突破',
      summary: 'Feeling AI 凭借 CodeBrain-1 在 Terminal-Bench 2.0 中以 72.9% 跃居全球第二,仅次 OpenAI 5.3-Codex,中国 AI 在 Agentic 复杂任务规划与自主编码领域工程化能力已达世界顶尖。',
      content: `# CodeBrain-1
...
强大的记忆能力以及适配模型原生的层级化记忆系统,意味着 Agentic AI 正从模型能力逐步走向用户体验层面的范式跃迁。`,
      category: 'AI 学术前沿',
      author: '新智元',
      cover: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=Feeling%20AI%20CodeBrain-1%20agentic%20coding%20Terminal-Bench%20dark%20tech&image_size=landscape_16_9',
      sort: 93,
      isPinned: false,
    },
    {
      title: 'Grok 4.5 正式发布:马斯克联手 Cursor,半价 Claude 的编码黑马',
      summary: 'xAI 于 2026 年 7 月 8 日发布 Grok 4.5,在 Cursor 代码数据上做特训,SWE-Bench Pro 64.7% 排名第四,价格 $2/$6 per M tokens,号称"半价 Claude" 的编码黑马。',
...
马斯克同时宣布 SpaceX AI 今年每月都将发布从头训练的完整新模型,预示以 600 亿美元收购 Cursor 后 AI 版图加速整合。`,
      category: 'AI 模型发布',
      author: 'xAI 官方',
      cover: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=xAI%20Grok%204.5%20coding%20model%20Cursor%20dark%20tech%20modern&image_size=landscape_16_9',
      sort: 92,
      isPinned: true,
    },
    {
      title: 'DeepSeek V4 正式版上线:峰谷定价 + DSpark 加速 85%,国内大模型性价比之王',
      summary: 'DeepSeek V4 于 2026 年 7 月 17 日正式 GA,引入"峰谷分时计费"(9-12、14-18 高峰价格 2 倍),联合北大发布 DSpark 推理加速框架,V4-Flash 单用户生成速度提升 60% 至 85%。',
...
DeepSeek 完成 500 亿元融资,首次对外发布开源技术成果。V4 系列具备 OpenAI / Anthropic 兼容 API,支持自托管。`,
      category: 'AI 模型发布',
      author: 'DeepSeek 官方',
      cover: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=DeepSeek%20V4%20peak%20pricing%20DSpark%20inference%20acceleration%20modern%20tech&image_size=landscape_16_9',
      sort: 91,
      isPinned: true,
    },
    {
      title: 'WAIC 2026 在上海开幕:9 位图灵奖诺奖得主参会,凯文·凯利畅谈具身智能',
      summary: '2026 世界人工智能大会于 7 月 17 日在上海世博/张江/西岸"三地四馆"启幕,持续 4 天,强化学习之父理查德·萨顿主旨演讲,凯文·凯利参加荣耀"从数字屏幕到具身智能"分论坛。',
...
- AI4S"百团百项":5 亿元专项基金`,
      category: 'AI 产业动态',
      author: '观察者网',
      cover: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=WAIC%202026%20Shanghai%20World%20AI%20Conference%20opening%20ceremony%20Kevin%20Kelly%20modern&image_size=landscape_16_9',
      sort: 90,
      isPinned: true,
    },
    {
      title: 'SK hynix 完成 265 亿美元 IPO:HBM4 内存成 AI 时代最大赢家',
      summary: 'SK hynix 于 2026 年 7 月 10 日完成史上最大外国公司赴美 IPO,募资 265 亿美元超额认购 7 倍,首日上涨 13%,HBM4 内存 4 个月内销售额突破 10 亿美元。',
...
AI Stack Weekly 观点:"硬件 GPU 性能每两年翻倍,超过摩尔定律"——黄仁勋法则继续在 AI 时代生效。`,
      ...
      cover: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=SK%20hynix%20HBM4%20memory%20chip%20IPO%20data%20center%20modern%20tech&image_size=landscape_16_9',
      sort: 89,
      isPinned: false,
    },
    {
      title: 'Claude Code 重大更新:Artifacts 集成 MCP,CLI v2.1.207 强化安全',
      summary: 'Anthropic 于 7 月 15 日为 Claude Code 推出 Artifacts 调用 MCP 连接器的能力(per-visitor 权限模型),CLI v2.1.207-210 强化屏幕阅读器、转写精简与安全加固。',
...
Anthropic 同步推出与 OpenAI GPT-Red 对标的内部安全加固,采用 red-blue self-play,验证 Claude 在 prompt injection 下的鲁棒性提升。`,
      category: 'AI 模型发布',
      author: 'Anthropic 官方',
      cover: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=Anthropic%20Claude%20Code%20Artifacts%20MCP%20enterprise%20security%20dark%20tech&image_size=landscape_16_9',
      sort: 88,
      isPinned: false,
    },
    {
      title: '智谱 GLM-5.2 开源:1M context,Apache-2.0,Function Call 达生产级',
      summary: '智谱 AI 于 2026 年 7 月上旬开源 GLM-5.2,1M 超长上下文,工具调用达生产级标准,Artificial Analysis 指数显示其与 Opus 4.8 统计无显著差异,成为国产开源第一梯队。',
...
阿里、字节、京东等大厂已开始在内部 AI 工具链中集成 GLM-5.2 作为 GPT-5.6 / Claude 的替代方案。`,
      category: 'AI 模型发布',
      author: '智谱 AI',
      cover: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=Zhipu%20GLM-5.2%20open%20source%20LLM%20Apache%20license%20function%20call%20modern&image_size=landscape_16_9',
      sort: 87,
      isPinned: false,
    },
    {
      title: 'Microsoft 发布 MAI 系列:MAI-Thinking-1 推理模型与 MAI-Image-2.5 图像模型',
      summary: 'Microsoft 于 2026 年 7 月发布 7 款 MAI 系列 AI 模型,MAI-Thinking-1 专注推理,MAI-Image-2.5 强化图像处理,均通过 Azure 提供,逐步摆脱对 OpenAI 单一依赖。',
...
- 企业客户可与 Azure 现有服务深度集成`,
      category: 'AI 产业动态',
      author: 'Microsoft 官方',
      cover: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=Microsoft%20MAI%20Thinking%20Image%20Azure%20AI%20models%20modern%20tech&image_size=landscape_16_9',
      sort: 86,
      isPinned: false,
    },
    {
      title: 'AI 工程师成 LinkedIn 2026 Jobs on the Rise 第一:大模型岗位需求井喷',
      summary: 'LinkedIn 2026 Jobs on the Rise 报告显示 AI Engineer 成为全球增长最快岗位第一名,AI 产品经理、ML Engineer、Prompt Engineer 紧随其后,DataRobot 预测 2026 年 AI 岗位增长 40%。',
      content: `# AI 工程师需求井喷
...
LinkedIn 报告同时指出,**AI 工程师将可能是十年内需求最高的工程岗位**。`,
      category: 'AI 产业动态',
      author: 'LinkedIn',
      cover: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=LinkedIn%20Jobs%20on%20the%20Rise%20AI%20Engineer%202026%20hiring%20growth%20modern%20tech&image_size=landscape_16_9',
      sort: 85,
      isPinned: false,
    },
  ]
  ...
  const questions = [
    {
      ...
      content: '我正在搭建一个企业级 Coding Agent,需要长程多文件编辑能力。GPT-5.6 Sol 在 Coding Agent Index 上 80 分领先,但 Claude Sonnet 5 智能体能力也很强。怎么选?',
      category: '大模型选型',
    ...
    },
    {
      ...
      content: '看了一些 demo,Gemini 3.5 Pro 在前端代码生成上似乎非常强,一次能出 SVG 和复杂 UI。实际项目使用中,代码质量如何?能直接上生产吗?',
      category: '大模型选型',
    ...
    },
    {
      ...
      content: 'Kimi K3 2.8 万亿参数虽然是开源,但这个体量本地基本不可能跑起来吧?有没有量化或蒸馏版本?部署一套最小可用环境需要什么硬件?',
      category: '大模型选型',
    ...
    },
    {
      ...
      content: 'Claude Code 现在支持 Artifacts 调用 MCP 连接器(2026 年 7 月 15 日更新),想做 per-visitor 而不是 per-creator 的权限模型。具体怎么搭?',
      category: 'AI 编程',
    ...
    },
    {
      ...
      content: 'DeepReinforce 团队开源的 Ornith-1.0 系列里 9B-Dense 版本号称可以"punch above its weight class",实际在 RTX 4090 或 3090 上能跑多复杂的多文件任务?',
      category: 'AI 编程',
    ...
    },
    {
      ...
      content: 'Feeling AI 的 CodeBrain-1 在 Terminal-Bench 2.0 全球第二,声称具备"动态规划与策略调整能力"。有没有公开的论文或代码解释其工作原理?',
      category: 'Agent 开发',
    ...
    },
    {
      ...
      content: 'DeepSeek V4 推出峰谷定价,高峰(9-12、14-18)价格是平时的 2 倍。我的应用主要在 19-23 点用,这样能省多少?非高峰有 SLA 保证吗?',
      category: '大模型选型',
    ...
    },
    {
      ...
      content: 'Grok 4.5($2/$6) 和 GPT-5.6 Terra($2.5/$15) 同日 7 月 8 日发布,价格接近但都是"性价比"档。日常写代码、文档、邮件处理,选哪个更稳?',
      category: '大模型选型',
    ...
    },
    {
      ...
      content: 'SpaceX 600 亿美元收购 Cursor 后,xAI 立刻用 Cursor 数据特训 Grok 4.5。在 SWE-Bench Pro 上 Grok 4.5 64.7% 排名第四,这个组合是不是当前最强 AI 编程?',
      category: 'AI 编程',
    ...
    },
    {
      ...
      content: 'WAIC 2026 7 月 17-20 日在上海举办,4 个主题日分别关注什么?普通开发者和创业者最值得关注的分论坛是哪几场?',
      category: 'AI 编程',
    ...
    },
    {
      ...
      content: 'LangChain/NVIDIA 研究显示 GLM-5.2 与 Opus 4.8 统计无显著差异(单任务 $1.28 vs $1.94),harness tuning 后可近 Opus 质量 1/10 成本。生产环境真能平替吗?',
      category: '大模型选型',
    ...
    },
    {
      ...
      content: 'dev.to 总结的 26 道 AI Agent 面试题 2026 版,涵盖 ReAct、MCP 协议、A2A、记忆系统、Agentic RAG、多 Agent 协作等。准备跳槽的同学有哪些高频坑?',
      category: 'Agent 开发',
    ...
    },
    {
      ...
      content: 'SK hynix 7 月 10 日完成 265 亿美元 IPO,HBM4 4 个月卖了 10 亿美元。Brian Letort 说利润涌向内存和电力,这对 AI 工程师有什么影响?',
      category: 'AI 编程',
    ...
    },
    {
      ...
      content: '腾讯混元 Hy3(7-6 开源,Apache 2.0)与 DeepSeek V4(7-17 GA,峰谷定价)是国内企业 AI 中台最常见选择。功能、性能、生态、成本怎么选?',
      category: '大模型选型',
  ...
  const circlesData = [
    {
      ...
      description: '聚焦 OpenAI GPT-5.6 Sol 的 Coding Agent 实战应用,涵盖长程编码、多文件编辑、Codex 集成等场景。',
      cover: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=GPT-5.6%20Sol%20coding%20agent%20community%20developer%20modern%20tech&image_size=landscape_4_3',
      members: 12580,
    },
    {
      name: 'Claude Sonnet 5 Agent 开发者',
      slug: 'claude-sonnet-5-agents',
      description: '围绕 Anthropic Claude Sonnet 5 的智能体能力,讨论 BrowseComp、OSWorld、自主工作流等话题。',
      cover: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=Anthropic%20Claude%20Sonnet%205%20agent%20developer%20community%20modern%20tech&image_size=landscape_4_3',
      members: 8920,
    },
    {
      name: 'Kimi K3 开源生态',
      ...
      cover: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=Kimi%20K3%20open%20source%20community%20developers%20modern%20dark&image_size=landscape_4_3',
      members: 6420,
    },
    {
      name: '国产开源大模型',
      slug: 'china-open-source-llm',
      description: 'DeepSeek V4 / 腾讯混元 Hy3 / Qwen3.7-Max / Kimi K3 等中国开源大模型的深度交流。',
      cover: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=Chinese%20open%20source%20LLM%20community%20DeepSeek%20Hunyuan%20Qwen%20Kimi%20modern%20tech&image_size=landscape_4_3',
      members: 18760,
    },
    {
      name: 'Agentic Coding 工程师',
      slug: 'agentic-coding-engineers',
      description: '聚焦 AI Coding Agent:Claude Code、Cursor、Codex、CodeBrain-1、Ornith-1.0 的工程实践与对比评测。',
      cover: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=Agentic%20coding%20engineers%20community%20Cursor%20Claude%20Codex%20modern%20tech&image_size=landscape_4_3',
      members: 9430,
    },
    {
      name: 'Grok 4.5 + Cursor 极客圈',
      slug: 'grok-45-cursor-hackers',
      description: 'SpaceX 600 亿美元收购 Cursor 后,Grok 4.5 + Cursor 成为最强 AI 编程组合。讨论实战、调优、Code Review 技巧。',
      cover: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=Grok%20Cursor%20hacker%20community%20AI%20coding%20modern%20dark&image_size=landscape_4_3',
      members: 5380,
    },
    {
      name: 'WAIC 2026 全球 AI 大会',
      slug: 'waic-2026',
      description: '2026 世界人工智能大会(7-17 至 7-20,上海)专题讨论区,涵盖主旨演讲、展览、发布、具身智能、AI 治理等。',
      cover: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=WAIC%202026%20World%20AI%20Conference%20Shanghai%20Kevin%20Kelly%20modern%20tech&image_size=landscape_4_3',
      members: 11200,
    },
    {
      name: 'AI 工程师面试互助',
      slug: 'ai-engineer-interview-2026',
      description: 'LinkedIn 2026 Jobs on the Rise AI 工程师 #1。讨论 Anthropic、OpenAI、Scale AI、Sierra、xAI、Databricks、Perplexity 真实面试题。',
      cover: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=AI%20Engineer%20Interview%202026%20community%20hiring%20modern%20tech&image_size=landscape_4_3',
      members: 14650,
    },
    {
      name: 'DeepSeek V4 开发者联盟',
      slug: 'deepseek-v4-developers',
      description: '聚焦 DeepSeek V4 峰谷定价、DSpark 加速框架、V3 → V4 迁移实战(7-24 截止)、OpenRouter 排名讨论。',
      cover: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=DeepSeek%20V4%20developer%20community%20peak%20pricing%20modern%20tech&image_size=landscape_4_3',
      members: 16280,
    },
    {
      name: 'MCP 与 A2A 协议工程师',
      slug: 'mcp-a2a-engineers',
      description: 'Model Context Protocol (MCP) 与 Agent-to-Agent (A2A) 协议开发者社区,围绕 Claude Code Artifacts + MCP 集成、LangGraph Agent 通信展开。',
      cover: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=MCP%20A2A%20protocol%20engineers%20community%20Claude%20LangGraph%20modern%20tech&image_size=landscape_4_3',
      members: 4820,
    },
  ]
...
async function seedResources() {
  ...
  const [exCat] = await db.select().from(resourceCategories).where(eq(resourceCategories.name, catName))
  let catId: string
  ...
  const resourcesData = [
    {
      ...
      intro: 'OpenAI 发布的 GPT-5.6 三档分层模型(Sol/Terra/Luna)技术详解,包含 Coding Agent Index 80 分领先的多基准评测数据。',
      url: 'https://openai.com/index/gpt-5-6-technical-report',
      type: 'doc',
    },
    {
      title: 'Claude Sonnet 5 智能体评测白皮书',
      intro: 'Anthropic 官方发布,涵盖 BrowseComp、OSWorld-Verified 等智能体基准对比 Sonnet 4.6 与 Opus 4.8 的实测数据。',
      url: 'https://www.anthropic.com/news/claude-sonnet-5-agent-benchmarks',
      type: 'doc',
    },
    {
      title: 'Kimi K3 2.8 万亿参数开源模型技术报告',
      intro: '月之暗面官方披露 Kimi K3 的训练方法、架构创新、软硬件协同优化,2.8 万亿参数规模下综合智能水平接近 Claude Fable 5 与 GPT-5.6 Sol。',
      url: 'https://www.moonshot.cn/blog/kimi-k3-tech-report',
      type: 'doc',
    },
    {
      title: 'GPT-Red 自动化红队训练方法论',
      intro: 'OpenAI 内部 GPT-Red 模型如何通过 self-play 强化学习发现并加固 prompt injection 漏洞,直接攻击成功率从 13% 提升到 84%。',
      url: 'https://openai.com/index/gpt-red-automated-red-teaming',
      type: 'article',
    },
    {
      title: 'SWE-Together 交互式 AI 编码 Agent 基准',
      intro: '2026 年 7 月发布的 AI 编码 agent 评测基准,109 个真实软件工程任务,采用 pass@1、pass²、token 消耗、稳定性等指标。',
      url: 'https://togetherbench.com/',
      type: 'link',
    },
    {
      title: 'Grok 4.5 官方技术报告(SpaceX AI,2026-07-08)',
      intro: 'xAI 发布的 Grok 4.5 技术报告,基于 1.5 万亿参数 V9 基座 + Cursor 联合特训,SWE-Bench Pro 64.7%,价格 $2/$6 per M tokens。',
      url: 'https://x.ai/blog/grok-4-5',
      type: 'doc',
    },
    {
      title: 'DeepSeek V4 峰谷定价与 DSpark 加速框架白皮书',
      intro: 'DeepSeek V4 峰谷定价策略详解(9-12、14-18 高峰 ×2 价格),联合北大发布 DSpark 推理加速 60-85%,V3 → V4 迁移截止 7-24。',
      url: 'https://api-docs.deepseek.com/news/v4-peak-pricing',
      type: 'doc',
    },
    {
      title: 'WAIC 2026 大会完整议程与嘉宾名单(2026-07-17~20)',
      intro: '世界人工智能大会 2026 官方完整议程,涵盖主旨演讲(理查德·萨顿、约书亚·本吉奥、姚期智)、凯文·凯利具身智能分论坛、1100+ 企业展览。',
      url: 'https://www.worldaic.com.cn/',
      type: 'link',
    },
    {
      title: 'Claude Code Artifacts + MCP 集成开发指南(2026-07-15)',
      intro: 'Anthropic 7 月 15 日更新:Artifacts 调用 MCP 连接器,per-visitor 权限模型,适用于 Pro/Max/Team/Enterprise 计划,CLI v2.1.207-210。',
      url: 'https://docs.anthropic.com/en/docs/claude-code/artifacts-mcp',
      type: 'doc',
    },
    {
      title: 'AI Agent 工程师面试 26 问通关手册(dev.to 2026-06)',
      intro: '2026 大厂 AI Agent 工程师面试 26 问完整指南,涵盖 ReAct、MCP 协议、A2A、记忆系统、Agentic RAG、多 Agent 协作、LangGraph、CrewAI。',
    ...
    },
    {
      ...
      intro: 'AWS Bedrock + SageMaker + Flows 完整 GenAI 开发认证课程,24 小时视频,303 个讲座,2026-07 更新,涵盖 RAG、Agent、多模态、安全治理。',
    ...
    },
    {
      ...
      intro: 'GLM-5.2 Apache-2.0 协议开源,1M 上下文,Function Call 达生产级,Artificial Analysis 指数与 Opus 4.8 统计无显著差异。',
      url: 'https://huggingface.co/zhipu-ai/GLM-5.2',
      type: 'doc',
    },
    {
      title: 'Kimi K3 2.8 万亿参数开源模型部署与量化实践',
      intro: '月之暗面 Kimi K3 完整权重即将发布,2.8 万亿参数原生视觉理解,100 万 token 上下文,综合智能仅次于 Claude Fable 5 与 GPT-5.6 Sol。',
  ...
  for (const r of resourcesData) {
    ...
    await db.insert(resources).values({
      title: r.title,
      intro: r.intro,
      coverImage: `https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=${encodeURIComponent(r.title)}&image_size=landscape_4_3`,
      categoryId: catId,
      fileUrl: r.url,
      fileType: r.type,
      fileSize: 0,
