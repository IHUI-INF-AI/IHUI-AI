...
// 2026-08-12 重构:实现合并到 CodeLoginForm(accountType='email'),本文件保留导出 API。
...
export function EmailCodeLoginForm(props: EmailCodeLoginFormProps) {
  return <CodeLoginForm accountType="email" {...props} />
}
