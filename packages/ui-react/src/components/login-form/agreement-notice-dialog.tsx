/**
 * AgreementNoticeDialog — 共享协议确认弹窗(2026-07-26 立)
 *
 * 抽到 packages/ui-react,web + extension 共用同一份组件。
 * 触发场景:登录表单提交但未勾选"我已阅读并同意"复选框时弹出。
 *
 * 键盘交互流(3 步 Enter,2026-07-21 立,扩展端通用):
 ...
 *
 * 视觉规范(跟 web 端 AgreementNoticeDialog 2026-07-21 立 完全一致):
...
export function AgreementNoticeDialog({ open, onAgree, onCancel, t }: AgreementNoticeDialogProps) {
