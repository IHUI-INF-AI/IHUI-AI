...
function createStyles(tk: AppThemeTokens) {
  return StyleSheet.create({
    ...
    errorText: { fontSize: 14, color: tk.danger.DEFAULT, marginBottom: 8, textAlign: 'center' },
    btnPrimary: {
    ...
    videoHint: { marginTop: 8, fontSize: 14, color: tk.text.tertiary },
    videoUrl: { marginTop: 8, fontSize: 10, color: tk.text.secondary, paddingHorizontal: 10 },
    ...
    chatContent: { marginTop: 8, fontSize: 14, color: tk.text.primary },
    chatErrorText: { marginTop: 8, fontSize: 10, color: tk.danger.DEFAULT },
    inputRow: {
      flexDirection: 'row',
      alignItems: 'center',
      gap: 8,
