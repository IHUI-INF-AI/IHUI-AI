...
function createStyles(tk: AppThemeTokens) {
  return StyleSheet.create({
    ...
    statText: { fontSize: 12, color: tk.text.secondary },
    description: {
      fontSize: 14,
      lineHeight: 22,
      color: tk.text.primary,
    ...
    actionBtnPrimaryText: { color: tk.surface.light, fontSize: 14, fontWeight: '600' },
    actionBtnSecondary: {
      borderWidth: 1,
      borderColor: tk.brand.DEFAULT,
      backgroundColor: tk.surface.bg,
    },
    actionBtnSecondaryText: { color: tk.brand.DEFAULT, fontSize: 14, fontWeight: '600' },
    actionBtnOutline: {
      borderWidth: 1,
      borderColor: tk.border.light,
      backgroundColor: tk.surface.bg,
    },
    actionBtnOutlineText: { color: tk.text.secondary, fontSize: 14, fontWeight: '600' },
  })
}
