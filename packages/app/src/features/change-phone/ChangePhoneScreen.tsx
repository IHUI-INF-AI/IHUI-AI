...
function createStyles(tk: AppThemeTokens) {
  return StyleSheet.create({
    ...
    areaText: { fontSize: 14, color: tk.text.medium },
    areaArrow: { fontSize: 10, color: tk.text.tertiary, marginLeft: 4 },
    input: { flex: 1, fontSize: 14, color: tk.text.primary, padding: 0 },
    sendBtn: { paddingLeft: 12 },
    sendText: { fontSize: 13, fontWeight: '700', color: tk.purple.DEFAULT },
    countdownText: { fontSize: 12, color: tk.text.secondary, paddingLeft: 12 },
    nationBox: {
      marginTop: 4,
      borderWidth: 1,
      borderColor: tk.border.light,
    ...
    nationTitle: { fontSize: 13, color: tk.text.primary },
    nationCode: { fontSize: 13, color: tk.text.tertiary },
    tipText: { fontSize: 12, color: tk.danger.DEFAULT, marginBottom: 12 },
    submitBtn: {
      height: 48,
      borderRadius: 12,
    ...
    submitText: { fontSize: 15, fontWeight: '700', color: tk.surface.light },
  })
}
