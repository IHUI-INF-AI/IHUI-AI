...
function createStyles(tk: AppThemeTokens) {
  return StyleSheet.create({
    ...
    statValue: { marginTop: 4, fontSize: 17, fontWeight: '700', color: tk.text.primary },
    statTrend: { marginTop: 2, fontSize: 11, color: tk.brand.DEFAULT },
    statHint: {
      width: '100%',
      paddingVertical: 16,
      fontSize: 12,
    ...
    entryText: { marginTop: 4, fontSize: 12, color: tk.text.medium },
    sectionHead: {
      marginHorizontal: 16,
      marginTop: 18,
      flexDirection: 'row',
    ...
    sectionTitle: { fontSize: 15, fontWeight: '600', color: tk.text.primary },
    ...
    featureTitle: { flex: 1, fontSize: 13, color: tk.text.medium, lineHeight: 18 },
    ...
    footSymbol: { fontSize: 14, fontWeight: '600', color: tk.text.primary },
    ...
    buyBtnText: { fontSize: 14, fontWeight: '600', color: tk.surface.light },
  })
}
