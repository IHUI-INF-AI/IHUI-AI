...
function createStyles(tk: AppThemeTokens) {
  return StyleSheet.create({
    ...
    stateText: { fontSize: 13, color: tk.text.tertiary, marginTop: 8 },
    ...
    subtitle: { marginTop: 4, fontSize: 12, color: tk.text.tertiary },
    ...
    jobSalary: { fontSize: 14, fontWeight: '600', color: tk.danger.bright },
    jobCompany: { marginTop: 4, fontSize: 12, color: tk.text.secondary },
    ...
    modalSalary: { marginTop: 6, fontSize: 13, color: tk.brand.DEFAULT },
    modalSection: {
      marginTop: 16,
      marginBottom: 6,
      fontSize: 13,
    ...
    modalDesc: { fontSize: 13, color: tk.text.medium, lineHeight: 20 },
    modalReq: { marginTop: 4, fontSize: 13, color: tk.text.medium, lineHeight: 20 },
    applyBtn: {
      marginTop: 20,
      paddingVertical: 12,
      borderRadius: 8,
    ...
    applyText: { color: tk.surface.light, fontSize: 15, fontWeight: '600' },
  })
}
