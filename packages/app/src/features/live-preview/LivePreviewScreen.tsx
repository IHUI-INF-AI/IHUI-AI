...
function createStyles(tk: AppThemeTokens) {
  return StyleSheet.create({
    ...
    body: { padding: 16 },
    liveTitle: { fontSize: 18, fontWeight: '600', color: tk.text.primary },
    meta: { marginTop: 6, fontSize: 13, color: tk.text.secondary },
    intro: { marginTop: 12, fontSize: 14, color: tk.text.medium, lineHeight: 22 },
    btn: {
      marginTop: 20,
    ...
    btnText: { color: tk.surface.light, fontSize: 14, fontWeight: '600' },
  })
}
