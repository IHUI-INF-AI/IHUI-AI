...
function createStyles(tk: AppThemeTokens) {
  return StyleSheet.create({
    ...
    playBtnText: { color: tk.surface.light, fontSize: 13, fontWeight: '600' },
    modalOverlay: {
      flex: 1,
    ...
    playerHint: { marginTop: 8, fontSize: 13, color: tk.text.tertiary },
    playerUrl: { marginTop: 4, fontSize: 10, color: tk.text.secondary, paddingHorizontal: 16 },
    closeBtn: {
      marginTop: 12,
      paddingVertical: 10,
      borderRadius: 8,
    ...
    closeBtnText: { color: tk.surface.light, fontSize: 14, fontWeight: '600' },
  })
}
