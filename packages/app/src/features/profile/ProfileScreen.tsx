...
function createStyles(tk: AppThemeTokens) {
  return StyleSheet.create({
    ...
    loadingTimeoutText: { fontSize: 16, color: tk.text.secondary, marginBottom: 4 },
    retryBtn: {
    ...
    retryBtnText: { fontSize: 15, fontWeight: '600', color: tk.brand.foreground },
    backLinkBtn: { paddingHorizontal: 16, paddingVertical: 8 },
    backLinkBtnText: { fontSize: 14, color: tk.text.medium },
    header: {
      flexDirection: 'row',
      alignItems: 'center',
