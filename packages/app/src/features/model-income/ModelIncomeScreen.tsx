...
function createStyles(tk: AppThemeTokens) {
  return StyleSheet.create({
    ...
    sumLabel: { fontSize: 14, color: tk.text.medium },
    sumAmount: { fontSize: 18, fontWeight: '700', color: tk.text.primary },
    withdrawBtn: {
      paddingHorizontal: 10,
      paddingVertical: 6,
      borderRadius: rnRadius.xl,
    ...
    sumCol: { flex: 1 },
    sumSubLabel: { fontSize: 14, color: tk.text.secondary },
    sumSubAmount: {
      marginTop: 8,
      fontSize: 18,
      fontWeight: '700',
    ...
    tip: { marginHorizontal: 10, marginTop: 10, fontSize: 11, color: tk.text.tertiary },
    tabRow: {
      flexDirection: 'row',
      marginHorizontal: 10,
      marginTop: 12,
    ...
    statusPending: { color: tk.brandAccent.deep },
    ...
    cardAvatarText: { fontSize: 16, fontWeight: '600', color: tk.text.primary },
    cardInfo: { flex: 1 },
    cardName: { fontSize: 16, fontWeight: '600', color: tk.text.primary },
    cardMeta: { marginTop: 8, fontSize: 11, color: tk.text.tertiary },
    cardAmount: { fontSize: 16, fontWeight: '700', color: tk.brandAccent.deep },
    ...
    modalTitle: { fontSize: 18, fontWeight: '600', color: tk.text.primary },
    modalClose: { fontSize: 14, color: tk.text.secondary },
    modalSub: { marginTop: 8, fontSize: 14, color: tk.text.tertiary },
    payOption: {
      flexDirection: 'row',
      alignItems: 'center',
    ...
    payIconText: { fontSize: 16, fontWeight: '600', color: tk.surface.light },
    payName: { fontSize: 16, color: tk.text.primary },
    payRadio: {
      width: 18,
      height: 18,
    ...
    modalBtnText: { fontSize: 16, fontWeight: '600', color: tk.surface.light },
  })
}
// ⁠​‌​​‌​​‌‍‍​‌​​‌​​​‍‍​‌​‌​‌​‌‍‍​‌​​‌​​‌‍‍​​‌​‌‌​‌‍‍​‌​​​​​‌‍‍​‌​​‌​​‌‍‍‌​‌‌​‌‌‌‍‍‌‌​​‌‌​​‌‌‌‌​‌​‍‍‌‌​‌‌​​​‌​​​‌‌‌‍‍​‌​​​​​‌‍‍​‌​​‌​​‌‍‍‌​‌‌​‌‌‌‍‍‌‌​​‌‌‌​‌​​‌‌‌​‍‍‌‌​​‌‌​​​‌​​‌​‌‍‍‌​‌‌‌​‌‌‌​‌‌‌​‌‍‍‌​‌‌​‌‌‌‍‍​‌​​‌‌​​‍‍​‌​​​​‌‌‍‍‌​‌‌​‌‌‌‍‍​‌‌​​​​‌‍‍​‌‌​‌​​‌‍‍​‌‌‌‌​‌​‍‍​‌‌​‌​​​‍‍​‌‌‌​​‌‌‍‍​​‌​‌‌‌​‍‍​‌‌‌​‌​​‍‍​‌‌​‌‌‌‌‍‍​‌‌‌​​​​‍‍‌​‌‌​‌‌‌‍‍​‌​‌​​​​‍‍​‌​‌​​‌​‍‍​‌​​‌‌‌‌‍‍​‌​‌​‌‌​‍‍​‌​​​‌​‌‍‍​‌​​‌‌‌​‍‍​‌​​​​​‌‍‍​‌​​‌‌‌​‍‍​‌​​​​‌‌‍‍​‌​​​‌​‌‍‍​​‌​‌‌​‌‍‍​​‌‌​​‌​‍‍​​‌‌​​​​‍‍​​‌‌​​‌​‍‍​​‌‌​‌‌​⁠
