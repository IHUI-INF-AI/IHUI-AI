...
function createStyles(tk: AppThemeTokens) {
  return StyleSheet.create({
    ...
    searchInput: { flex: 1, fontSize: 14, color: tk.text.primary },
    tabsBar: {
      paddingHorizontal: 12,
      paddingBottom: 12,
    },
    ...
    orderLabel: { flex: 1, fontSize: 13, color: tk.text.primary },
    statusTag: {
      paddingHorizontal: 8,
      paddingVertical: 2,
      borderRadius: 6,
    ...
    buyerText: { fontSize: 13, color: tk.text.secondary },
    orderFooter: {
      flexDirection: 'row',
      justifyContent: 'space-between',
      alignItems: 'center',
    ...
    amountText: { fontSize: 15, fontWeight: '600', color: tk.text.primary },
    rateTag: {
      paddingHorizontal: 6,
      paddingVertical: 2,
      borderRadius: 6,
    ...
    commissionValue: { fontSize: 14, fontWeight: '600', color: tk.danger.DEFAULT },
    timeText: { fontSize: 12, color: tk.text.tertiary },
