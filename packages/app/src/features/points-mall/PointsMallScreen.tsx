...
function createStyles(tk: AppThemeTokens) {
  return StyleSheet.create({
    ...
    balanceValue: { marginTop: 4, fontSize: 28, fontWeight: '700', color: tk.success.DEFAULT },
    errorBar: {
    ...
    productName: { marginTop: 6, fontSize: 13, fontWeight: '600', color: tk.text.primary, minHeight: 36 },
    productDesc: { fontSize: 11, color: tk.text.tertiary, marginTop: 2 },
    pointsCost: { marginTop: 4, fontSize: 14, fontWeight: '700', color: tk.success.DEFAULT },
    stockText: { fontSize: 10, color: tk.text.tertiary, marginTop: 2 },
    redeemBtn: {
      marginTop: 8,
      paddingVertical: 6,
      borderRadius: 8,
    ...
    redeemBtnText: { fontSize: 12, color: tk.surface.light },
  })
}
