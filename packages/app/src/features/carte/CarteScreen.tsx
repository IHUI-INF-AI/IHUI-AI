...
function createStyles(tk: AppThemeTokens) {
  return StyleSheet.create({
    ...
    avatarText: { fontSize: 18, fontWeight: '600', color: tk.brand.DEFAULT },
    profileMeta: { marginLeft: 12, flex: 1 },
    name: { fontSize: 17, fontWeight: '600', color: tk.text.primary },
    title2: { marginTop: 2, fontSize: 12, color: tk.brand.DEFAULT },
    bio: {
      marginTop: 12,
      fontSize: 13,
      lineHeight: 20,
    ...
    workTitle: { fontSize: 15, fontWeight: '600', color: tk.text.primary },
    workDesc: {
      marginTop: 4,
      fontSize: 12,
      lineHeight: 18,
    ...
    retryText: { color: tk.surface.light, fontSize: 13 },
