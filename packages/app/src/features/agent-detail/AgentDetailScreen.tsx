...
function createStyles(tk: AppThemeTokens) {
  return StyleSheet.create({
    ...
    btn: { paddingHorizontal: 16, paddingVertical: 8, borderRadius: 8, backgroundColor: tk.brand.DEFAULT },
    ...
    cta: { marginTop: 16, paddingVertical: 12, borderRadius: 8, backgroundColor: tk.brand.DEFAULT, alignItems: 'center' },
