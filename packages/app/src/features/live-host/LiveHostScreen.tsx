...
function createStyles(tk: AppThemeTokens) {
  return StyleSheet.create({
    ...
    previewText: { fontSize: 14, color: tk.text.tertiary },
    sectionBox: {
      marginHorizontal: 10,
      marginTop: 12,
      padding: 12,
    ...
    sectionLabel: { fontSize: 14, color: tk.text.tertiary, marginBottom: 8 },
    ...
    streamInfoText: { fontSize: 14, color: tk.text.tertiary, marginTop: 8 },
    actionRow: {
      flexDirection: 'row',
      gap: 12,
      marginHorizontal: 10,
    ...
    statValue: { fontSize: 16, fontWeight: '600', color: tk.text.primary },
    productHeader: {
      flexDirection: 'row',
      alignItems: 'center',
    ...
    productHint: { fontSize: 14, color: tk.text.tertiary, paddingVertical: 8, textAlign: 'center' },
    productError: {
      fontSize: 14,
    ...
    productName: { flex: 1, fontSize: 16, color: tk.text.primary, marginRight: 8 },
    productPrice: { fontSize: 16, fontWeight: '600', color: tk.danger.DEFAULT },
  })
}
