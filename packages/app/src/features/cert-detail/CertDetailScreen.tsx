...
function createStyles(tk: AppThemeTokens) {
  return StyleSheet.create({
    ...
    certTitle: { fontSize: 18, fontWeight: '600', color: tk.text.primary },
    certNo: { marginTop: 4, fontSize: 12, color: tk.text.secondary },
    divider: {
      marginVertical: 12,
      height: 1,
      backgroundColor: tk.success.DEFAULT,
    },
    label: { marginTop: 6, fontSize: 11, color: tk.text.tertiary },
    ...
    verifyText: { fontSize: 14, fontWeight: '600', color: tk.success.DEFAULT },
