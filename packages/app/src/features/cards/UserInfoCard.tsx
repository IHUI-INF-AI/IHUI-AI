...
function createStyles(tk: AppThemeTokens) {
  return StyleSheet.create({
    ...
    statSpacer: { flex: 1 },
    followBtn: { backgroundColor: tk.brand.DEFAULT, borderRadius: 6, paddingHorizontal: 14, paddingVertical: 6 },
    followBtnOutline: { backgroundColor: 'transparent', borderWidth: 1, borderColor: tk.border.medium, borderRadius: 6, paddingHorizontal: 14, paddingVertical: 6 },
