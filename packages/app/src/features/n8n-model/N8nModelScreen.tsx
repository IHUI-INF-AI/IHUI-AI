    ...
    <View style={styles.container}>
      ...
      {loading && items.length === 0 ? (
        <View style={styles.loadingWrap}>
          <ActivityIndicator color={tk.purple.DEFAULT} />
        </View>
      ) : (
...
function createStyles(tk: AppThemeTokens) {
  return StyleSheet.create({
    ...
    errorText: { flex: 1, fontSize: 12, color: tk.danger.DEFAULT },
    retryText: { fontSize: 12, fontWeight: '600', color: tk.purple.DEFAULT, marginLeft: 8 },
    ...
    cardUrl: { marginTop: 6, fontSize: 11, color: tk.purple.DEFAULT },
    ...
    actionText: { fontSize: 13, fontWeight: '600', color: tk.surface.light },
    actionEdit: {
      paddingHorizontal: 16,
      height: 34,
      borderRadius: 8,
    ...
    actionEditText: { fontSize: 13, color: tk.text.medium },
  })
}
