...
function createStyles(tk: AppThemeTokens) {
  return StyleSheet.create({
    ...
    podiumName: { marginTop: 6, fontSize: 13, fontWeight: '600', color: tk.text.primary },
    podiumPoints: { marginTop: 2, fontSize: 12, color: tk.success.DEFAULT },
    ...
    listName: { fontSize: 14, fontWeight: '600', color: tk.text.primary },
    listMeta: { marginTop: 2, fontSize: 11, color: tk.text.tertiary },
    listPoints: { fontSize: 15, fontWeight: '700', color: tk.success.DEFAULT },
  })
}
