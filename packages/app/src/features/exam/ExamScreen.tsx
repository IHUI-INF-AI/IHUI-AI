...
function createStyles(tk: AppThemeTokens) {
  return StyleSheet.create({
    ...
    fullCenter: { flex: 1, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 10 },
    ...
    toastText: { paddingHorizontal: 10, paddingVertical: 4, fontSize: 14, color: tk.brand.DEFAULT },
    errorText: {
    ...
    cardTitle: { flex: 1, fontSize: 18, fontWeight: '700', color: tk.text.primary },
    statusBadge: {
      paddingHorizontal: 8,
      paddingVertical: 4,
      borderRadius: 8,
    ...
    startBtnText: { fontSize: 14, fontWeight: '600', color: tk.surface.light },
  })
}
