...
function createStyles(tk: AppThemeTokens) {
  ...
  return StyleSheet.create({
    ...
    fullscreenBackText: { fontSize: 14, color: tk.text.secondary, marginRight: 12 },
    ...
    iconBtnText: { fontSize: 18, color: tk.text.secondary },
    input: {
      flex: 1,
      paddingHorizontal: 8,
      paddingVertical: 6,
    ...
    voiceBarLine: { width: 3, borderRadius: 1 },
    ...
    errorText: { marginTop: 4, fontSize: 12, color: tk.danger.DEFAULT },
  })
}
