...
function createStyles(tk: AppThemeTokens) {
  return StyleSheet.create({
    ...
    statLabel: { marginTop: 4, fontSize: 11, color: tk.success.deepText },
    linkCard: {
      marginHorizontal: 16,
      marginTop: 12,
      padding: 16,
    ...
    linkLabel: { fontSize: 12, fontWeight: '600', color: tk.text.medium },
    linkText: { marginTop: 6, fontSize: 13, color: tk.success.DEFAULT },
    linkActions: { flexDirection: 'row', gap: 8, marginTop: 10 },
    linkBtn: { flex: 1, paddingVertical: 8, borderRadius: 8, alignItems: 'center' },
    copyBtn: { backgroundColor: tk.success.DEFAULT },
    shareBtn: { backgroundColor: tk.surface.card },
    linkBtnText: { fontSize: 13, color: tk.surface.light },
    ...
    ruleText: { fontSize: 12, color: tk.text.secondary, marginVertical: 3, lineHeight: 18 },
    ...
    recordName: { fontSize: 14, fontWeight: '600', color: tk.text.primary },
    recordDate: { marginTop: 2, fontSize: 11, color: tk.text.tertiary },
    recordRight: { alignItems: 'flex-end' },
    recordContribution: { fontSize: 13, fontWeight: '600', color: tk.success.DEFAULT },
    recordStatus: {
      marginTop: 4,
      paddingHorizontal: 6,
      paddingVertical: 1,
