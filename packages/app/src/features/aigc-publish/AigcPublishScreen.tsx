      ...
      {showTextInput ? (
        ...
        <>
          <Text style={styles.label}>
            {t('aigcPublish.labelUpload', { count: files.length })}
          </Text>
          ...
          >
            {uploading ? (
              <View style={styles.pickerBtnInner}>
                ...
                <Text style={styles.pickerBtnTextUploading}>
                  {t('aigcPublish.uploading')}
                </Text>
              </View>
            ) : (
...
function createStyles(tk: AppThemeTokens) {
  ...
  return StyleSheet.create({
    ...
    subtitle: { marginTop: 4, fontSize: 13, color: tk.text.secondary, marginBottom: 12 },
    label: { marginTop: 14, fontSize: 12, color: tk.text.secondary, marginBottom: 6 },
    errorText: { fontSize: 13, color: tk.error.text, marginTop: 4 },
    ...
    typeChipText: { fontSize: 13, color: tk.text.medium, fontWeight: '600' },
    typeChipTextActive: { color: tk.surface.light },
    typeChipDesc: { marginTop: 2, fontSize: 10, color: tk.text.tertiary },
    ...
    urlAddBtn: { paddingHorizontal: 14, paddingVertical: 10, borderRadius: 8, backgroundColor: primary },
    urlAddText: { color: tk.surface.light, fontSize: 13, fontWeight: '600' },
    pickerBtn: {
      paddingVertical: 11,
      borderRadius: 8,
      borderWidth: 1,
    ...
    pickerBtnDisabled: { opacity: 0.6, borderColor: tk.text.tertiary, backgroundColor: tk.text.tertiary },
    pickerBtnInner: { flexDirection: 'row', alignItems: 'center', gap: 6 },
    pickerBtnText: { color: primary, fontSize: 13, fontWeight: '600' },
    pickerBtnTextUploading: { color: tk.surface.light, fontSize: 13, fontWeight: '600' },
    ...
    fileAddText: { fontSize: 11, color: tk.text.tertiary, marginTop: 2 },
    submitBtn: {
      marginTop: 24,
      paddingVertical: 14,
      borderRadius: 8,
