...
function createStyles(tk: AppThemeTokens) {
  return StyleSheet.create({
    ...
    avatarText: { fontSize: 20, fontWeight: '600', color: tk.purple.DEFAULT },
    baseMain: { flex: 1 },
    ...
    priceUnit: { fontSize: 18, fontWeight: '600', color: tk.purple.DEFAULT, marginRight: 8 },
    priceInput: { flex: 1, paddingVertical: 10, fontSize: 14, color: tk.text.primary },
    btn: {
      marginTop: 28,
      height: 46,
      borderRadius: 12,
    ...
    btnText: { fontSize: 15, fontWeight: '600', color: tk.surface.light },
  })
}
