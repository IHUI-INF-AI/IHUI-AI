...
function createStyles(tk: AppThemeTokens) {
  return StyleSheet.create({
    ...
    btnPrimary: { backgroundColor: tk.success.DEFAULT },
    btnGhost: {
      backgroundColor: tk.surface.bg,
      borderWidth: 1,
      borderColor: tk.border.light,
    ...
    btnTextPrimary: { color: tk.surface.light, fontSize: 14, fontWeight: '600' },
    btnTextGhost: { color: tk.text.medium, fontSize: 14, fontWeight: '600' },
    testRow: {
      flexDirection: 'row',
      alignItems: 'center',
      justifyContent: 'space-between',
    },
    testLabel: { fontSize: 13, color: tk.text.medium },
    testBtn: {
    ...
    testBtnText: { color: tk.surface.light, fontSize: 13, fontWeight: '600' },
    statusOk: { fontSize: 12, color: tk.success.DEFAULT, marginTop: 8 },
    statusErr: { fontSize: 12, color: tk.danger.DEFAULT, marginTop: 8 },
    toast: {
      fontSize: 12,
