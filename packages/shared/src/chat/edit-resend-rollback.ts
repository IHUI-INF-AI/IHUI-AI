...
export const EDIT_RESEND_STEPS = [
  'edit',
  'preview',
  'confirm',
  'rollback',
...
const FAILURE_SET: ReadonlySet<EditResendPhase> = new Set<EditResendPhase>(
 ...
 */
export async function composeEditResend(
  ctx: EditResendComposeContext,
): Promise<EditResendComposeResult> {
