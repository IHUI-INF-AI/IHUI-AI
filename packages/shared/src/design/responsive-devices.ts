...
export const RESPONSIVE_DEVICES: ResponsiveDevice[] = [
  {
    id: 'mobile-portrait',
    nameKey: 'design.responsive.deviceMobilePortrait',
    width: 375,
    height: 667,
    icon: 'phone',
    category: 'mobile',
  ...
  {
    id: 'mobile-landscape',
    nameKey: 'design.responsive.deviceMobileLandscape',
    width: 667,
    height: 375,
    icon: 'phone',
    category: 'mobile',
  ...
  {
    id: 'tablet-portrait',
    nameKey: 'design.responsive.deviceTabletPortrait',
    width: 768,
    height: 1024,
    icon: 'tablet',
    category: 'tablet',
  ...
  {
    id: 'tablet-landscape',
    nameKey: 'design.responsive.deviceTabletLandscape',
    width: 1024,
    height: 768,
    icon: 'tablet',
    category: 'tablet',
  ...
  {
    id: 'desktop',
    nameKey: 'design.responsive.deviceDesktop',
    width: 1440,
    height: 900,
    icon: 'desktop',
    category: 'desktop',
  ...
  {
    id: 'custom',
    nameKey: 'design.responsive.deviceCustom',
    width: 0,
    height: 0,
    icon: 'custom',
    category: 'custom',
