...
const LANDING_HTML = `<div id="root" style="font-family:sans-serif">
  ...
  <section id="features" style="display:flex;gap:16px;padding:24px">
    <div style="flex:1;padding:16px;border:1px solid ${DOC_BORDER};border-radius:8px">
...
const LOGIN_HTML = `<div id="root" style="display:flex;align-items:center;justify-content:center;min-height:100vh;font-family:sans-serif">
  <div id="card" style="width:320px;padding:32px;border:1px solid ${DOC_BORDER};border-radius:8px">
    <h2 style="margin:0 0 16px;text-align:center;font-size:20px">Login</h2>
    <input id="email" placeholder="Email" style="width:100%;padding:8px;margin-bottom:12px;border:1px solid ${DOC_BORDER_HARD};border-radius:4px;box-sizing:border-box;font-size:13px" />
    <input id="password" type="password" placeholder="Password" style="width:100%;padding:8px;margin-bottom:16px;border:1px solid ${DOC_BORDER_HARD};border-radius:4px;box-sizing:border-box;font-size:13px" />
...
const BLOG_HTML = `<div id="root" style="display:flex;gap:24px;padding:24px;font-family:sans-serif;max-width:960px;margin:0 auto">
  ...
  <aside id="sidebar" style="width:200px;padding:16px;border:1px solid ${DOC_BORDER};border-radius:8px;align-self:flex-start">
...
const PRODUCT_HTML = `<div id="root" style="display:flex;gap:24px;padding:24px;font-family:sans-serif;max-width:960px;margin:0 auto">
  <div id="gallery" style="flex:1;background:${DOC_BG_CARD};border-radius:8px;min-height:320px;display:flex;align-items:center;justify-content:center;color:${DOC_TEXT_MUTED};font-size:14px">Image</div>
...
const PRICING_HTML = `<div id="root" style="padding:24px;font-family:sans-serif">
  ...
  <div id="plans" style="display:flex;gap:16px">
    <div id="starter" style="flex:1;padding:24px;border:1px solid ${DOC_BORDER};border-radius:8px">
    ...
    <div id="team" style="flex:1;padding:24px;border:1px solid ${DOC_BORDER};border-radius:8px">
...
const PROFILE_HTML = `<div id="root" style="display:flex;flex-direction:column;align-items:center;padding:24px;font-family:sans-serif">
  <div id="avatar" style="width:96px;height:96px;background:${DOC_BG_CARD};border-radius:8px;display:flex;align-items:center;justify-content:center;color:${DOC_TEXT_BODY};font-size:36px;font-weight:600">A</div>
  ...
  <div id="social" style="display:flex;gap:12px">
    <button style="padding:6px 16px;border:1px solid ${DOC_BORDER_HARD};border-radius:4px;background:transparent;cursor:pointer;font-size:12px">Twitter</button>
    <button style="padding:6px 16px;border:1px solid ${DOC_BORDER_HARD};border-radius:4px;background:transparent;cursor:pointer;font-size:12px">GitHub</button>
    <button style="padding:6px 16px;border:1px solid ${DOC_BORDER_HARD};border-radius:4px;background:transparent;cursor:pointer;font-size:12px">LinkedIn</button>
  </div>
</div>`
