...
export const rnLightTokens: RnThemeTokens = {
  ...
  surface: { bg: '#FFFFFF', light: '#FFFFFF', muted: '#F9FAFB', card: '#F3F4F6', dark: '#1F2937', inputBg: '#f0f7ff' },
...
export const rnDarkTokens: RnThemeTokens = {
  ...
  surface: { bg: '#1F2937', light: '#FFFFFF', muted: '#111827', card: '#374151', dark: '#0F172A', inputBg: 'rgba(78,163,245,0.15)' },
