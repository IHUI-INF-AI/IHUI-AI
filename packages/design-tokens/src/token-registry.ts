...
const EXTENDED_COLOR_ENTRIES: ReadonlyArray<TokenEntry> = [
  ...
  { name: '--color-brand-accent', type: 'color', defaultValue: '#8fb8cc' },
  { name: '--color-brand-accent-foreground', type: 'color', defaultValue: '#1e3a47' },
  { name: '--color-brand-accent-deep', type: 'color', defaultValue: '#4a7a96' },
...
const TINT_COLOR_ENTRIES: ReadonlyArray<TokenEntry> = [
  ...
  { name: '--color-brand-accent-tint', type: 'color', defaultValue: 'rgba(143, 184, 204, 0.18)' },
  {
    name: '--color-brand-accent-tint-strong',
    type: 'color',
    defaultValue: 'rgba(143, 184, 204, 0.4)',
  },
...
const RN_FINE_COLOR_ENTRIES: ReadonlyArray<TokenEntry> = [
  ...
  {
    name: '--color-brand-accent-light',
    type: 'color',
    defaultValue: '#eaf2f7',
    description: '品牌灰蓝浅底(RN brandAccent.light,页面浅灰蓝底)',
  },
  {
