// 临时脚本: 用 password-crypto(argon2id)生成 [REDACTED-PW] 密码 hash,并更新 users 表 admin 用户为硬约束规范
...
try {
  ...
  // 生成 [REDACTED-PW] 密码 hash(argon2id)
  const passwordHash = await hashPassword('[REDACTED-PW]')
