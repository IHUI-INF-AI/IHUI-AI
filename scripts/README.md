...
> 注:一次性脚本(fix-*/scan-zh-tw-*)已删除,迁移审计脚本已归档到 .trae-cn/archive/scripts/migration-audit/。精简日期:2026-07-25
...
| setup-admin-account.mjs | 用 bcryptjs 生成 [REDACTED-PW] 密码 hash,更新 users 表 admin 用户 | — | 临时脚本 |
