/**
 * @file mobile-rn 端 i18n 死 key 扫描器集成测试
 * @description 端到端覆盖 _i18n-scan-helpers.mjs 的 main() 入口,模拟 mobile-rn 端
...
// mobile-rn 端配置(对应 scripts/scan-mobile-rn-dead-i18n-keys.mjs)
const END_CONFIG = {
  name: 'mobile-rn',
...
const CODE_FILE = 'apps/mobile-rn/src/page.tsx'
...
describe('mobile-rn 端 i18n 死 key 扫描器集成测试(main() 端到端)', () => {
