...
const DEAD_KEYS = [
  ...
  // commandArg.* (42) — 2026-08-20 新发现
  'commandArg.goalBenchmark',
  'commandArg.goalDeadCode',
  'commandArg.goalE2e',
  'commandArg.goalFixTs',
  'commandArg.goalLint',
  'commandArg.goalMigrateShared',
  'commandArg.goalPassTests',
  'commandArg.goalRefactor',
  'commandArg.loop10',
  'commandArg.loop20',
  'commandArg.loop5',
  'commandArg.loopOff',
  'commandArg.loopOn',
  'commandArg.goalBench.label',
  'commandArg.goalBench.description',
  'commandArg.goalBenchMark',
  'commandArg.goalBenchmarkLabel',
  'commandArg.goalBenchmarkDesc',
  'commandArg.goalDeadCodeLabel',
  'commandArg.goalDeadCodeDesc',
  'commandArg.goalE2eLabel',
  'commandArg.goalE2eDesc',
  'commandArg.goalFixTsLabel',
  'commandArg.goalFixTsDesc',
  'commandArg.goalLintLabel',
  'commandArg.goalLintDesc',
  'commandArg.goalMigrateSharedLabel',
  'commandArg.goalMigrateSharedDesc',
  'commandArg.goalPassTestsLabel',
  'commandArg.goalPassTestsDesc',
  'commandArg.goalRefactorLabel',
  'commandArg.goalRefactorDesc',
  'commandArg.loop5Label',
  'commandArg.loop5Desc',
  'commandArg.loop10Label',
  'commandArg.loop10Desc',
  'commandArg.loop20Label',
  'commandArg.loop20Desc',
  'commandArg.loopOnLabel',
  'commandArg.loopOnDesc',
  'commandArg.loopOffLabel',
  'commandArg.loopOffDesc',
  // withdrawals.* (53) — 2026-08-20 新发现
  'withdrawals.detail.accountInfo',
  'withdrawals.detail.amount',
  'withdrawals.detail.applyTime',
  'withdrawals.detail.bankInfo',
  'withdrawals.detail.completeTime',
  'withdrawals.detail.fee',
  'withdrawals.detail.id',
  'withdrawals.detail.method',
  'withdrawals.detail.remark',
  'withdrawals.detail.status',
  'withdrawals.detail.title',
  'withdrawals.detail.userInfo',
  'withdrawals.export.amount',
  'withdrawals.export.applyTime',
  'withdrawals.export.bankInfo',
  'withdrawals.export.completeTime',
  'withdrawals.export.filename',
  'withdrawals.export.id',
  'withdrawals.export.method',
  'withdrawals.export.remark',
  'withdrawals.export.status',
  'withdrawals.export.userInfo',
  'withdrawals.filter.account',
  'withdrawals.filter.accountPlaceholder',
  'withdrawals.filter.amount',
  'withdrawals.filter.applyTime',
  'withdrawals.filter.completeTime',
  'withdrawals.filter.method',
  'withdrawals.filter.methodPlaceholder',
  'withdrawals.filter.status',
  'withdrawals.filter.statusPlaceholder',
  'withdrawals.filter.userId',
  'withdrawals.filter.userIdPlaceholder',
  'withdrawals.reject',
  'withdrawals.review.reject',
  'withdrawals.table.action',
  'withdrawals.table.amount',
  'withdrawals.table.applyTime',
  'withdrawals.table.completeTime',
  'withdrawals.table.fee',
  'withdrawals.table.method',
  'withdrawals.table.remark',
  'withdrawals.table.status',
  'withdrawals.table.userInfo',
  'withdrawals.toast.approveFailed',
  'withdrawals.toast.approveSuccess',
  'withdrawals.toast.confirmApprove',
  'withdrawals.toast.confirmReject',
  'withdrawals.toast.confirmRemit',
  'withdrawals.toast.rejectFailed',
  'withdrawals.toast.rejectSuccess',
  'withdrawals.toast.remitFailed',
  'withdrawals.toast.remitSuccess',
  // 其他零散死 key (2026-08-20)
  'detail.subtitle',
  'dict.fieldEvents',
  'operationLogs.detail.id',
  'operationLogs.table.operUrl',
]
