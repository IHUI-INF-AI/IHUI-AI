...
alter table t_department modify id bigint auto_increment comment '主键id';

-- changeset bill:202103312
...
create table t_lecturer(
  id bigint auto_increment comment '主键id',
  user_id bigint not null comment '用户id',
  job_title nvarchar(500) not null default '' comment '头衔' ,
  mobile varchar(100) not null default '' comment '联系电话' ,
  image varchar(2000) not null default '' comment '头像' ,
  description nvarchar(4000) not null default '' comment '简介',
  status varchar(200) not null default '' comment '状态',
  create_time timestamp default current_timestamp comment '创建时间',
  update_time timestamp default current_timestamp on update current_timestamp comment '最后修改时间',
  primary key(id)
) comment '讲师';
...
create table t_company(
   id bigint auto_increment comment '主键id',
   name nvarchar(500) not null comment '名称' ,
   image varchar(2000) not null default '' comment 'logo' ,
   mobile varchar(100) not null comment '联系电话' ,
   email varchar(200) not null comment '简介',
