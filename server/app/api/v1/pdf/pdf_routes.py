...
async def upload_pdf(file: UploadFile = File(...)):
    if not file.filename.lower().endswith('.pdf'):  # type: ignore[union-attr]
...
async def add_signature(
    ...
    output_path, sig_info = PDFSignatureService.add_signature(  # type: ignore[attr-defined]
        pdf_path=pdf_path,
...
async def verify_signature(file_id: str):
    ...
    signatures = PDFSignatureService.verify_signature(pdf_path)  # type: ignore[attr-defined]
