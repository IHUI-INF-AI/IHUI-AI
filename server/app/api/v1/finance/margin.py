...
def expire(
    ...
    result = token_service.expire_token(user_uuid, quantity, source=source)
    if not result["success"]:
...
def grant_commission(
    ...
    result = token_service.grant_commission(
        user_uuid,
        quantity,
...
def refund_token(
    ...
    result = token_service.refund_token(
        user_uuid,
        quantity,
...
def list_flows(
    ...
    result = token_service.list_token_flows(user_uuid, page, limit, op_type=op_type)
