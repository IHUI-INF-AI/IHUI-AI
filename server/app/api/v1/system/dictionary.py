...
迁移自 ai-smart-society-java + edu Java 微服务: SysDictTypeController / SysDictDataController (13 端点)
对应模型:
...
def dict_type_list(
    ...
    return _ok({"list": [_dict_type_to_dict(i) for i in items], "total": total})
...
def dict_data_list(
    ...
    return _ok({"list": [_dict_data_to_dict(i) for i in items], "total": total})
