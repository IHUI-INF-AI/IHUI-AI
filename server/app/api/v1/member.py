...
async def get_member(member_id: str, _user: str = Depends(require_login)):
...
async def get_member_by_mobile(mobile: str, _user: str = Depends(require_login)):
...
async def get_member_by_openid(open_id: str, _user: str = Depends(require_login)):
...
async def create_member(req: CreateMemberReq, _user: str = Depends(require_login)):
...
async def create_company(req: CreateCompanyReq, _user: str = Depends(require_login)):
...
async def add_member_to_company(company_id: str, member_id: str, _user: str = Depends(require_login)):
...
async def list_member_companies(member_id: str, _user: str = Depends(require_login)):
...
async def create_tag(req: CreateTagReq, _user: str = Depends(require_login)):
...
async def tag_member(tag_id: str, member_id: str, _user: str = Depends(require_login)):
    r = member_service.tag_member(member_id=member_id, tag_id=tag_id)
    return {"code": 0, "data": _to_dict(r), "msg": "ok"}


@router.get("/{member_id}/tags", summary="查询会员标签")
async def list_member_tags(member_id: str, _user: str = Depends(require_login)):
...
async def create_post(req: CreatePostReq, _user: str = Depends(require_login)):
...
async def assign_post(post_id: str, member_id: str, _user: str = Depends(require_login)):
    r = member_service.assign_post(member_id=member_id, post_id=post_id)
    return {"code": 0, "data": _to_dict(r), "msg": "ok"}


@router.post("/group", summary="创建会员分组")
async def create_group(req: CreateGroupReq, _user: str = Depends(require_login)):
...
async def add_to_group(group_id: str, member_id: str, _user: str = Depends(require_login)):
...
async def create_level(req: CreateLevelReq, _user: str = Depends(require_login)):
...
async def grant_level(level_id: str, member_id: str, _user: str = Depends(require_login)):
...
async def do_checkin(req: CheckinReq, _user: str = Depends(require_login)):
...
async def follow_member(req: FollowReq, _user: str = Depends(require_login)):
...
async def unfollow_member(req: FollowReq, _user: str = Depends(require_login)):
...
async def list_following(member_id: str, _user: str = Depends(require_login)):
