"""TBox 智能体发布相关 Pydantic schemas.

迁移自 ZHS_Server_java/mcp/domain/TBoxBean.java、
TBoxAgentContentBean.java、TBoxAgentCustomBean.java.

注: 原位于 app/models/tbox_models.py, 因内容为 Pydantic BaseModel (非 SQLAlchemy ORM),
于 2026-06-30 迁移至 app/schemas/ 目录以明确区分 schemas 与 models.
"""
