...
try:
    ...
    SHADOW_COMPARE_TOTAL = None  # type: ignore[assignment]
    SHADOW_COMPARE_MISMATCH_TOTAL = None  # type: ignore[assignment]
    SHADOW_REQUEST_DURATION = None  # type: ignore[assignment]
...
class ShadowRouter:
    ...
    async def run(
        ...
        # 影子异步启动 (主流程不等)
        asyncio.create_task(_shadow_then_compare())  # noqa: RUF006
