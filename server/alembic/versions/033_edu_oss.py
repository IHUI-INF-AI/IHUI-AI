...
def upgrade() -> None:
    """Create edu_oss tables using SQLAlchemy metadata."""
    ...
    target_tables = ['edu_oss_file', 'edu_oss_upload_session']
...
def downgrade() -> None:
    """Drop edu_oss tables (Phase B: drops are safe as data is recoverable)."""
    from app.config import settings
    from app.database import Base
