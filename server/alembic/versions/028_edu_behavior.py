...
def upgrade() -> None:
    """Create edu_behavior tables using SQLAlchemy metadata."""
    ...
    target_tables = ['edu_behavior_view']
...
def downgrade() -> None:
    """Drop edu_behavior tables (Phase B: drops are safe as data is recoverable)."""
    from app.config import settings
    from app.database import Base
