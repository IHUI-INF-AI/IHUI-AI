"""Create edu edu_search tables.

Revision ID: 034_edu_search
Revises: 033_edu_oss
Create Date: 2026-06-24 (Phase B)

Tables created: edu_search_index
"""
import logging
...
def upgrade() -> None:
    """Create edu_search tables using SQLAlchemy metadata."""
    ...
    target_tables = ['edu_search_index']
...
def downgrade() -> None:
    """Drop edu_search tables (Phase B: drops are safe as data is recoverable)."""
    from app.config import settings
    from app.database import Base
