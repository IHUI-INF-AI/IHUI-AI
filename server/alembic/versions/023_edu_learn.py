"""Create edu edu_learn tables.

Revision ID: 023_edu_learn
Revises: 022_edu_content
Create Date: 2026-06-24 (Phase B)

Tables created: edu_course, edu_course_chapter, edu_course_section, edu_learn_record, edu_homework, edu_homework_submission, edu_certificate
"""
import logging
...
def upgrade() -> None:
    """Create edu_learn tables using SQLAlchemy metadata."""
    ...
    target_tables = ['edu_course', 'edu_course_chapter', 'edu_course_section', 'edu_learn_record', 'edu_homework', 'edu_homework_submission', 'edu_certificate']
...
def downgrade() -> None:
    """Drop edu_learn tables (Phase B: drops are safe as data is recoverable)."""
    from app.config import settings
    from app.database import Base
