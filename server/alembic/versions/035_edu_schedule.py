...
def upgrade() -> None:
    """Create edu_schedule tables using SQLAlchemy metadata."""
    ...
    target_tables = ['edu_schedule_course']
...
def downgrade() -> None:
    """Drop edu_schedule tables (Phase B: drops are safe as data is recoverable)."""
    from app.config import settings
    from app.database import Base
