...
def upgrade() -> None:
    """Create edu_setting tables using SQLAlchemy metadata."""
    ...
    target_tables = ['edu_setting_dict']
...
def downgrade() -> None:
    """Drop edu_setting tables (Phase B: drops are safe as data is recoverable)."""
    from app.config import settings
    from app.database import Base
