...
def upgrade() -> None:
    """Create edu_member tables using SQLAlchemy metadata."""
    ...
    target_tables = ['edu_member', 'edu_member_parent']
...
def downgrade() -> None:
    """Drop edu_member tables (Phase B: drops are safe as data is recoverable)."""
    from app.config import settings
    from app.database import Base
