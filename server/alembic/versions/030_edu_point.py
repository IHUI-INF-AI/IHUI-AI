"""Create edu edu_point tables.

Revision ID: 030_edu_point
Revises: 029_edu_pay
Create Date: 2026-06-24 (Phase B)

Tables created: edu_point_account, edu_point_record
"""
import logging
...
def upgrade() -> None:
    """Create edu_point tables using SQLAlchemy metadata."""
    ...
    target_tables = ['edu_point_account', 'edu_point_record']
...
def downgrade() -> None:
    """Drop edu_point tables (Phase B: drops are safe as data is recoverable)."""
    from app.config import settings
    from app.database import Base
