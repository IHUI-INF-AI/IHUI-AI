...
// checks if the ProductIdentityCreate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProductIdentityCreate{}

// ProductIdentityCreate struct for ProductIdentityCreate
type ProductIdentityCreate struct {
	Id string `json:"id"`
...
type _ProductIdentityCreate ProductIdentityCreate
...
func (o *ProductIdentityCreate) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *ProductIdentityCreate) SetDescriptionNil() {
...
func (o *ProductIdentityCreate) SetPriceNil() {
	o.Price.Set(nil)
}
...
func (o *ProductIdentityCreate) SetTokenAmountNil() {
...
func (o *ProductIdentityCreate) SetIdentityTypeNil() {
...
func (o *ProductIdentityCreate) SetDurationDaysNil() {
...
func (o *ProductIdentityCreate) SetStatusNil() {
	o.Status.Set(nil)
}
...
func (o *ProductIdentityCreate) SetSortNil() {
	o.Sort.Set(nil)
}
...
func (o ProductIdentityCreate) MarshalJSON() ([]byte, error) {
...
func (o ProductIdentityCreate) ToMap() (map[string]interface{}, error) {
...
func (o *ProductIdentityCreate) UnmarshalJSON(data []byte) (err error) {
	...
	varProductIdentityCreate := _ProductIdentityCreate{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varProductIdentityCreate)

	if err != nil {
		return err
	}

	*o = ProductIdentityCreate(varProductIdentityCreate)

	return err
}

type NullableProductIdentityCreate struct {
	value *ProductIdentityCreate
	isSet bool
}

func (v NullableProductIdentityCreate) Get() *ProductIdentityCreate {
	return v.value
}

func (v *NullableProductIdentityCreate) Set(val *ProductIdentityCreate) {
	v.value = val
	v.isSet = true
}

func (v NullableProductIdentityCreate) IsSet() bool {
	return v.isSet
}

func (v *NullableProductIdentityCreate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProductIdentityCreate(val *ProductIdentityCreate) *NullableProductIdentityCreate {
	return &NullableProductIdentityCreate{value: val, isSet: true}
}

func (v NullableProductIdentityCreate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProductIdentityCreate) UnmarshalJSON(src []byte) error {
	v.isSet = true
