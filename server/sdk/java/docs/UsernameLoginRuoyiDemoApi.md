...
import org.openapitools.client.api.UsernameLoginRuoyiDemoApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    UsernameLoginRuoyiDemoApi apiInstance = new UsernameLoginRuoyiDemoApi(defaultClient);
    ...
    try {
      ...
      System.err.println("Exception when calling UsernameLoginRuoyiDemoApi#loginByUsernameApiV1LoginUsernamePost");
