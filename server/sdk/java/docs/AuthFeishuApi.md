...
import org.openapitools.client.api.AuthFeishuApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    AuthFeishuApi apiInstance = new AuthFeishuApi(defaultClient);
    ...
    try {
      ...
      System.err.println("Exception when calling AuthFeishuApi#feishuPcTestApiV1AuthLoginFeishuPcTestGet");
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling AuthFeishuApi#feishuPcWxCodeApiV1AuthLoginFeishuPcWxCodeGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
