...
import org.openapitools.client.api.CozeWorkflowsAsyncApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    CozeWorkflowsAsyncApi apiInstance = new CozeWorkflowsAsyncApi(defaultClient);
    ...
    try {
      ...
      System.err.println("Exception when calling CozeWorkflowsAsyncApi#runWorkflowAsyncApiV1CozeWorkflowsAsyncWorkflowsAsyncPost");
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling CozeWorkflowsAsyncApi#streamWorkflowAsyncApiV1CozeWorkflowsAsyncWorkflowsAsyncStreamPost");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling CozeWorkflowsAsyncApi#workflowChatApiV1CozeWorkflowsAsyncWorkflowsAsyncChatPost");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
