...
import org.openapitools.client.api.FundOperationsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    FundOperationsApi apiInstance = new FundOperationsApi(defaultClient);
    ...
    try {
      ...
      System.err.println("Exception when calling FundOperationsApi#createFundOrderApiV1PaymentsCreateOrderPost");
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling FundOperationsApi#fundTransferApiV1PaymentsTransferPost");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling FundOperationsApi#fundWechatPayApiV1PaymentsWechatPayPost");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling FundOperationsApi#fundWithdrawalApiV1PaymentsWithdrawalPost");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
