...
public class SubscribeRequest {
  public static final String SERIALIZED_NAME_VIP_LEVEL_ID = "vip_level_id";
  @SerializedName(SERIALIZED_NAME_VIP_LEVEL_ID)
  ...
  public SubscribeRequest vipLevelId(@javax.annotation.Nonnull Integer vipLevelId) {
  ...
  public void setVipLevelId(@javax.annotation.Nonnull Integer vipLevelId) {
    this.vipLevelId = vipLevelId;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.vipLevelId, subscribeRequest.vipLevelId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(vipLevelId);
  }
  ...
  public String toString() {
    ...
    sb.append("    vipLevelId: ").append(toIndentedString(vipLevelId)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("vip_level_id"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("vip_level_id"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SubscribeRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SubscribeRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
