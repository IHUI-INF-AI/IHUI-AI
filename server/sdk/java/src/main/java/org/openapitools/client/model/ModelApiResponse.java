...
public class ModelApiResponse {
  ...
  public ModelApiResponse ok(@javax.annotation.Nullable Boolean ok) {
    this.ok = ok;
    return this;
  }
  ...
  public ModelApiResponse data(@javax.annotation.Nullable Map<String, Object> data) {
    this.data = data;
    return this;
  }

  public ModelApiResponse putDataItem(String key, Object dataItem) {
    if (this.data == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.ok, _apiResponse.ok) &&
        Objects.equals(this.data, _apiResponse.data);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ok, data);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("ok", "data"));
