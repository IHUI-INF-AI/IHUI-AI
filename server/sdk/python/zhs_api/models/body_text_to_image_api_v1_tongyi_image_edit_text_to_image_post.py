...
class BodyTextToImageApiV1TongyiImageEditTextToImagePost(BaseModel):
    """
    BodyTextToImageApiV1TongyiImageEditTextToImagePost
    """ # noqa: E501
    model: Optional[StrictStr] = 'qwen-image'
    prompt: StrictStr
    negative_prompt: Optional[StrictStr] = None
    size: Optional[StrictStr] = '1024*1024'
    n: Optional[StrictInt] = 1
    style: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["model", "prompt", "negative_prompt", "size", "n", "style"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "model": obj.get("model") if obj.get("model") is not None else 'qwen-image',
            "prompt": obj.get("prompt"),
            "negative_prompt": obj.get("negative_prompt"),
            "size": obj.get("size") if obj.get("size") is not None else '1024*1024',
