...
class BodyTongyiImageEdit(BaseModel):
    """
    BodyTongyiImageEdit
    """ # noqa: E501
    model: Optional[StrictStr] = 'qwen-image-edit'
    image_url: Optional[StrictStr] = None
    image_base64: Optional[StrictStr] = None
    prompt: StrictStr
    negative_prompt: Optional[StrictStr] = None
    n: Optional[StrictInt] = 1
    __properties: ClassVar[List[str]] = ["model", "image_url", "image_base64", "prompt", "negative_prompt", "n"]
