...
class NoticePushReq(BaseModel):
    ...
    NoticePushReq
    """ # noqa: E501
    topic: Optional[StrictStr] = 'announcement'
    title: Optional[StrictStr] = ''
    content: Optional[StrictStr] = ''
    user_id: Optional[StrictStr] = Field(default=None, alias="userId")
    level: Optional[StrictStr] = 'info'
    extra: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["topic", "title", "content", "userId", "level", "extra"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "topic": obj.get("topic") if obj.get("topic") is not None else 'announcement',
