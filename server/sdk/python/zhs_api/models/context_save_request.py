...
class ContextSaveRequest(BaseModel):
    ...
    """ # noqa: E501
    agent_id: StrictStr
    context_key: StrictStr
    context_value: StrictStr
    field_name: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["agent_id", "context_key", "context_value", "field_name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "context_value": obj.get("context_value"),
