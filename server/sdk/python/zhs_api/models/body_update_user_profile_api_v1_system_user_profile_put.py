...
class BodyUpdateUserProfileApiV1SystemUserProfilePut(BaseModel):
    """
    ...
    sex: Optional[StrictStr] = Field(default=None, description="0=男 1=女 2=未知")
    remark: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["nick_name", "email", "phone", "sex", "remark"]
