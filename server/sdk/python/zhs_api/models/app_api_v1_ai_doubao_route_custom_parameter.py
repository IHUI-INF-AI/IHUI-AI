...
class AppApiV1AiDoubaoRouteCustomParameter(BaseModel):
    """
    Custom parameter model for image/video generation.
    """ # noqa: E501
    name: StrictStr = Field(description="Parameter name")
    desc: StrictStr = Field(description="Parameter description")
    value: Optional[Any]
    __properties: ClassVar[List[str]] = ["name", "desc", "value"]
