...
| 13      | check-cli-integration-completeness.mjs | cli 통합 완전성                             |
...
| **연락 전화**      | [REDACTED-PHONE]                                                      |
| **이메일**         | [REDACTED-EMAIL] · lizong@aizhs.top                              |
...
- **기계가 인간 review 대신**: 17개 가드레일은 API key 유출·i18n 키 무결성·zh-TW 간체자 잔류·ko 중국어 잔류·ja 잔류·en 기계번역 파손·schema drift·stale dist·UTF-8 BOM·API 라우트 일치성·safeParse 무시·의존성 파편화·skipResponseSanitization·border-radius 위반·배포 보고서 일치성·cli 통합·마이그레이션 완전성·CSS 색상 토큰 중첩·네이티브 title tooltip·staged 오염 경고를 커버합니다
