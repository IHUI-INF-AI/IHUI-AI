/**
 * Compaction V2 — 融合 grok-build `xai-grok-compaction` crate 设计理念的上下文压缩模块。
 *
...
/**
 * selectTurnsToCompact — 移植自 grok-build select.rs:60-147。
...
/**
 * shouldCompact — 移植自 grok-build trigger.rs:117-149。
...
/**
 * sampleWithRetry — 移植自 grok-build sampler.rs:90-104。
