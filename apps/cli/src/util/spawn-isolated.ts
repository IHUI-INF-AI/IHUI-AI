 ...
 *
 * 灵感来源:参考 xai-grok-mermaid/src/subprocess.rs
 * 简化策略(做减法):
...
/** 子进程执行失败原因(对齐 xai-grok-mermaid/src/subprocess.rs::SubprocessError) */
 ...
 * 参考 xai-grok-mermaid/src/subprocess.rs::spawn_with_etxtbsy_retry。
 */
