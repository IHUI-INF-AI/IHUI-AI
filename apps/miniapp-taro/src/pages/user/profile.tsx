...
export default function Profile() {
  ...
  return (
    <View className="pf-page">
          ...
          >
            <View className="pf-avatar-wrap">
              ...
              <View className="pf-avatar-edit-tip">
                <Text>{t('user.profile.changeAvatar', '更换')}</Text>
              </View>
            </View>
            <Text className="pf-avatar-hint">
              {t('user.profile.clickToChange', '点击更换头像')}
            </Text>
      ...
      {/* 账号信息 section */}
      <View className="pf-section">
        <Text className="pf-section-title">{t('user.profile.accountInfo', '账号信息')}</Text>
        <View className="pf-section-card">
          {accountRows.map((row) => (
            <View
              key={row.path}
      ...
      {/* 安全设置 section */}
      <View className="pf-section">
        <Text className="pf-section-title">{t('user.profile.security', '安全设置')}</Text>
        <View className="pf-section-card">
      ...
      {/* 反馈 section */}
      <View className="pf-section">
        <Text className="pf-section-title">{t('user.profile.other', '其他')}</Text>
        <View className="pf-section-card">
          <View
            className="pf-item"
