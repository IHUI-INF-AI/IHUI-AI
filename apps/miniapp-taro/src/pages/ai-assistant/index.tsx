  ...
  return (
    <View className="flex flex-col h-screen bg-background box-border">
      <View className="flex items-center px-[40rpx] py-[24rpx] bg-card">
        ...
        <Text className="flex-1 text-center text-[64rpx] font-semibold text-foreground truncate">
          {pageTitle}
        </Text>
        ...
        <ScrollView scrollX className="mb-[16rpx]">
          <View className="flex gap-[24rpx]">
            {SUGGESTED.map((q) => (
              <View
                key={q}
                className="px-[32rpx] py-[12rpx] rounded border border-border text-[48rpx] text-foreground whitespace-nowrap"
                onClick={() => {
                  setPrompt(q)
