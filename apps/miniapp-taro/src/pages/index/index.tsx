    ...
    <View className="min-h-screen pb-[40rpx]">
        ...
        <View className="mx-[32rpx] mb-[24rpx] glass px-[24rpx] py-[24rpx]">
          ...
          <View className="flex mt-[20rpx]">
            <View className="flex-1 text-center">
              <Text className="block text-[36rpx] text-neon font-bold">
                {study.todayMinutes}
              </Text>
      ...
      {livePreview.length > 0 ? (
        <View className="mx-[32rpx] my-[24rpx] tech-card px-[24rpx] py-[24rpx]">
          <View className="flex justify-between items-center">
            ...
            <Text className="text-[24rpx] text-muted-foreground" onClick={() => goPage('/pages/live/list')}>
              {t('home.more')} {'>'}
            </Text>
          </View>
      ...
      <View className="mx-[32rpx] my-[24rpx]">
        <View className="flex justify-between items-center mb-[20rpx]">
          ...
          <Text className="text-[24rpx] text-muted-foreground" onClick={() => goPage('/pages/course/list')}>
            {t('home.more')} {'>'}
          </Text>
        </View>
        <ScrollView scrollX>
