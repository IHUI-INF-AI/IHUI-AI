  ...
  return (
    <View className="min-h-screen bg-background">
      <View className="mx-[24rpx] mt-[24rpx] bg-card rounded-[16rpx] p-[32rpx]">
        <Text className="text-[24rpx] text-muted-foreground">{t('distribution.commission.total')}</Text>
        <Text className="block text-[64rpx] text-foreground font-bold mt-[8rpx]">¥{totalCommission}</Text>
      </View>
      {list.length > 0 && (
