      ...
      <ScrollView scrollX className="whitespace-nowrap mb-[16rpx]" enhanced showScrollbar={false}>
        <View className="whitespace-nowrap px-[24rpx]">
          {categories.map((c) => {
            ...
            return (
              <ThemeRoot className="inline-flex items-center gap-[6rpx] h-[64rpx] px-[24rpx] mr-[12rpx] bg-card border-[2rpx] rounded-[10rpx] align-middle ${active ? 'bg-primary/10 border-primary' : 'border-border'}">
      <View key={c.key}
