        ...
        >
          ...
          {info ? (
            <View>
              ...
              <View
                style={{ paddingLeft: toRpx(10), paddingTop: toRpx(16), paddingBottom: toRpx(8) }}
              >
                <Text style={textStyles.calendarTitle(tk)}>
                  {tt('checkIn.calendar', '签到日历')}
                </Text>
              </View>
