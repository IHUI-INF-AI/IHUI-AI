    ...
    <ScrollView scrollX className="w-full">
      <View className="flex items-center box-border w-full py-[36rpx] pl-[20rpx]">
        ...
        {customize ? (
          ...
          >
            <Image className="w-[92rpx] h-[92rpx] mr-[8rpx]" src="/static/images/szdy_20250816161421A290.png" />
            <Text>自定义</Text>
          </View>
        ) : null}
      </View>
      ...
      {addType ? (
        <View className="fixed inset-0 m-auto z-[996] w-[854rpx] h-[606rpx] rounded-[40rpx] bg-white border border-[#DADADA] box-border flex flex-col items-center justify-center">
          <Text className="text-[48rpx] font-bold text-[#3D3D3D] mb-[100rpx]">请设置自定义种类</Text>
          <Input
