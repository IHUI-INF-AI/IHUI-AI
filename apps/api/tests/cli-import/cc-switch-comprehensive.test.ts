          ...
          providers: [
            {
              ...
              settingsConfig: {
                ...
                websiteUrl: 'https://from-settings.com',
              },
            },
          ],
        }),
          ...
          providers: [
            {
              id: 'p1',
              name: 'OpenAI',
              settingsConfig: { apiBaseUrl: 'https://api.openai.com/v1', apiKey: 'sk-a' },
            },
            {
              id: 'p2',
              name: 'Anthropic',
              settingsConfig: { apiBaseUrl: 'https://api.anthropic.com', apiKey: 'sk-b' },
            },
            {
              id: 'p3',
              name: 'Google',
