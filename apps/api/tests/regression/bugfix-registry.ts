...
export interface BugFixRecord {
  ...
  /** 修复轮次(2-18) */
  round: number
  /** 对应的回归测试文件路径(相对 apps/api 根目录),pending 状态时为计划路径 */
  testFile: string
  /** 验证场景简述 */
  scenario: string
 ...
 *
 * 11 条关键场景已全部迁移到 apps/api/tests/regression/ 目录,测试文件均存在。
 */
export const BUG_FIXES: BugFixRecord[] = [
  {
    ...
    round: 3,
    testFile: 'tests/regression/xss-protection.test.ts',
  ...
  },
  {
    ...
    round: 5,
    testFile: 'tests/regression/csrf.test.ts',
  ...
  },
  {
    ...
    round: 7,
    testFile: 'tests/regression/idor-guard.test.ts',
  ...
  },
  {
    ...
    round: 9,
    testFile: 'tests/regression/prompt-injection-guard.test.ts',
  ...
  },
  {
    ...
    round: 11,
    testFile: 'tests/regression/upload-scanner.test.ts',
  ...
  },
  {
    ...
    round: 13,
    testFile: 'tests/regression/audit-chain.test.ts',
  ...
  },
  {
    ...
    round: 15,
    testFile: 'tests/regression/bloom-guard.test.ts',
  ...
  },
  {
    ...
    round: 16,
    testFile: 'tests/regression/deadlock-retry.test.ts',
  ...
  },
  {
    ...
    round: 17,
    testFile: 'tests/regression/db-failover.test.ts',
  ...
  },
  {
    ...
    round: 18,
    testFile: 'tests/regression/chaos-injector.test.ts',
  ...
  },
  {
    ...
    round: 18,
    testFile: 'tests/regression/p0-audit-gaps.test.ts',
