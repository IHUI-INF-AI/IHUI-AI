...
vi.mock('../src/db/statistics-queries.js', () => ({
  getLearnStatistics: vi
    .fn()
    .mockResolvedValue({ lessonTotal: 0, lessonPublished: 0, signupTotal: 0, viewSum: 0 }),
  getExamStatistics: vi
    .fn()
    .mockResolvedValue({
      examTotal: 0,
      examPublished: 0,
  ...
  getContentStatistics: vi
    .fn()
    .mockResolvedValue({ memberTotal: 0, postTotal: 0, announcementTotal: 0, articleTotal: 0 }),
