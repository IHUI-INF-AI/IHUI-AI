  ...
  server.get('/ai-pricing', async (request, reply) => {
    ...
    const items = rows.map((r) => {
      ...
      return {
        ...
        perUnitPrice: r.perUnitPrice === null ? null : Number(r.perUnitPrice),
        tieredCallPrices: r.tieredCallPrices,
        videoUnit: r.videoUnit,
  ...
  server.get('/ai-pricing/:modelId', async (request, reply) => {
    ...
    return reply.send(
      success({
        ...
        perUnitPrice: row.perUnitPrice === null ? null : Number(row.perUnitPrice),
        tieredCallPrices: row.tieredCallPrices,
        videoUnit: row.videoUnit,
