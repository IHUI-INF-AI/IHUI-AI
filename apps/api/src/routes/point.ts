...
export const pointRoutes: FastifyPluginAsync = async (server) => {
  ...
  server.get('/edu-points/channels', { schema: { response: { ...responseSchema } } }, async (_request, reply) => {
    const list = await findAllActiveChannels();
    return reply.send(success({ list }));
  });

  // GET /edu-points/channels/:id - 渠道详情
  server.get('/edu-points/channels/:id', { schema: { response: { ...responseSchema } } }, async (request, reply) => {
  ...
  server.get('/edu-points/rules/:id', { schema: { response: { ...responseSchema } } }, async (request, reply) => {
    const parsed = uuidParamSchema.safeParse(request.params);
    if (!parsed.success) {
      return reply.status(400).send(error(400, parsed.error.issues[0]?.message ?? '参数错误'));
    }
  ...
  server.get('/edu-points/my-points', { schema: { response: { ...responseSchema } } }, async (request, reply) => {
...
export const adminPointRoutes: FastifyPluginAsync = async (server) => {
  ...
  server.get('/edu-points/channels', { schema: { response: { ...responseSchema } } }, async (request, reply) => {
  ...
  server.post('/edu-points/channels', { schema: { response: { ...responseSchema201 } } }, async (request, reply) => {
  ...
  server.put('/edu-points/channels/:id', { schema: { response: { ...responseSchema } } }, async (request, reply) => {
  ...
  server.delete('/edu-points/channels/:id', { schema: { response: { ...responseSchema } } }, async (request, reply) => {
    const parsed = uuidParamSchema.safeParse(request.params);
    if (!parsed.success) {
      return reply.status(400).send(error(400, parsed.error.issues[0]?.message ?? '参数错误'));
    }
  ...
  server.get('/edu-points/rules', { schema: { response: { ...responseSchema } } }, async (request, reply) => {
  ...
  server.post('/edu-points/rules', { schema: { response: { ...responseSchema201 } } }, async (request, reply) => {
  ...
  server.put('/edu-points/rules/:id', { schema: { response: { ...responseSchema } } }, async (request, reply) => {
    const idParsed = uuidParamSchema.safeParse(request.params);
    if (!idParsed.success) {
      return reply.status(400).send(error(400, idParsed.error.issues[0]?.message ?? '参数错误'));
    }
  ...
  server.delete('/edu-points/rules/:id', { schema: { response: { ...responseSchema } } }, async (request, reply) => {
    const parsed = uuidParamSchema.safeParse(request.params);
    if (!parsed.success) {
      return reply.status(400).send(error(400, parsed.error.issues[0]?.message ?? '参数错误'));
    }
  ...
  server.get('/edu-points/relations', { schema: { response: { ...responseSchema } } }, async (request, reply) => {
  ...
  server.put('/edu-points/relations', { schema: { response: { ...responseSchema } } }, async (request, reply) => {
  ...
  server.get('/edu-points/records', { schema: { response: { ...responseSchema } } }, async (request, reply) => {
