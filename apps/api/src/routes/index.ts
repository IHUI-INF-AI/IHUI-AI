...
// FIXME(ai-pricing): ai-pricing.ts 文件缺失(其他 agent 引入未完成),暂时注释避免 API 启动失败
// import { aiPricingRoutes } from './ai-pricing.js'
// FIXME(developer-portal): developer-portal.ts 文件缺失(其他 agent 引入未完成),暂时注释避免 API 启动失败
...
export function registerRoutes(server: FastifyInstance) {
  ...
  // FIXME(ai-pricing): ai-pricing.ts 文件缺失,暂时注释避免 API 启动失败
  // server.register(aiPricingRoutes, { prefix: '/api' })
  // 开发者门户公开元信息（P0-4a/b 配套,开发者门户页用）
  // FIXME(developer-portal): developer-portal.ts 文件缺失,暂时注释避免 API 启动失败
