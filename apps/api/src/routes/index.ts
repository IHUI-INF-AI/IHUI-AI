...
// FIXME(ai-pricing): ai-pricing.ts missing (other agent unfinished), commented out to unblock API startup
// import { aiPricingRoutes } from './ai-pricing.js'
// FIXME(developer-portal): developer-portal.ts missing (other agent unfinished), commented out to unblock API startup
...
export function registerRoutes(server: FastifyInstance) {
  ...
  // FIXME(ai-pricing): ai-pricing.ts missing, commented out
  // server.register(aiPricingRoutes, { prefix: '/api' })
  // 开发者门户公开元信息（P0-4a/b 配套,开发者门户页用）
  // FIXME(developer-portal): developer-portal.ts missing, commented out
