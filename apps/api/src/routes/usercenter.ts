...
export const usercenterRoutes: FastifyPluginAsync = async (server) => {
  ...
  server.get('/usercenter/users/by-phone', {
    schema: {
      summary: '按手机号查用户',
      tags: ['usercenter'],
      querystring: {
  ...
  server.get('/usercenter/users/:id', {
    schema: {
      summary: '按ID查用户',
      tags: ['usercenter'],
      response: {
  ...
  server.put('/usercenter/users/:id', {
    schema: {
      summary: '更新用户',
      tags: ['usercenter'],
      body: {
  ...
  server.put('/usercenter/users/:id/password', {
    schema: {
      summary: '修改密码',
      tags: ['usercenter'],
      body: {
  ...
  server.put('/usercenter/users/:id/reset-password', {
    schema: {
      summary: '重置密码',
      tags: ['usercenter'],
      body: {
  ...
  server.delete('/usercenter/users/:id', {
    schema: {
      summary: '删除用户',
      tags: ['usercenter'],
      response: {
  ...
  server.get('/usercenter/users/:id/certificates', {
    schema: {
      summary: '用户证书列表',
      tags: ['usercenter'],
      response: {
  ...
  server.post('/usercenter/users/:id/certificates', {
    schema: {
      summary: '创建用户证书',
      tags: ['usercenter'],
      body: {
  ...
  server.delete('/usercenter/certificates/:id', {
    schema: {
      summary: '删除证书',
      tags: ['usercenter'],
      response: {
  ...
  server.get('/usercenter/departments', {
    schema: {
      summary: '部门列表',
      tags: ['usercenter'],
      querystring: {
  ...
  server.get('/usercenter/departments/:id', {
    schema: {
      summary: '部门详情',
      tags: ['usercenter'],
      response: {
  ...
  server.post('/usercenter/departments', {
    schema: {
      summary: '创建部门',
      tags: ['usercenter'],
      body: {
  ...
  server.put('/usercenter/departments/:id', {
    schema: {
      summary: '更新部门',
      tags: ['usercenter'],
      body: {
  ...
  server.delete('/usercenter/departments/:id', {
    schema: {
      summary: '删除部门',
      tags: ['usercenter'],
      response: {
  ...
  server.get('/usercenter/statistics', {
    schema: {
      summary: '用户统计',
      tags: ['usercenter'],
      response: {
