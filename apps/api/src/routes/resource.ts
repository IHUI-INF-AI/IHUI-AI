...
export const resourceRoutes: FastifyPluginAsync = async (server) => {
  ...
  server.get('/resources/categories', { schema: { response: { ...responseSchema } } }, async (request, reply) => {
  ...
  server.get('/resources/categories/:id', { schema: { response: { ...responseSchema } } }, async (request, reply) => {
  ...
  server.get('/resources', { schema: { response: { ...responseSchema } } }, async (request, reply) => {
  ...
  server.get('/resources/by-ids', { schema: { response: { ...responseSchema } } }, async (request, reply) => {
  ...
  server.get('/resources/:id', { schema: { response: { ...responseSchema } } }, async (request, reply) => {
    const parsed = uuidParamSchema.safeParse(request.params);
    if (!parsed.success) {
      return reply.status(400).send(error(400, parsed.error.issues[0]?.message ?? '参数错误'));
    }
  ...
  server.get('/resources/products/:id', { schema: { response: { ...responseSchema } } }, async (request, reply) => {
    const parsed = uuidParamSchema.safeParse(request.params);
    if (!parsed.success) {
      return reply.status(400).send(error(400, parsed.error.issues[0]?.message ?? '参数错误'));
    }
  ...
  server.get('/resources/tags/:id', { schema: { response: { ...responseSchema } } }, async (request, reply) => {
    const parsed = uuidParamSchema.safeParse(request.params);
    if (!parsed.success) {
      return reply.status(400).send(error(400, parsed.error.issues[0]?.message ?? '参数错误'));
    }
...
export const adminResourceRoutes: FastifyPluginAsync = async (server) => {
  ...
  server.post('/resources/categories', { schema: { response: { ...responseSchema201 } } }, async (request, reply) => {
  ...
  server.put('/resources/categories/:id', { schema: { response: { ...responseSchema } } }, async (request, reply) => {
  ...
  server.delete('/resources/categories/:id', { schema: { response: { ...responseSchema } } }, async (request, reply) => {
    const parsed = uuidParamSchema.safeParse(request.params);
    if (!parsed.success) {
      return reply.status(400).send(error(400, parsed.error.issues[0]?.message ?? '参数错误'));
    }
  ...
  // POST /resources - 创建资源
  server.post('/resources', { schema: { response: { ...responseSchema201 } } }, async (request, reply) => {
  ...
  server.put('/resources/:id', { schema: { response: { ...responseSchema } } }, async (request, reply) => {
    const idParsed = uuidParamSchema.safeParse(request.params);
    if (!idParsed.success) {
      return reply.status(400).send(error(400, idParsed.error.issues[0]?.message ?? '参数错误'));
    }
  ...
  server.delete('/resources/:id', { schema: { response: { ...responseSchema } } }, async (request, reply) => {
    const parsed = uuidParamSchema.safeParse(request.params);
    if (!parsed.success) {
      return reply.status(400).send(error(400, parsed.error.issues[0]?.message ?? '参数错误'));
    }
  ...
  server.put('/resources/:id/publish', { schema: { response: { ...responseSchema } } }, async (request, reply) => {
    const idParsed = uuidParamSchema.safeParse(request.params);
    if (!idParsed.success) {
      return reply.status(400).send(error(400, idParsed.error.issues[0]?.message ?? '参数错误'));
    }
  ...
  server.get('/resources/products', { schema: { response: { ...responseSchema } } }, async (request, reply) => {
  ...
  server.post('/resources/products', { schema: { response: { ...responseSchema201 } } }, async (request, reply) => {
  ...
  server.put('/resources/products/:id', { schema: { response: { ...responseSchema } } }, async (request, reply) => {
    const idParsed = uuidParamSchema.safeParse(request.params);
    if (!idParsed.success) {
      return reply.status(400).send(error(400, idParsed.error.issues[0]?.message ?? '参数错误'));
    }
  ...
  server.delete('/resources/products/:id', { schema: { response: { ...responseSchema } } }, async (request, reply) => {
    const parsed = uuidParamSchema.safeParse(request.params);
    if (!parsed.success) {
      return reply.status(400).send(error(400, parsed.error.issues[0]?.message ?? '参数错误'));
    }
  ...
  server.get('/resources/tags', { schema: { response: { ...responseSchema } } }, async (request, reply) => {
  ...
  server.post('/resources/tags', { schema: { response: { ...responseSchema201 } } }, async (request, reply) => {
  ...
  server.put('/resources/tags/:id', { schema: { response: { ...responseSchema } } }, async (request, reply) => {
    const idParsed = uuidParamSchema.safeParse(request.params);
    if (!idParsed.success) {
      return reply.status(400).send(error(400, idParsed.error.issues[0]?.message ?? '参数错误'));
    }
  ...
  server.delete('/resources/tags/:id', { schema: { response: { ...responseSchema } } }, async (request, reply) => {
    const parsed = uuidParamSchema.safeParse(request.params);
    if (!parsed.success) {
      return reply.status(400).send(error(400, parsed.error.issues[0]?.message ?? '参数错误'));
    }
