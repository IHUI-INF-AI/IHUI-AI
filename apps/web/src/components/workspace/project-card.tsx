...
import { Card, CardHeader, CardTitle, CardDescription, CardContent, CardFooter, Button } from '@ihui/ui'
...
export function ProjectCard({ project }: { project: ProjectCardData }) {
  ...
  return (
    <Card className="flex h-full flex-col transition-colors hover:border-primary/50 hover:shadow-md">
      <CardHeader>
