  ...
  return (
    <div className="mx-auto flex w-full max-w-3xl flex-col items-center gap-2">
      ...
      <Link
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="group inline-flex w-full items-center justify-center gap-2 rounded-lg border-2 border-primary bg-card px-5 py-2.5 text-sm font-semibold shadow-sm transition-all hover:scale-[1.02] hover:shadow-lg animate-[pulse_2s_ease-in-out_infinite] dark:shadow-primary/20"
      >
        <Image
        ...
        <div className="flex flex-col items-start">
          ...
          <span className="text-xs font-normal text-muted-foreground">aizhs.top · 无需部署，开箱即用</span>
        </div>
      </Link>
    </div>
  )
