          ...
          return (
            <RevealOnView key={plan.id} delay={0.05 * (i + 1)} className="group h-full">
              <Card
                className={
                  isRecommended
                    ? 'relative flex h-full flex-col overflow-hidden rounded-xl border-2 border-brand-accent-deep bg-card p-3 shadow-lg shadow-primary/20 transition-all duration-300 animate-pulse-glow-light group-hover:-translate-y-2 group-hover:border-brand-accent-deep group-hover:bg-primary/5 group-hover:shadow-xl group-hover:shadow-primary/30'
