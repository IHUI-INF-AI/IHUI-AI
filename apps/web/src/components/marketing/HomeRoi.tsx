...
const ROI_I18N_KEY: Record<
  string,
  { title: string; value: string; description: string; calculation: string }
> = {
  cost: {
    title: 'cost.title',
    value: 'cost.value',
        ...
        {rois.map(
          (
            ...
            >
              ...
              {/* 描述 */}
              <p className="text-[11px] leading-relaxed text-muted-foreground min-[640px]:text-xs">
                {description}
              </p>
