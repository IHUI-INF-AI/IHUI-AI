    ...
    >
      ...
      <div className="flex flex-col items-center text-center">
        {/* 顶部 logo + welcome 左右并排(复用 M-66/M-68/M-69 视觉方案,2026-07-20 恢复;2026-07-20 修 w-full 塌陷 + logo 统一 + logo 高度对齐 welcome 文字)
            - logo 27×27 rounded-md object-contain,统一用 /images/logo.png?v=20260719-unify(全站 9 处一致),浅/深主题统一
              高度 27px = welcome.svg viewBox 67 中文字 path y(20.625→55,占 51.3%)× 渲染 52px ≈ 26.7px,与 welcome 文字像素高度一致
            - welcome h-[52px] w-auto 等比缩放(原 447×67 → h52 时 w≈347)
            - gap-3(12px)间距,27+12+340=379 ≤ 内宽 404(p-7 28×2 + max-w-460),余 25px 由 flex justify-center 自动居中
        ...
        <div className="flex items-center justify-center gap-3">
          <Image
            ...
            width={27}
            height={27}
            className="h-[27px] w-[27px] shrink-0 select-none rounded-md object-contain"
            draggable={false}
            priority
          />
