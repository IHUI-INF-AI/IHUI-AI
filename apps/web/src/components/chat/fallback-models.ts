...
export const FALLBACK_MODELS: FallbackModel[] = [
  ...
  // Cloudflare Workers AI 免费(2026-07-31 立,GLM-5.2 7月28日起需 Workers Paid,用 GLM-4.7-flash 免费替代)
  { value: '@cf/zai-org/glm-4.7-flash', label: 'GLM-4.7 Flash (CF 免费)', vendor: 'cloudflare_workers_ai' },
  {
