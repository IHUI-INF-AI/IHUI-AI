...
export function MessageInput({
  ...
  // (2026-09-04 conversationId 选择器已随剪刀按钮迁移移除,压缩入口见 context-usage-ring.tsx)
  ...
  // 手动压缩上下文已迁入 ContextUsageRing 弹窗压缩区(2026-09-04 整合:
  // 输入工具栏不再保留独立剪刀入口,压缩会话(/compact)+压缩存档(/compress)
  // 统一收敛到上下文用量弹窗,见 context-usage-ring.tsx)
          ...
          >
            ...
            <div className="ai-input-toolbar flex min-w-0 items-center gap-1 overflow-hidden px-2 pb-2 pt-1">
              ...
              <div className="ml-auto flex min-w-0 flex-1 items-center justify-end gap-1">
                {/* 手动压缩上下文入口已迁入 ContextUsageRing 弹窗压缩区(2026-09-04):
                    工具栏不再保留剪刀按钮,点击用量环弹窗即可"压缩会话/生成压缩存档" */}
