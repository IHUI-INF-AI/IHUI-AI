...
import type { ChatMode, MessageInputProps as SharedMessageInputProps } from '@ihui/types'
import {
...
interface WebInputCoreProps
  extends Pick<SharedMessageInputProps, 'text' | 'placeholder' | 'isStreaming' | 'onTextChange' | 'onSend' | 'onStop' | 'onClear' | 'error'> {
