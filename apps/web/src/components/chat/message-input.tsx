...
import { VoiceToolbar } from '@/components/chat/voice-toolbar'
            ...
            <div className="ai-input-toolbar flex min-w-0 items-center gap-1 overflow-hidden px-2 pb-2 pt-1">
              ...
              <div className="ml-auto flex min-w-0 flex-1 items-center justify-end gap-1">
                ...
                <ModelSelector
                  ...
                  label={modelLabel}
                />
                {/* 语音三合一按钮(2026-09-18 用户规则:"这几个按钮能不能整合成一个按钮功能啊"):
                    VoiceToolbar 合并原 VoiceInput / VoicePlaybackToggle / VoiceHandsFreeToggle
                    三个独立按钮,主按钮单击直接录音,点开 dropdown 里三个 ToggleItem 分别控制
                    自动朗读 / 连续对话;右上角绿/蓝状态点显示开关组合,流式期间按钮禁用 */}
