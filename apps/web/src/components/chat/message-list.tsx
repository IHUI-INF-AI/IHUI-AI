...
export function MessageList({
  ...
  const safeSetUserScrolledUp = typeof setUserScrolledUp === 'function' ? setUserScrolledUp : () => {}
  const safeSetUserScrolledToTop = typeof setUserScrolledToTop === 'function' ? setUserScrolledToTop : () => {}
