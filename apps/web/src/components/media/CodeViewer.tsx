  ...
  return (
    <div className={cn('group relative overflow-hidden rounded-lg', className)}>
      {showCopyButton && (
        <button
          onClick={handleCopy}
          className="absolute right-2 top-2 z-10 rounded-md bg-black/60 p-1.5 text-white opacity-0 transition-opacity hover:bg-black/80 group-hover:opacity-100 group-focus-within:opacity-100"
        >
