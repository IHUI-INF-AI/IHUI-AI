...
function FlowEventItem({
  ...
  return (
    // eslint-disable-next-line jsx-a11y/click-events-have-key-events, jsx-a11y/no-static-element-interactions -- 点击展开详情;键盘用户通过 verbose 模式查看完整信息
    <div
      className={cn(
...
function ResizeHandle({
  ...
  return (
    // eslint-disable-next-line jsx-a11y/no-static-element-interactions -- 拖拽调整高度,非交互元素;键盘用户通过双击重置(原生 onDoubleClick)
    <div
