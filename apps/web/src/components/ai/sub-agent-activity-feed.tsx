    ...
    >
      ...
      {expanded && view === 'canvas' && (
        <div data-testid="subagent-canvas" className="space-y-1.5 bg-muted/20 px-2 py-1.5">
              ...
              return (
                ...
                >
                  <div className="mb-1 flex items-center gap-1">
                    ...
                    {members.length > 0 && (
                      <span className="ml-auto shrink-0 rounded-sm bg-muted px-1 text-[9px] tabular-nums text-muted-foreground/70">
                        {members.length}
                      </span>
                    )}
                  </div>
          ...
          {selected && (
            <div
              data-testid="subagent-canvas-detail"
              className="rounded-md border border-border/30 bg-card/60 p-1.5"
            >
              <SubAgentCard
                agent={selected}
                badgeLabel={t('badge')}
