    ...
    <div className="rounded-xl border bg-card" data-testid="plan-review-panel">
      ...
      <div className="flex items-center gap-1 px-4 pb-2" data-testid="plan-phase-track">
        {PLAN_PHASES.map((p, i) => (
          <React.Fragment key={p}>
            ...
            <span
              className={cn(
                'inline-flex items-center whitespace-nowrap rounded-full px-2 py-0.5 text-[10px] font-medium transition-colors',
                i < phaseIdx
      ...
      <div className="space-y-3 p-3">
        {plan.steps.length === 0 && !plan.summary ? (
          <p className="py-6 text-center text-sm text-muted-foreground" data-testid="plan-review-empty">
            {t('empty')}
          </p>
        ) : (
          <>
