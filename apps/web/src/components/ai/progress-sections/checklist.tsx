...
/**
 * Checklist — 绿色对勾清单(Phase 19.9,2026-07-28 立)
 *
 * 对标 Trae Work 截图:多任务清单用绿色对勾 + 任务文字,
 * 多任务用 `&` 连接(每行一项)或显示多行。
 */
...
const STATUS_ICON_CLS: Record<ChecklistStatus, string> = {
  done: 'bg-emerald-500/20 text-emerald-600 dark:text-emerald-400',
  in_progress: 'bg-primary/20 text-primary',
  pending: 'bg-muted-foreground/15 text-muted-foreground/50',
}
