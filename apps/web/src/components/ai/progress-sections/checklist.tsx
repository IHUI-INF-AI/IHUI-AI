...
/**
 * ChecklistItem — 单个 checklist 项(2026-07-28 立,Trae Work 对齐)
 */
...
const STATUS_ICON: Record<ChecklistItemData['status'], React.ComponentType<{ className?: string }>> = {
  pending: Circle,
  in_progress: Loader2,
  completed: Check,
  skipped: Minus,
...
/**
 * Checklist — 已检查项列表(2026-07-28 立,Trae Work 对齐)
 *
 * 设计:
 * - 每行:状态图标 + 标签 + 副标题 + 右侧 meta
 * - 紧凑间距,行间无分割线
 * - completed 项标签轻微灰化(类似"划掉"效果但保留可读)
 * - 配合 trae-block 容器使用
 */
