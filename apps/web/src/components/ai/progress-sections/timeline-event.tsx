...
import { ChevronRight, Loader2, AlertCircle, Bot, HelpCircle, Wrench, Brain, FileText, Circle } from 'lucide-react'
import { cn } from '@/lib/utils'
import { useTimelineStore, type TimelineEvent, type TimelineEventStatus, type TimelineEventType } from '@/stores/timeline-store'
import { formatRelativeTime } from './foldable-section'
import { useTranslations } from 'next-intl'

/**
 * TimelineEventRow — 单条时间线事件(2026-07-28 立,Trae Work 对齐)
 *
 * 设计:
 * - 左侧时间戳 + 状态图标
 * - 中间标题 + 描述
 * - 右侧 meta + chevron(可展开时显示)
 * - 折叠/展开通过 timeline-store 管理
 * - memo 化:event 引用稳定时不重渲染
 */
