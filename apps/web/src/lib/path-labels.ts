...
const EXTRA_PATH_LABELS: PathLabelEntry[] = [
  ...
  { href: '/admin/agreements', spec: { ns: 'admin', key: 'agreements.title' } },
  { href: '/admin/ai-metrics', spec: { ns: 'admin', key: 'aiMetrics.title' } },
  { href: '/admin/asks', spec: { ns: 'admin', key: 'asks.title' } },
  { href: '/admin/behavior', spec: { ns: 'admin', key: 'behavior.title' } },
  { href: '/admin/circles', spec: { ns: 'admin', key: 'circles.title' } },
  { href: '/admin/clawdbot/permissions', spec: { ns: 'admin', key: 'permissions.title' } },
  { href: '/admin/comment-logs', spec: { ns: 'admin', key: 'commentLogs.title' } },
  { href: '/admin/comments', spec: { ns: 'admin', key: 'comments.title' } },
  { href: '/admin/customer-service', spec: { ns: 'admin', key: 'customerService' } },
  { href: '/admin/demand-audit', spec: { ns: 'admin', key: 'demandAudit.title' } },
  { href: '/admin/demand-audit/[id]', spec: { ns: 'admin', key: 'demandAudit.title' } },
  { href: '/admin/demand-square/[id]', spec: { ns: 'admin', key: 'demandSquare.title' } },
  { href: '/admin/distribution/orders', spec: { ns: 'admin', key: 'orders.title' } },
  { href: '/admin/edu', spec: { ns: 'admin', key: 'edu.title' } },
  { href: '/admin/edu-settings', spec: { ns: 'admin', key: 'eduSettings.title' } },
  { href: '/admin/edu/class/members', spec: { ns: 'admin', key: 'members.title' } },
  { href: '/admin/edu/learn/live', spec: { ns: 'admin', key: 'live.title' } },
  { href: '/admin/exchange-rates', spec: { ns: 'admin', key: 'exchangeRates.title' } },
  { href: '/admin/learn', spec: { ns: 'admin', key: 'learn.title' } },
  { href: '/admin/menu', spec: { ns: 'admin', key: 'menu.title' } },
  { href: '/admin/menu-permission', spec: { ns: 'admin', key: 'menuPermission.title' } },
  { href: '/admin/message-templates', spec: { ns: 'admin', key: 'messageTemplates.title' } },
  { href: '/admin/oss', spec: { ns: 'admin', key: 'oss.title' } },
  { href: '/admin/private-letters', spec: { ns: 'admin', key: 'privateLetters.title' } },
  { href: '/admin/refund/[id]', spec: { ns: 'admin', key: 'refund.title' } },
  { href: '/admin/resources/tags', spec: { ns: 'admin', key: 'tags.title' } },
  { href: '/admin/saas/[slug]', spec: { ns: 'admin', key: 'saas.title' } },
  { href: '/admin/schedule/logs', spec: { ns: 'admin', key: 'logs.title' } },
  { href: '/admin/search-hot-words', spec: { ns: 'admin', key: 'searchHotWords.title' } },
  { href: '/admin/security/anomalies', spec: { ns: 'admin', key: 'anomalies.title' } },
  { href: '/admin/security/ip-reputation', spec: { ns: 'admin', key: 'ipReputation.title' } },
  { href: '/admin/security/threat-dashboard', spec: { ns: 'admin', key: 'threatDashboard.title' } },
  { href: '/admin/sensitive-word', spec: { ns: 'admin', key: 'sensitiveWord.title' } },
  { href: '/admin/sensitive-words', spec: { ns: 'admin', key: 'sensitiveWords.title' } },
  { href: '/admin/signin-rule', spec: { ns: 'admin', key: 'signinRule.title' } },
  { href: '/admin/video-logs', spec: { ns: 'admin', key: 'videoLogs.title' } },
  // 其他独立页面
  ...
  { href: '/certificate/download', spec: { ns: 'certificate', key: 'download.title' } },
  { href: '/circles/post', spec: { ns: 'circles', key: 'post.title' } },
  ...
  { href: '/exam/wrong-questions', spec: { ns: 'exam', key: 'wrongQuestions.title' } },
  ...
  { href: '/knowledge-rag/[id]/chunks', spec: { ns: 'knowledgeRag', key: 'chunks.title' } },
  { href: '/knowledge-rag/manage', spec: { ns: 'knowledgeRag', key: 'manage.title' } },
  { href: '/learn/topic', spec: { ns: 'learn', key: 'topic.title' } },
  { href: '/learn/topic/[id]', spec: { ns: 'learn', key: 'topic.title' } },
  { href: '/models/contact', spec: { ns: 'models', key: 'contact.title' } },
  { href: '/oauth/authorize', spec: { ns: 'oauth', key: 'authorizeTitle' } },
  { href: '/payment/checkout', spec: { ns: 'payment', key: 'checkout.title' } },
  { href: '/plugins', spec: { ns: 'plugins', key: 'title' } },
  { href: '/points/sign-in', spec: { ns: 'points', key: 'signIn.title' } },
  ...
  { href: '/settings/login-security', spec: { ns: 'settings', key: 'loginSecurity.title' } },
  ...
  { href: '/skills/market', spec: { ns: 'skills', key: 'market.title' } },
  { href: '/sso/redirect', spec: { ns: 'sso', key: 'redirect.title' } },
  ...
  { href: '/user/articles', spec: { ns: 'user', key: 'articles.title' } },
  ...
  { href: '/workspace/permissions', spec: { ns: 'workspace', key: 'permissionsPage.title' } },
  ...
  {
    href: '/admin/resources/product-categories',
    spec: { ns: 'admin.resources', key: 'published' },
  },
  ...
  { href: '/knowledge-base/[id]', spec: { ns: 'knowledgeRag', key: 'detail.title' } },
  ...
  { href: '/lecturers/[id]', spec: { ns: 'lecturer', key: 'notFound' } },
  {
    ...
    spec: { ns: 'legal.serviceSpecificTerms', key: 'title' },
  },
  ...
  { href: '/settings/billing', spec: { ns: 'settings', key: 'billingOrders' } },
  {
    ...
    spec: { ns: 'settings', key: 'connectedAccountsUnbindSuccess' },
  },
  ...
  { href: '/sso/login', spec: { ns: 'sso', key: 'redirect.title' } },
  ...
  { href: '/user/[id]', spec: { ns: 'user', key: 'profile.title' } },
  ...
  { href: '/workflows/[id]', spec: { ns: 'workflows', key: 'detail.title' } },
  { href: '/workflows/instances/[id]', spec: { ns: 'workflows', key: 'instance' } },
  { href: '/workspace/[id]', spec: { ns: 'workspace', key: 'detail.title' } },
]
