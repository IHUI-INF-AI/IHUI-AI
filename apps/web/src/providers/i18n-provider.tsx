...
const MESSAGES_MAP: Record<string, AbstractIntlMessages> = {
  'zh-CN': mergeMessages(sharedZhCN as Messages, webZhCN as Messages) as unknown as AbstractIntlMessages,
  ...
  'zh-TW': mergeMessages(sharedZhTW as Messages, webZhTW as Messages) as unknown as AbstractIntlMessages,
}
