...
describe('Progress Sections — 折叠子区组件(对齐 Trae Work)', () => {
  ...
  it('ToolCallsSection — 有工具调用时渲染并显示分类摘要', () => {
    const tools: AgentToolCall[] = [
      { id: 't1', toolName: 'read_file', args: {}, status: 'success', startedAt: '2026-01-01T00:00:00Z', durationMs: 1000 },
      { id: 't2', toolName: 'search', args: {}, status: 'success', startedAt: '2026-01-01T00:00:01Z', durationMs: 2000 },
      { id: 't3', toolName: 'edit_file', args: {}, status: 'running', startedAt: '2026-01-01T00:00:02Z' },
    ]
