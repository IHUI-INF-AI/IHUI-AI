...
export function EnterpriseContent() {
  ...
  return (
    <>
      <div className="mx-auto w-full max-w-5xl space-y-10 px-4 py-4">
        ...
        <section className="space-y-4">
          ...
          <Card className="overflow-hidden">
            <CardContent className="flex flex-col items-start gap-4 p-3 min-[768px]:flex-row min-[768px]:items-center min-[768px]:gap-6">
