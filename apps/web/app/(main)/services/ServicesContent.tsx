...
export function ServicesContent(): React.JSX.Element {
  ...
  return (
    <main className="mx-auto w-full max-w-6xl px-4 py-10 md:px-8 md:py-14">
      ...
      {/* 服务卡片网格 */}
      <section className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-4 lg:items-start">
      ...
      <section className="mt-12 space-y-4">
        <h2 className="text-center text-xl font-bold tracking-tight md:text-2xl">{t('faq.title')}</h2>
      ...
      <section id="inquiry" className="mt-12 scroll-mt-20">
        <div className="mx-auto max-w-2xl space-y-2 text-center">
          <h2 className="text-xl font-bold tracking-tight md:text-2xl">{t('inquiry.title')}</h2>
