...
const compareJsonLd = {
  ...
  '@graph': [
    {
      '@type': 'WebPage',
      '@id': 'https://aizhs.top/compare/ihui-vs-bolt-new#webpage',
      url: 'https://aizhs.top/compare/ihui-vs-bolt-new',
      ...
      about: [{ '@id': 'https://aizhs.top/#organization' }, { '@type': 'Thing', name: 'Bolt.new' }],
    },
    {
      '@type': 'BreadcrumbList',
      '@id': 'https://aizhs.top/compare/ihui-vs-bolt-new#breadcrumb',
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 2, name: '产品对比', item: 'https://aizhs.top/compare' },
        {
          '@type': 'ListItem',
          position: 3,
          name: 'IHUI AI vs Bolt.new',
          item: 'https://aizhs.top/compare/ihui-vs-bolt-new',
        },
      ],
    },
  ],
