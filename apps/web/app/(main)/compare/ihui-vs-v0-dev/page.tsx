...
const compareJsonLd = {
  ...
  '@graph': [
    {
      '@type': 'WebPage',
      '@id': 'https://ihui.ai/compare/ihui-vs-v0-dev#webpage',
      url: 'https://ihui.ai/compare/ihui-vs-v0-dev',
      ...
      about: [
        ...
        { '@type': 'Thing', name: 'v0.dev' },
      ],
    },
    {
      '@type': 'BreadcrumbList',
      '@id': 'https://ihui.ai/compare/ihui-vs-v0-dev#breadcrumb',
      itemListElement: [
        { '@type': 'ListItem', position: 1, name: '首页', item: 'https://ihui.ai' },
        { '@type': 'ListItem', position: 2, name: '产品对比', item: 'https://ihui.ai/compare' },
        { '@type': 'ListItem', position: 3, name: 'IHUI AI vs v0.dev', item: 'https://ihui.ai/compare/ihui-vs-v0-dev' },
      ],
    },
  ],
}
