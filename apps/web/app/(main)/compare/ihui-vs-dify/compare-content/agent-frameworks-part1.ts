...
export const agentFrameworksCompetitorsPart1: Partial<
...
> = {
  ...
  'openai-agent': {
    id: 'openai-agent',
    name: 'OpenAI Agent',
    tagline: 'OpenAI Agent 是 GPT 生态内的 Agent 构建;IHUI AI 是跨模型 + 六端分发的全栈操作系统',
    verdict:
      '如果你已深度绑定 OpenAI 生态,GPTs / Assistants API 够用;如果需要跨模型调度 + 知识库 RAG + 六端分发 + 团队协作 + 私有化,IHUI AI 是更完整的方案。',
    rows: [
      {
        dimension: '定位',
        ihui: '六端同源全栈 AI 操作系统',
        competitor: 'OpenAI 生态内 Agent 构建',
        ihuiDetail: 'Agent + 知识库 + 工作流 + 六端',
        competitorDetail: 'GPTs / Assistants API / Operator',
      },
      {
        dimension: '客户端覆盖',
        ihui: '6 端同源',
        competitor: 'Web + API',
        ihuiDetail: 'Web/桌面/小程序/扩展/移动/CLI',
        competitorDetail: 'ChatGPT Web + API 调用',
      },
      {
        dimension: '开源协议',
        ihui: 'Apache 2.0',
      ...
      },
      {
        dimension: 'Agent 编排',
        ihui: '可视化 + 200+ 模板',
        competitor: 'GPTs / Assistants',
        ihuiDetail: 'Agent 市场 + 一键 fork + 创作者分成',
        competitorDetail: 'GPT Builder + Assistants API',
      },
      {
        dimension: '知识库 RAG',
        ihui: '内置 + 多格式',
        competitor: 'File Search / Vector Store',
        ihuiDetail: '向量 + BM25 + 知识图谱,中文友好',
        competitorDetail: '依赖 OpenAI File Search',
      },
      {
        dimension: '多模型',
        ihui: '30+ 模型中立',
        competitor: '仅 OpenAI 系列',
        ihuiDetail: '跨厂商 + 自动 fallback + 成本路由',
        competitorDetail: 'GPT-4o / o1 / o3 系列',
      },
      {
        dimension: '团队协作',
        ihui: '完整 RBAC + 审计 + SSO',
        competitor: 'Team/Enterprise',
        ihuiDetail: '多租户 + 积分共享 + 审计日志',
        competitorDetail: 'ChatGPT Team/Enterprise 席位',
      },
      {
        dimension: '工作流',
        ihui: '可视化画布 + 触发器',
        competitor: '有限',
        ihuiDetail: 'n8n 风格节点 + 条件分支 + 人机协同',
        competitorDetail: 'Assistants + Code Interpreter',
      },
      {
        dimension: 'MCP 工具',
        ihui: '原生 + 100+ 预置',
        ...
        competitorDetail: '通过 Function Calling 模拟',
      },
      {
        dimension: '定价',
        ihui: '个人免费 + Pro ¥49/月',
        competitor: '按 token / 订阅计费',
        ihuiDetail: '开源自托管零费用',
        competitorDetail: 'Plus $20/月 + API 按量',
      },
    ],
  },
  langchain: {
  ...
  'copilot-studio': {
    id: 'copilot-studio',
    name: 'Copilot Studio',
    tagline: 'Copilot Studio 是微软低代码 AI 平台;IHUI AI 是开源 + 跨模型 + 六端全栈操作系统',
    verdict:
      '如果你已使用 Microsoft 365 + Power Platform,Copilot Studio 集成自然;如果需要跨模型 + 开源 + 私有化 + Agent 市场 + 六端分发,IHUI AI 是更开放的方案。',
    rows: [
      {
        dimension: '定位',
        ihui: '六端同源全栈 AI 操作系统',
        competitor: '微软低代码 AI Agent 平台',
        ihuiDetail: 'Agent + 知识库 + 工作流 + 六端分发',
        competitorDetail: 'Power Platform + M365 集成',
      },
      {
        dimension: '客户端覆盖',
        ihui: '6 端同源',
        competitor: 'Web + Power Platform',
        ihuiDetail: 'Web/桌面/小程序/扩展/移动/CLI',
        competitorDetail: 'Web + Teams/PP 应用',
      },
      {
        dimension: '开源协议',
        ihui: 'Apache 2.0',
      ...
      },
      {
        ...
        competitor: '低代码 + 插件',
        ihuiDetail: 'Agent 市场 + 一键 fork + 创作者分成',
        competitorDetail: 'Copilot 主题 + 插件扩展',
      },
      {
        dimension: '知识库 RAG',
        ihui: '内置 + 多格式',
        competitor: 'SharePoint/Dataverse',
        ihuiDetail: '向量 + BM25 + 知识图谱,中文友好',
        competitorDetail: '依赖 Microsoft 365 内容源',
      },
      {
        dimension: '多模型',
        ihui: '30+ 模型中立',
        competitor: 'Azure OpenAI / GPT',
        ihuiDetail: '跨厂商 + 自动 fallback + 成本路由',
        competitorDetail: '主要使用 OpenAI 模型',
      },
      {
        dimension: '团队协作',
        ihui: '完整 RBAC + 审计 + SSO',
        competitor: 'M365 集成',
        ihuiDetail: '多租户企业级',
        competitorDetail: '依赖 Entra ID / M365 权限',
      },
      {
        dimension: '工作流',
        ihui: '可视化画布 + 触发器',
        competitor: 'Power Automate',
        ihuiDetail: 'n8n 风格节点 + 条件分支',
        competitorDetail: 'Power Automate 流程集成',
      },
      {
        dimension: '定价',
        ihui: '个人免费 + Pro ¥49/月',
        competitor: '按 Power Platform 许可',
        ihuiDetail: '开源自托管零费用',
        competitorDetail: '按用户/容量许可计费',
      },
    ],
  },
  manus: {
