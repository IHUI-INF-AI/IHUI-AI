...
const compareJsonLd = {
  ...
  '@graph': [
    {
      '@type': 'WebPage',
      '@id': 'https://ihui.ai/compare/ihui-vs-langchain#webpage',
      url: 'https://ihui.ai/compare/ihui-vs-langchain',
    ...
    {
      '@type': 'BreadcrumbList',
      '@id': 'https://ihui.ai/compare/ihui-vs-langchain#breadcrumb',
      itemListElement: [
        { '@type': 'ListItem', position: 1, name: '首页', item: 'https://ihui.ai' },
        { '@type': 'ListItem', position: 2, name: '产品对比', item: 'https://ihui.ai/compare' },
        { '@type': 'ListItem', position: 3, name: 'IHUI AI vs LangChain', item: 'https://ihui.ai/compare/ihui-vs-langchain' },
      ],
    },
  ],
}
