...
/**
 * CategoriesDialog — 薄 wrapper(2026-09-06 治理)。
 * 原为跨域复制粘贴的完整实现,已收敛到 @/components/admin/category-admin 唯一事实来源;
 * 本文件仅注入 admin.edu.exam.categories 命名空间的 i18n 文案,页面/helper/types 零改动。
 */
  ...
  return (
    <AdminCategoryDialog
      ...
      labels={{
        ...
        fieldName: t('nameLabel'),
        namePlaceholder: t('namePlaceholder'),
        fieldSort: t('sortLabel'),
        fieldStatus: t('statusLabel'),
