...
import { Loader2, Plus, Download, Search, Link2 } from 'lucide-react'
...
const RESOURCE = '/api/admin/auth-accounts'
const PERM = 'auth:auth_accounts'
const EMPTY = {
  userUuid: '',
  platform: '',
  openId: '',
...
export default function AuthAccountsPage() {
  ...
  function handleReset() {
    setSearch({ userUuid: '', platform: '', openId: '', platformName: '', nickname: '' })
    setPage(1)
  }
      ...
      <div className="flex flex-wrap items-end gap-3 rounded-lg border p-4">
        ...
        <div className="space-y-1">
          ...
          <Input
            ...
            onChange={(e) => setSearch({ ...search, platformName: e.target.value })}
            placeholder="搜索平台名称"
          />
        </div>
        <div className="space-y-1">
          ...
          <form onSubmit={submit} className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <DatePicker
                label="绑定时间"
                value={form.bindTime}
                onChange={(v) => setForm({ ...form, bindTime: v })}
              />
            </div>
            <DialogFooter>
