...
import type { EduSetting } from './types'

interface Props {
  list: EduSetting[]
  isLoading: boolean
  onEdit: (c: EduSetting) => void
  onDelete: (c: EduSetting) => void
  deletePending: boolean
}

export function EduSettingsTable({ list, isLoading, onEdit, onDelete, deletePending }: Props) {
