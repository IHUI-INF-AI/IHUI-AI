            ...
            <div className="flex items-center gap-3">
              <div className="group relative">
                ...
                <button
                  ...
                  className="absolute inset-0 flex items-center justify-center rounded-md bg-black/50 text-white opacity-0 transition-opacity group-hover:opacity-100 group-focus-within:opacity-100 disabled:opacity-60"
                >
                  {uploading ? (
