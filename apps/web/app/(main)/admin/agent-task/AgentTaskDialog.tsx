      ...
      <DialogContent className="max-w-lg">
        <form onSubmit={onSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Input
              value={form.context}
              onChange={(e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => setForm({ ...form, context: e.target.value })}
            />
          </div>
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => setForm({ ...form, lowestPrice: e.target.value })}
              />
            </div>
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => setForm({ ...form, peakPrice: e.target.value })}
              />
            </div>
            <div className="space-y-2">
              ...
              <Input
                value={form.cycle}
                onChange={(e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => setForm({ ...form, cycle: e.target.value })}
              />
            </div>
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => setForm({ ...form, cycleUnit: e.target.value })}
              />
            </div>
          </div>
          <div className="space-y-2">
