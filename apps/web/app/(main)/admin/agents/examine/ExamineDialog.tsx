        ...
        <form onSubmit={onSubmit} className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-2">
              ...
              <Input
                value={form.agentId}
                onChange={(e: React.ChangeEvent<HTMLInputElement>) => onFormChange({ ...form, agentId: e.target.value })}
              />
            </div>
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e: React.ChangeEvent<HTMLInputElement>) => onFormChange({ ...form, agentName: e.target.value })}
              />
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e: React.ChangeEvent<HTMLInputElement>) => onFormChange({ ...form, startPhone: e.target.value })}
              />
            </div>
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e: React.ChangeEvent<HTMLInputElement>) => onFormChange({ ...form, startName: e.target.value })}
              />
            </div>
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e: React.ChangeEvent<HTMLInputElement>) => onFormChange({ ...form, examineUser: e.target.value })}
              />
            </div>
          </div>
          <div className="space-y-2">
            ...
            <Input
              value={form.desc}
              onChange={(e: React.ChangeEvent<HTMLInputElement>) => onFormChange({ ...form, desc: e.target.value })}
            />
          </div>
          <div className="space-y-2">
            ...
            <Input
              value={form.follow}
              onChange={(e: React.ChangeEvent<HTMLInputElement>) => onFormChange({ ...form, follow: e.target.value })}
            />
          </div>
          <div className="space-y-2">
            ...
            <Input
              value={form.prologue}
              onChange={(e: React.ChangeEvent<HTMLInputElement>) => onFormChange({ ...form, prologue: e.target.value })}
            />
          </div>
