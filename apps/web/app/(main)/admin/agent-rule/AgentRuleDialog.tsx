      ...
      <DialogContent className="max-w-lg">
        <form onSubmit={onSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Input
              value={form.agentId}
              onChange={(e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => setForm({ ...form, agentId: e.target.value })}
          ...
          <div className="space-y-2">
            ...
            <Input
              value={form.ruleName}
              onChange={(e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => setForm({ ...form, ruleName: e.target.value })}
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-2">
              ...
              <Input
                value={form.ruleCode}
                onChange={(e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => setForm({ ...form, ruleCode: e.target.value })}
          ...
          <div className="flex items-center gap-4">
            <div className="space-y-2">
              ...
              <Input
                type="number"
                value={form.priority}
                onChange={(e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => setForm({ ...form, priority: e.target.value })}
              />
            </div>
