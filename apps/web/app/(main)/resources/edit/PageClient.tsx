...
export default function ResourceEditPage() {
  ...
  const saveMut = useMutation({
    mutationFn: async () => {
      ...
      // 后端 createResourceSchema/updateResourceSchema 已支持全部字段
      // (title/coverImage/intro/categoryId/fileUrl/fileType/fileSize/isPublished/sort/status
      //  /type/productId/tagIdList/image/introduction/cidList)
      const body = {
        title: title.trim(),
        intro: intro.trim(),
        categoryId: cidArr[0],
