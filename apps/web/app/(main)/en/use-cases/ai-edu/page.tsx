...
const jsonLd = {
  ...
  '@graph': [
    ...
    },
    {
      ...
      supply: [{ '@type': 'HowToSupply', name: 'Student data / question bank / textbook / teaching research docs' }],
      tool: [
        { '@type': 'HowToTool', name: 'IHUI AI Personalized Learning Path Engine' },
        { '@type': 'HowToTool', name: 'IHUI AI Smart Question Bank Module' },
      ],
      step: [
        { '@type': 'HowToStep', position: 1, name: 'Configure student data', text: 'Import historical grades, homework, and learning behavior; AI builds student profiles and identifies strengths and weaknesses.' },
        { '@type': 'HowToStep', position: 2, name: 'Train learning path', text: 'Train a personalized path model on knowledge graph and historical data; daily and weekly plans are auto-generated for each student.' },
        { '@type': 'HowToStep', position: 3, name: 'Integrate question bank', text: 'Connect school, district, or third-party question banks (K12, language, vocational); AI auto-generates tests matching student level.' },
        { '@type': 'HowToStep', position: 4, name: 'Set grading rules', text: 'Configure rules for objective and subjective questions (essay, free response); Agent grades 24/7 with 85%+ accuracy on subjective questions.' },
        { '@type': 'HowToStep', position: 5, name: 'Enable analytics', text: 'Aggregate class, grade, and subject data; auto-generate learning reports and surface common weaknesses to support teaching research.' },
        { '@type': 'HowToStep', position: 6, name: 'Parent-school communication', text: 'Connect WeChat, DingTalk, and WeCom parent apps; auto-push weekly reports, homework status, and progress highlights.' },
      ],
    },
  ],
}
...
const capabilities = [
  { title: 'Personalized learning path', desc: 'Knowledge graph and student profiles power dynamic daily and weekly plans; advanced students extend while struggling students get targeted support, scaling differentiated teaching.' },
  { title: '7x24 smart Q&A', desc: 'AI Q&A agent answers student questions around the clock using subject knowledge graphs and historical Q&A; 30-second response, 92% accuracy across K12 subjects.' },
  { title: 'Smart question generation and grading', desc: 'Question bank integration auto-generates tests at student level; objective questions graded instantly and subjective questions (essays, free response) at 85%+ accuracy, cutting teacher workload 70%.' },
  { title: 'Learning data analytics', desc: 'Aggregate class, grade, and subject data; auto-generate learning reports and identify common weaknesses to support data-driven teaching.' },
  { title: 'Teaching research collaboration', desc: 'Unified management of lesson plans, slides, questions, and reflections; cross-school and cross-district sharing raises high-quality resource reuse from 30% to 75%.' },
  { title: 'Parent-school communication', desc: 'Connect WeChat, DingTalk, and WeCom parent apps; auto-push weekly reports, homework status, and progress highlights, lifting parent satisfaction 60%.' },
]
...
const toolchain = [
  ...
  { name: 'Fastify 5 + Drizzle ORM', purpose: 'API for student data storage and permission isolation' },
  { name: 'FastAPI + LangGraph + LiteLLM', purpose: 'Personalized path + smart Q&A + subjective grading' },
  { name: 'MCP tool protocol', purpose: 'Adapters for question banks, textbooks, learning systems, and parent-school platforms' },
  { name: 'Tauri 2 desktop', purpose: 'Teacher offline lesson preparation and local question bank' },
  { name: 'WXT browser extension', purpose: 'One-click capture from teaching research sites and question banks' },
  { name: 'Taro 4 mini-program', purpose: 'Student photo question search and parent learning report' },
      ...
      <main className="mx-auto w-full max-w-6xl px-4 py-8 min-[768px]:px-8 min-[768px]:py-8">
        ...
        <section className="space-y-5 text-center">
          ...
          <p className="mx-auto max-w-3xl text-base text-muted-foreground min-[768px]:text-lg">
            Built on the IHUI AI full-stack AI operating system, 8-endpoint distribution, Apache 2.0 open source, on-premise support; covers K12, higher education, and vocational training.
          </p>
        ...
        <section className="mt-16 rounded-2xl border bg-card p-8 min-[768px]:p-12">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-xl font-bold tracking-tight min-[768px]:text-2xl">Real challenges facing educators</h2>
          </div>
        ...
        <section className="mt-16">
          ...
          <p className="mx-auto mt-3 max-w-3xl text-center text-sm text-muted-foreground min-[768px]:text-base">
            Built on the IHUI AI full-stack AI operating system with one codebase across 8 endpoints; all core components are open source; covers K12, higher education, and vocational training scenarios.
          </p>
        ...
        <section className="mt-16 rounded-2xl border bg-card p-8 text-center min-[768px]:p-12">
          ...
          <h2 className="mt-4 text-xl font-bold tracking-tight min-[768px]:text-2xl">Start building your AI smart education assistant</h2>
          <p className="mx-auto mt-2 max-w-xl text-sm text-muted-foreground min-[768px]:text-base">
            Sign up and get 1000 credits, fork the smart education scenario template, and try personalized learning in 30 minutes.
          </p>
          ...
          <div className="mt-6 flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-xs text-muted-foreground">
            <span className="flex items-center gap-1.5"><MessageSquare className="h-3.5 w-3.5" /> Education consult 8801</span>
            <span className="flex items-center gap-1.5"><Lightbulb className="h-3.5 w-3.5" /> Teaching research 8805</span>
            <span className="flex items-center gap-1.5"><Palette className="h-3.5 w-3.5" /> Campus deploy 8806</span>
            <span className="flex items-center gap-1.5"><Globe className="h-3.5 w-3.5" /> District solution 8809</span>
          </div>
        </section>
      </main>
    </>
