    ...
    },
    {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          position: 3,
          name: 'AI Marketing',
          item: 'https://aizhs.top/en/use-cases/ai-marketing',
        },
      ],
    },
    {
      ...
      supply: [
        {
          '@type': 'HowToSupply',
          name: 'Brand guidelines / past hit articles / product manual / target personas',
        },
      ],
      tool: [
      ...
      step: [
        {
          '@type': 'HowToStep',
          position: 1,
          name: 'Upload brand guidelines',
          text: 'Upload brand story, voice document, and past hit articles; AI learns tone and forbidden expressions.',
        },
        {
          '@type': 'HowToStep',
          position: 2,
          name: 'Train voice model',
          text: 'Fine-tune the LLM on brand history; manual review workload drops 80% while outputs match brand persona.',
        },
        {
          '@type': 'HowToStep',
          position: 3,
          name: 'Connect platform APIs',
          text: 'Connect Xiaohongshu, Douyin, Weibo, WeChat, LinkedIn, and Twitter Open APIs for one-click publishing.',
        },
        {
          '@type': 'HowToStep',
          position: 4,
          name: 'Configure A/B tests',
          text: 'Generate 3-5 title and cover variants per topic; the agent runs A/B tests and identifies the high-CTR version within 72 hours.',
        },
        {
          '@type': 'HowToStep',
          position: 5,
          name: 'Import personas',
          text: 'Import CRM personas (age, region, spending power, interests); Agent auto-matches tone, angle, and CTA for +35% conversion.',
        },
        {
          '@type': 'HowToStep',
          position: 6,
          name: 'Enable data feedback',
          text: 'Pull platform metrics (views, likes, conversions); AI reviews top performers and feeds the next round of generation.',
        },
      ],
    },
  ],
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      'Multi-platform rewriting + brand voice consistency + A/B testing, 30-minute onboarding.',
    url: 'https://aizhs.top/en/use-cases/ai-marketing',
    type: 'article',
  },
}
...
const capabilities = [
  {
    title: 'One-click multi-platform rewriting',
    desc: 'One 3,000-word article is auto-rewritten into Xiaohongshu short post, Douyin script, Zhihu answer, LinkedIn long-form, and Weibo post; each matches the platform tone.',
  },
  {
    title: 'Smart SEO optimization',
    desc: 'Enter target keywords; AI auto-generates SEO-friendly title, meta, and body, applying mainstream rules for Google, Bing, and Baidu.',
  },
  {
    title: 'Unified brand voice',
    desc: 'Upload brand guidelines and past hits; AI learns the voice and 100% of outputs match the brand.',
  },
  {
    title: 'A/B test copy',
    desc: '3-5 title and cover variants per topic; agent runs A/B tests and finds the high-CTR version in 72 hours, lifting conversion 35%.',
  },
  {
    title: 'Persona-driven content',
    desc: 'Import CRM personas; agent matches tone, content angle, and CTA for true 1:1 personalization.',
  },
  {
    title: 'Data feedback loop',
    desc: 'Pull platform metrics; AI reviews top performers and feeds the next round of creation for continuous improvement.',
  },
]
...
const toolchain = [
  {
    ...
    purpose: 'Web workbench for marketing operations and brand guidelines',
  },
  {
    name: 'Fastify 5 + Drizzle ORM',
    purpose: 'API for multi-platform account auth and publishing queue',
  },
  {
    name: 'FastAPI + LangGraph + LiteLLM',
    purpose: 'Multi-platform rewriting + SEO optimization + brand voice fine-tuning',
  },
  {
    name: 'MCP tool protocol',
    purpose: 'Adapters for Xiaohongshu, Douyin, Weibo, WeChat, and LinkedIn',
  },
  { name: 'Tauri 2 desktop', purpose: 'Local brand asset library and offline copy workbench' },
  {
    name: 'WXT browser extension',
    purpose: 'One-click capture of reference material and competitor copy',
  },
  { name: 'Taro 4 mini-program', purpose: 'Mobile marketing data dashboard and instant review' },
  {
    name: 'CLI command line',
    purpose: 'Batch content generation and publishing pipeline automation',
  },
]
      ...
      <main className="mx-auto w-full max-w-6xl px-4 py-8 min-[768px]:px-8 min-[768px]:py-8">
        ...
        <section className="space-y-5 text-center">
          ...
          <p className="mx-auto max-w-3xl text-base text-muted-foreground min-[768px]:text-lg">
            ...
            open source, on-premise support, with unified brand voice guarantee.
          </p>
        ...
        <section className="mt-16 rounded-2xl border bg-card p-8 min-[768px]:p-12">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-xl font-bold tracking-tight min-[768px]:text-2xl">
              Capacity bottlenecks in marketing teams
            </h2>
          </div>
        ...
        <section className="mt-16">
          ...
          <p className="mx-auto mt-3 max-w-3xl text-center text-sm text-muted-foreground min-[768px]:text-base">
            ...
            endpoints; all core components are open source and integrate seamlessly with 5 major
            social platforms.
          </p>
        ...
        <section className="mt-16 rounded-2xl border bg-card p-8 text-center min-[768px]:p-12">
          ...
          <h2 className="mt-4 text-xl font-bold tracking-tight min-[768px]:text-2xl">
            Start building your AI marketing content assistant
          </h2>
          <p className="mx-auto mt-2 max-w-xl text-sm text-muted-foreground min-[768px]:text-base">
            Sign up and get 1000 credits, fork the marketing scenario template, and try
            multi-platform output in 30 minutes.
          </p>
          ...
          <div className="mt-6 flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-xs text-muted-foreground">
            <span className="flex items-center gap-1.5">
              <MessageSquare className="h-3.5 w-3.5" /> Sales consult 8804
            </span>
            <span className="flex items-center gap-1.5">
              <GraduationCap className="h-3.5 w-3.5" /> Marketing academy 8805
            </span>
            <span className="flex items-center gap-1.5">
              <Palette className="h-3.5 w-3.5" /> Brand custom 8806
            </span>
            <span className="flex items-center gap-1.5">
              <Globe className="h-3.5 w-3.5" /> Platform mirror 8809
            </span>
          </div>
        </section>
      </main>
