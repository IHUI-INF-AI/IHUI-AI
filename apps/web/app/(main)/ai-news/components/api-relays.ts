...
export const COMPANY_RELAYS: ApiRelay[] = [
  ...
  },
  {
    ...
    vendors: ['Meta', 'Qwen', 'DeepSeek', 'Mistral'],
    features: '海外开源模型聚合,主打低价 GPU 推理,OpenAI 格式兼容,支持批量推理',
    billing: '按 token 计费,价格比官方低 40-60%,送新用户免费额度',
  },
  {
    name: 'Atlas Inference',
    type: 'company',
    url: 'https://atlasinference.com/',
    docsUrl: 'https://docs.atlasinference.com/',
    baseUrl: 'https://api.atlasinference.com/v1',
    vendors: ['Meta', 'Mistral', 'Qwen', 'DeepSeek'],
    features: '海外开源模型聚合,主打企业级推理 + 私有部署,OpenAI 格式兼容',
    billing: '按 token 计费,提供免费试用额度,企业版按部署收费',
  },
  {
    name: 'DeepLink',
    type: 'company',
    url: 'https://www.deeplink.com/',
    docsUrl: 'https://docs.deeplink.com/',
    baseUrl: 'https://api.deeplink.com/v1',
    vendors: ['DeepSeek', 'Qwen', 'Moonshot', 'Alibaba'],
    features: '国内聚合平台,主打国内大模型聚合,国内直连速度快,OpenAI 格式兼容',
    billing: '按 token 计费,送新用户免费额度,支持按月套餐',
  },
  {
    name: 'Foundry',
    type: 'company',
    url: 'https://foundry.ai/',
    docsUrl: 'https://docs.foundry.ai/',
    baseUrl: 'https://api.foundry.ai/v1',
    vendors: ['Meta', 'Mistral', 'Qwen', 'DeepSeek'],
    features: '海外推理平台,主打 GPU 算力市场 + 模型部署,OpenAI 格式兼容',
    billing: '按 GPU 时长计费,送新用户额度,支持按月套餐',
  },
]
