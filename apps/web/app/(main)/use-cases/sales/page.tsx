    ...
    },
    {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 2, name: '用例', item: 'https://aizhs.top/use-cases' },
        {
          ...
          position: 3,
          name: 'AI 销售助手',
          item: 'https://aizhs.top/use-cases/sales',
        },
      ],
    },
    {
      ...
      step: [
        {
          ...
          position: 1,
          name: '接入 CRM 数据',
          text: '对接 Salesforce/HubSpot/纷享销客等 CRM,导入历史线索、成交记录、客户画像。',
        },
        {
          '@type': 'HowToStep',
          position: 2,
          name: '训练话术 Agent',
          text: '上传销冠通话录音与 IM 记录,AI 学习 Top Sales 话术模式,生成教练 Agent。',
        },
        {
          '@type': 'HowToStep',
          position: 3,
          name: '配置线索分级',
          text: '基于 BANT/MEDDIC 模型自动给线索打分,A/B/C/D 级自动路由给对应销售。',
        },
        {
          '@type': 'HowToStep',
          position: 4,
          name: '集成通话与 IM 渠道',
          text: '接入电话/企微/钉钉/邮件,Agent 实时监听对话,推送话术建议与异议处理。',
        },
        {
          '@type': 'HowToStep',
          position: 5,
          name: '自动化合同与回款',
          text: 'AI 生成合同初稿(模板 + 谈判记录),自动跟踪回款节点,逾期预警。',
        },
        {
          '@type': 'HowToStep',
          position: 6,
          name: '监控与优化',
          text: '分析转化漏斗,识别话术短板,每周自动生成销售复盘报告与改进建议。',
        },
      ],
    },
  ],
...
const capabilities = [
  {
    title: '线索自动分级',
    desc: '基于 BANT/MEDDIC 模型,AI 给每条线索打分,A/B/C/D 自动路由,销售专注高价值客户。',
  },
  {
    title: '话术实时教练',
    desc: '学习销冠通话模式,实时推送话术建议、异议处理、下一步动作,新人 1 周达到老销售 70% 水平。',
  },
  {
    title: 'CRM 自动化',
    desc: '通话/邮件/IM 自动归档到 CRM,客户画像、跟进记录、商机阶段自动更新,告别手工录入。',
  },
  {
    title: '合同一键生成',
    desc: '基于模板 + 谈判记录,AI 生成合同初稿,法务只需 review 关键条款,合同周期从 7 天缩到 1 天。',
  },
  {
    title: '回款预测',
    desc: '基于历史数据 + 当前商机阶段,预测本月/季度回款金额,准确率 90%+,财务规划不再拍脑袋。',
  },
  {
    title: '销售复盘',
    desc: '每周自动生成团队/个人复盘报告,识别话术短板、转化漏斗瓶颈,数据驱动改进。',
  },
]
