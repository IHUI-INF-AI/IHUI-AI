...
const jsonLd = {
  ...
  '@graph': [
    {
      '@type': 'WebPage',
      '@id': 'https://ihui.ai/use-cases/ai-research#webpage',
      url: 'https://ihui.ai/use-cases/ai-research',
    ...
    {
      '@type': 'BreadcrumbList',
      '@id': 'https://ihui.ai/use-cases/ai-research#breadcrumb',
      itemListElement: [
        { '@type': 'ListItem', position: 1, name: '首页', item: 'https://ihui.ai' },
        { '@type': 'ListItem', position: 2, name: '用例', item: 'https://ihui.ai/use-cases' },
        { '@type': 'ListItem', position: 3, name: 'AI 学术研究', item: 'https://ihui.ai/use-cases/ai-research' },
      ],
    },
    {
      '@type': 'HowTo',
      '@id': 'https://ihui.ai/use-cases/ai-research#howto',
      ...
      <main className="mx-auto w-full max-w-6xl px-4 py-12 md:px-8 md:py-16">
        ...
        <section className="mt-16 rounded-2xl border bg-card p-8 md:p-12">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-2xl font-bold tracking-tight md:text-3xl">研究者的真实痛点</h2>
          </div>
        ...
        <section className="mt-16 rounded-2xl border bg-card p-8 text-center md:p-12">
          ...
          <h2 className="mt-4 text-2xl font-bold tracking-tight md:text-3xl">开始搭建你的 AI 学术研究助手</h2>
