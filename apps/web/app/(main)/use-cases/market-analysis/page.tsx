...
const jsonLd = {
  ...
  '@graph': [
    ...
    },
    {
      ...
      step: [
        { '@type': 'HowToStep', position: 1, name: '接入数据源', text: '对接新闻 API/社媒(微博/小红书/抖音)/竞品官网/搜索引擎,全量采集市场信号。' },
        { '@type': 'HowToStep', position: 2, name: '配置竞品监控', text: '录入竞品清单,Agent 监控产品发布/定价/营销活动/招聘动态,日报自动推送。' },
        { '@type': 'HowToStep', position: 3, name: '设置舆情关键词', text: '配置品牌/产品/行业关键词,Agent 实时抓取舆情,负面情绪 5 分钟内预警。' },
        { '@type': 'HowToStep', position: 4, name: '训练趋势模型', text: '基于历史数据训练趋势预测模型,提前 90 天预测品类热度走势,准确率 90%+。' },
        { '@type': 'HowToStep', position: 5, name: '生成受众画像', text: '聚合社媒/搜索/电商数据,AI 自动生成受众画像(兴趣/消费力/决策路径),指导精准投放。' },
        { '@type': 'HowToStep', position: 6, name: '输出 SEO 建议', text: '基于关键词趋势与竞品内容差距,Agent 每周输出选题与 SEO 优化建议,流量提升 40%。' },
      ],
    },
  ],
}
...
const capabilities = [
  { title: '360° 竞品监控', desc: '监控竞品产品/定价/营销/招聘动态,日报自动推送,新动作 1 小时内预警。' },
  { title: '实时舆情预警', desc: '全网抓取品牌/产品/行业关键词,负面情绪 5 分钟内预警,危机公关抢占黄金窗口。' },
  { title: '趋势预测', desc: '基于历史数据训练模型,提前 90 天预测品类热度走势,准确率 90%+,产能规划不再拍脑袋。' },
  { title: '受众画像', desc: '聚合社媒/搜索/电商数据,AI 自动生成受众画像(兴趣/消费力/决策路径),指导精准投放。' },
  { title: 'SEO 建议', desc: '基于关键词趋势与竞品内容差距,每周输出选题与 SEO 优化建议,自然流量提升 40%。' },
  { title: '市场复盘', desc: '每月自动生成市场复盘报告,品牌声量/份额变化/机会威胁一览,数据驱动决策。' },
]
    ...
    <>
      ...
      <main className="mx-auto w-full max-w-6xl px-4 py-8 min-[768px]:px-8 min-[768px]:py-8">
        ...
        <section className="mt-16 rounded-2xl border bg-card p-8 text-center min-[768px]:p-12">
          ...
          <h2 className="mt-4 text-xl font-bold tracking-tight min-[768px]:text-2xl">开始构建你的 AI 市场分析助手</h2>
