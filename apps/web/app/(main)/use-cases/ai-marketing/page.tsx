    ...
    },
    {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 2, name: '用例', item: 'https://aizhs.top/use-cases' },
        {
          ...
          position: 3,
          name: 'AI 营销内容',
          item: 'https://aizhs.top/use-cases/ai-marketing',
        },
      ],
    },
    {
      ...
      step: [
        {
          ...
          position: 1,
          name: '上传品牌指南',
          text: '上传品牌故事/调性文档/历史爆款文章,AI 学习品牌语气与禁忌表达,所有产出符合调性。',
        },
        {
          '@type': 'HowToStep',
          position: 2,
          name: '训练语调模型',
          text: '基于品牌历史内容微调 LLM,确保所有 AI 产出与品牌人设一致,人工审校工作量减少 80%。',
        },
        {
          '@type': 'HowToStep',
          position: 3,
          name: '接入多平台 API',
          text: '一键对接小红书/抖音/微博/公众号/LinkedIn/Twitter 平台 Open API,内容直发,无需切换工具。',
        },
        {
          '@type': 'HowToStep',
          position: 4,
          name: '配置 A/B 测试',
          text: '同一选题自动生成 3-5 个标题与封面变体,Agent 自动跑 A/B 测试,72 小时内识别高 CTR 版本。',
        },
        {
          '@type': 'HowToStep',
          position: 5,
          name: '导入用户画像',
          text: '导入 CRM 用户画像(年龄/地域/消费力/兴趣),Agent 自动匹配调性与内容角度,转化率提升 35%。',
        },
        {
          '@type': 'HowToStep',
          position: 6,
          name: '启用数据反馈',
          text: '接入平台数据(阅读/点赞/转化),AI 自动复盘高表现内容模式,反哺下一轮内容生成。',
        },
      ],
    },
  ],
...
const capabilities = [
  {
    title: '一键多平台改写',
    desc: '一篇 3000 字深度文章,AI 自动改写为小红书短文/抖音脚本/知乎回答/LinkedIn 长文/微博推文,各平台调性匹配,人工微调即可发布。',
  },
  {
    title: 'SEO 智能优化',
    desc: '输入目标关键词,AI 自动生成 SEO 友好的标题/Meta/正文结构,内置 Google/Bing/百度主流 SEO 规则,自然排名提升。',
  },
  {
    title: '品牌语调统一',
    desc: '上传品牌指南 + 历史爆款,AI 学习调性后所有产出 100% 符合品牌,避免不同编辑产出风格不一。',
  },
  {
    title: 'A/B 测试文案',
    desc: '同一选题自动生成 3-5 个标题与封面变体,Agent 自动跑 A/B 测试,72 小时内识别高 CTR 版本,转化率提升 35%。',
  },
  {
    title: '用户画像驱动',
    desc: '导入 CRM 用户画像(年龄/地域/消费力/兴趣),Agent 自动匹配调性/内容角度/CTA 措辞,千人千面内容生成。',
  },
  {
    title: '数据反馈闭环',
    desc: '接入各平台数据(阅读/点赞/转化),AI 自动复盘高表现内容模式,反哺下一轮创作,持续优化。',
  },
]
...
const toolchain = [
  { name: 'Next.js 16 + React 19', purpose: 'Web 端营销工作台与品牌指南管理' },
      ...
      <main className="mx-auto w-full max-w-6xl px-4 py-8 min-[768px]:px-8 min-[768px]:py-8">
        ...
        <section className="space-y-5 text-center">
          ...
          <p className="mx-auto max-w-3xl text-base text-muted-foreground min-[768px]:text-lg">
            基于 IHUI AI 全栈 AI 操作系统搭建,8 端分发,Apache 2.0
            开源,支持私有化部署,品牌语调统一保障。
          </p>
        ...
        <section className="mt-16 rounded-2xl border bg-card p-8 text-center min-[768px]:p-12">
          ...
          <div className="mt-6 flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-xs text-muted-foreground">
            <span className="flex items-center gap-1.5">
              <MessageSquare className="h-3.5 w-3.5" /> 商务咨询 8804
            </span>
            <span className="flex items-center gap-1.5">
              <GraduationCap className="h-3.5 w-3.5" /> 营销学院 8805
            </span>
            <span className="flex items-center gap-1.5">
              <Palette className="h-3.5 w-3.5" /> 品牌定制 8806
            </span>
            <span className="flex items-center gap-1.5">
              <Globe className="h-3.5 w-3.5" /> 平台镜像 8809
            </span>
          </div>
        </section>
      </main>
