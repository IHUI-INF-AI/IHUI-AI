...
const jsonLd = {
  ...
  '@graph': [
    {
      '@type': 'WebPage',
      '@id': 'https://ihui.ai/use-cases/ai-translation#webpage',
      url: 'https://ihui.ai/use-cases/ai-translation',
    ...
    {
      '@type': 'BreadcrumbList',
      '@id': 'https://ihui.ai/use-cases/ai-translation#breadcrumb',
      itemListElement: [
        { '@type': 'ListItem', position: 1, name: '首页', item: 'https://ihui.ai' },
        { '@type': 'ListItem', position: 2, name: '用例', item: 'https://ihui.ai/use-cases' },
        { '@type': 'ListItem', position: 3, name: 'AI 多语翻译', item: 'https://ihui.ai/use-cases/ai-translation' },
      ],
    },
    {
      '@type': 'HowTo',
      '@id': 'https://ihui.ai/use-cases/ai-translation#howto',
      ...
      step: [
        { '@type': 'HowToStep', position: 1, name: '建立术语库', text: '录入产品/品牌/行业术语(中英日韩繁等 50+ 语种),Agent 严格遵循术语一致性,避免一词多译。' },
        { '@type': 'HowToStep', position: 2, name: '上传历史译文', text: '上传既往优质双语对照文档,Agent 学习团队译文风格,确保 AI 产出与人工历史风格一致。' },
        { '@type': 'HowToStep', position: 3, name: '配置目标语种', text: '选择目标语种(支持 50+ 主流语种 + 方言变体如繁体/简体的细分地区版本),批量翻译一键启动。' },
        { '@type': 'HowToStep', position: 4, name: '训练文化适配', text: '基于目标市场文化习惯微调翻译(如日语敬语/阿拉伯语右起/西语拉美 vs 西班牙变体),避免文化冒犯。' },
        { '@type': 'HowToStep', position: 5, name: '设置审校规则', text: '配置术语一致性/数字格式/日期格式/单位换算/敏感词检查等审校规则,Agent 自动标记可疑译文。' },
        { '@type': 'HowToStep', position: 6, name: '接入工作流', text: '对接 Git/CMS/Confluence/Notion/Figma 等内容源,翻译更新自动同步,人工只需终审关键内容。' },
      ],
    },
  ],
}
...
const capabilities = [
  { title: '50+ 语种文档翻译', desc: '支持 50+ 主流语种(中/英/日/韩/法/德/西/俄/阿拉伯/葡/意/繁简等),批量翻译 Word/PDF/Markdown/JSON/CSV 等格式,术语一致性 99%。' },
  { title: '本地化工作流', desc: '对接 Git/CMS/Confluence/Notion 等内容源,源文档更新后自动触发翻译,译文同步推送,人工只需终审关键内容。' },
  { title: '术语库管理', desc: '建立多语种术语库,AI 严格遵循术语一致性,品牌名/产品名/技术术语 0 误译,翻译记忆(TM)跨项目复用。' },
  { title: '译文智能审校', desc: '配置术语一致性/数字格式/日期格式/单位换算/敏感词等审校规则,Agent 自动标记可疑译文,人工审校工作量减少 75%。' },
  { title: '文化适配', desc: '基于目标市场文化习惯自动调整表达(日语敬语分级/阿拉伯语 RTL/西语拉美 vs 西班牙变体),避免文化冒犯,提升本地化质量。' },
  { title: '字幕翻译', desc: '支持视频字幕 SRT/VTT 文件解析与翻译,自动对齐时间轴,导出多语种字幕版本,字幕翻译效率提升 8 倍。' },
]
      ...
      <main className="mx-auto w-full max-w-6xl px-4 py-12 md:px-8 md:py-16">
        ...
        <section className="mt-16 rounded-2xl border bg-card p-8 text-center md:p-12">
          ...
          <div className="mt-6 flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-xs text-muted-foreground">
            <span className="flex items-center gap-1.5"><MessageSquare className="h-3.5 w-3.5" /> 翻译咨询 8801</span>
            <span className="flex items-center gap-1.5"><GraduationCap className="h-3.5 w-3.5" /> 术语库培训 8805</span>
            <span className="flex items-center gap-1.5"><Palette className="h-3.5 w-3.5" /> 私有化部署 8806</span>
            <span className="flex items-center gap-1.5"><Globe className="h-3.5 w-3.5" /> 语种扩展 8809</span>
          </div>
        </section>
      </main>
    </>
