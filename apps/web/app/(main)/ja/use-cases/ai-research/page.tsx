    ...
    },
    {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          position: 3,
          name: 'AI 学術研究',
          item: 'https://aizhs.top/ja/use-cases/ai-research',
        },
      ],
    },
    {
      ...
      supply: [
        {
          '@type': 'HowToSupply',
          name: '研究分野キーワード / 既存文献 PDF / 引用スタイル (APA/MLA/Chicago)',
        },
      ],
      tool: [
      ...
      step: [
        {
          ...
          position: 1,
          name: '学術 DB 接続',
          text: 'arXiv / PubMed / IEEE / CNKI / Wanfang など 30 以上の DB を接続し、新規論文を毎日自動取得。',
        },
        {
          '@type': 'HowToStep',
          position: 2,
          name: '文献 PDF アップロード',
          text: '過去 PDF を一括アップロード、タイトル・著者・要旨・参考文献を AI が自動抽出しローカル文献庫を構築。',
        },
        {
          '@type': 'HowToStep',
          position: 3,
          name: '引用スタイル設定',
          text: 'APA / MLA / Chicago / GB/T 7714 など主要引用スタイルから選択、Agent が雑誌規定の参考文献を自動生成。',
        },
        {
          '@type': 'HowToStep',
          position: 4,
          name: '綜述モデル学習',
          text: 'チーム過去の綜述文体を Agent が学習、ローカル文献庫に基づき構造化綜述を生成。',
        },
        {
          '@type': 'HowToStep',
          position: 5,
          name: 'ナレッジグラフ構築',
          text: '論文のエンティティ (著者・機関・手法・データセット) と関係を抽出、分野横断ナレッジグラフを可視化。',
        },
        {
          '@type': 'HowToStep',
          position: 6,
          name: 'トレンドレポート出力',
          text: '時系列とトピックモデルに基づき、研究热点・新興手法・潜在協力者レポートを毎週出力。',
        },
      ],
    },
  ],
...
const capabilities = [
  {
    title: '30+ DB 横断検索',
    desc: 'arXiv / PubMed / IEEE / CNKI / Wanfang / Springer / Elsevier などの学術 DB を統合検索、新論文を毎日自動入库。',
  },
  {
    title: 'PDF スマート解析',
    desc: 'PDF を一括解析しタイトル・著者・要旨・図表・式・参考文献を抽出、100 論文の解析時間が 40 時間から 20 分に短縮。',
  },
  {
    title: '引用スタイル自動生成',
    desc: 'APA / MLA / Chicago / GB/T 7714 / IEEE Vancouver など 20+ の引用スタイルをサポート、Agent が雑誌規定に合わせて参考文献を自動整形。',
  },
  {
    title: '文献綜述生成',
    desc: 'チーム過去の綜述文体を Agent が学習し構造化綜述を生成、手作業は推敲のみで済み、サイクルを 2 週間から 2 日に短縮。',
  },
  {
    title: '分野横断ナレッジグラフ',
    desc: '論文のエンティティ (著者・機関・手法・データセット) と関係を抽出、可視化ナレッジグラフで探索的クエリと潜在協力者発見を支援。',
  },
  {
    title: '研究トレンド分析',
    desc: '時系列とトピックモデルに基づき研究热点・新興手法・高被引論文を追跡、週次トレンドレポートで选题判断を支援。',
  },
]
      ...
      <main className="mx-auto w-full max-w-6xl px-4 py-8 min-[768px]:px-8 min-[768px]:py-8">
        ...
        <section className="space-y-5 text-center">
          ...
          <p className="mx-auto max-w-3xl text-base text-muted-foreground min-[768px]:text-lg">
            IHUI AI フルスタック AI OS 上で構築、8 エンドポイント配信 (Web / デスクトップ /
            ミニプログラム / ブラウザ拡張 / RN / CLI / API / AI-Service)、Apache 2.0
            オープンソース、オンプレ対応。
          </p>
        ...
        <section className="mt-16">
          ...
          <p className="mx-auto mt-3 max-w-3xl text-center text-sm text-muted-foreground min-[768px]:text-base">
            ...
            エンドポイントでソース統一、核心コンポーネントはすべてオープンソース。
          </p>
        ...
        <section className="mt-16 rounded-2xl border bg-card p-8 text-center min-[768px]:p-12">
          ...
          <div className="mt-6 flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-xs text-muted-foreground">
            <span className="flex items-center gap-1.5">
              <MessageSquare className="h-3.5 w-3.5" /> ご相談窓口 8801
            </span>
            <span className="flex items-center gap-1.5">
              <GraduationCap className="h-3.5 w-3.5" /> 教育版 8802
            </span>
            <span className="flex items-center gap-1.5">
              <Palette className="h-3.5 w-3.5" /> ラボ導入 8803
            </span>
            <span className="flex items-center gap-1.5">
              <Globe className="h-3.5 w-3.5" /> ミラー高速化 8809
            </span>
          </div>
        </section>
      </main>
