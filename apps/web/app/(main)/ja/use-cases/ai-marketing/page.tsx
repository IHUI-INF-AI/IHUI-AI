...
const jsonLd = {
  ...
  '@graph': [
    {
      '@type': 'WebPage',
      '@id': 'https://aizhs.top/ja/use-cases/ai-marketing#webpage',
      url: 'https://aizhs.top/ja/use-cases/ai-marketing',
    ...
    {
      '@type': 'BreadcrumbList',
      '@id': 'https://aizhs.top/ja/use-cases/ai-marketing#breadcrumb',
      itemListElement: [
        ...
        },
        {
          ...
          position: 3,
          name: 'AI マーケティング',
          item: 'https://aizhs.top/ja/use-cases/ai-marketing',
        },
      ],
    },
    {
      '@type': 'HowTo',
      '@id': 'https://aizhs.top/ja/use-cases/ai-marketing#howto',
      ...
      supply: [
        {
          '@type': 'HowToSupply',
          name: 'ブランドガイド / 過去ヒット記事 / 製品マニュアル / ターゲットペルソナ',
        },
      ],
      tool: [
      ...
      step: [
        {
          ...
          position: 1,
          name: 'ブランドガイドアップロード',
          text: 'ブランドストーリー / トーン文書 / 過去ヒットをアップロード、AI が語調と禁忌表現を学習。',
        },
        {
          '@type': 'HowToStep',
          position: 2,
          name: 'トーンモデル学習',
          text: 'LLM をブランド過去コンテンツで微調整、手動レビュー工数を 80% 削減しつつブランドペルソナを保持。',
        },
        {
          '@type': 'HowToStep',
          position: 3,
          name: 'マルチプラットフォーム API 接続',
          text: 'XHS / Douyin / Weibo / WeChat / LinkedIn / Twitter の Open API をワンクリック接続、ツール切替不要。',
        },
        {
          '@type': 'HowToStep',
          position: 4,
          name: 'A/B テスト設定',
          text: '选题ごとに 3-5 のタイトルとカバー案を自動生成、Agent が A/B テストを実行、72 時間以内に高 CTR 版を特定。',
        },
        {
          '@type': 'HowToStep',
          position: 5,
          name: 'ペルソナインポート',
          text: 'CRM のペルソナ (年齢・地域・消費力・興味) をインポート、Agent が自動的に語調・角度・CTA をマッチング、転換率 35% 向上。',
        },
        {
          '@type': 'HowToStep',
          position: 6,
          name: 'データフィードバック',
          text: 'プラットフォーム指標 (閲覧・いいね・転換) を取得、AI が高パフォーマンスパターンをレビューし次回生成に反映。',
        },
      ],
    },
  ],
...
export const metadata: Metadata = {
  title:
    'AI マーケティングコンテンツ生成 — マルチプラットフォーム / SEO / ブランドトーン | IHUI AI',
  description:
  ...
  openGraph: {
    ...
    description:
      'マルチプラットフォーム一括リライト + ブランドトーン統一 + A/B テスト、30 分導入。',
    url: 'https://aizhs.top/ja/use-cases/ai-marketing',
    type: 'article',
  },
}
...
const capabilities = [
  {
    title: 'ワンクリック マルチプラットフォーム リライト',
    desc: '3,000 字の深掘り記事を XHS 短文 / Douyin スクリプト / Zhihu 回答 / LinkedIn 長文 / Weibo 投稿へ自動変換、各プラットフォームのトーンに合わせて手動微調整のみで配信可能。',
  },
  {
    title: 'スマート SEO 最適化',
    desc: 'ターゲットキーワードを入力すると AI が SEO フレンドリーなタイトル・メタ・本文を自動生成、Google / Bing / Baidu の主要 SEO ルールを内蔵。',
  },
  {
    title: 'ブランドトーン統一',
    desc: 'ブランドガイドと過去ヒットをアップロード、AI がトーンを学習し 100% ブランド準拠のアウトプットを実現。',
  },
  {
    title: 'A/B テストコピー',
    desc: '选题ごとに 3-5 のタイトルとカバー案を自動生成、Agent が A/B テストを実行し 72 時間以内に高 CTR 版を特定、転換率 35% 向上。',
  },
  {
    title: 'ペルソナ駆動コンテンツ',
    desc: 'CRM のペルソナをインポートし、Agent が語調・コンテンツ角度・CTA 文言をマッチング、千人千面のコンテンツを生成。',
  },
  {
    title: 'データフィードバックループ',
    desc: 'プラットフォーム指標を取り込み、AI が高パフォーマンスパターンをレビュー、次回制作に反映して継続最適化。',
  },
]
...
const toolchain = [
  {
    ...
    purpose: 'Web エンドのマーケティングワークベンチとブランドガイド管理',
  },
  {
    name: 'Fastify 5 + Drizzle ORM',
    purpose: 'API エンドのマルチプラットフォームアカウント認可と配信キュー',
  },
  {
    name: 'FastAPI + LangGraph + LiteLLM',
    purpose: 'マルチプラットフォームリライト + SEO 最適化 + ブランドトーン微調整',
  },
  {
    name: 'MCP ツールプロトコル',
    purpose: 'XHS / Douyin / Weibo / WeChat / LinkedIn のプラットフォームアダプタ',
  },
  {
    name: 'Tauri 2 デスクトップ',
    purpose: 'ローカルブランド素材庫 + オフラインコピーワークベンチ',
  },
  { name: 'WXT ブラウザ拡張', purpose: '任意のページで素材や競合コピーをワンクリック取得' },
  {
    name: 'Taro 4 ミニプログラム',
    purpose: 'モバイルのマーケティングデータダッシュボードと即時レビュー',
  },
      ...
      <main className="mx-auto w-full max-w-6xl px-4 py-8 min-[768px]:px-8 min-[768px]:py-8">
        ...
        <section className="mt-16">
          ...
          <p className="mx-auto mt-3 max-w-3xl text-center text-sm text-muted-foreground min-[768px]:text-base">
            ...
            エンドポイントでソース統一、核心コンポーネントはすべてオープンソース、5 大手 SNS
            とシームレス連携。
          </p>
        ...
        <section className="mt-16 rounded-2xl border bg-card p-8 text-center min-[768px]:p-12">
          ...
          <h2 className="mt-4 text-xl font-bold tracking-tight min-[768px]:text-2xl">
            AI マーケティングコンテンツアシスタントの構築を始めましょう
          </h2>
          <p className="mx-auto mt-2 max-w-xl text-sm text-muted-foreground min-[768px]:text-base">
            登録で 1000 クレジット進呈、マーケティングシナリオテンプレートからワンクリック fork、30
            分でマルチプラットフォーム一括産出を体験。
          </p>
          ...
          <div className="mt-6 flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-xs text-muted-foreground">
            <span className="flex items-center gap-1.5">
              <MessageSquare className="h-3.5 w-3.5" /> ビジネス相談 8804
            </span>
            <span className="flex items-center gap-1.5">
              <GraduationCap className="h-3.5 w-3.5" /> マーケアカデミー 8805
            </span>
            <span className="flex items-center gap-1.5">
              <Palette className="h-3.5 w-3.5" /> ブランドカスタム 8806
            </span>
            <span className="flex items-center gap-1.5">
              <Globe className="h-3.5 w-3.5" /> プラットフォームミラー 8809
            </span>
          </div>
        </section>
      </main>
