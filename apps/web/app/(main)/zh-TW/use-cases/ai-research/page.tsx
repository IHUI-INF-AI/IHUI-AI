    ...
    },
    {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 2, name: '用例', item: 'https://aizhs.top/use-cases' },
        {
          ...
          position: 3,
          name: 'AI 學術研究',
          item: 'https://aizhs.top/zh-TW/use-cases/ai-research',
        },
      ],
    },
    {
      ...
      supply: [
        { '@type': 'HowToSupply', name: '研究領域關鍵詞/既往文獻 PDF/引用樣式(APA/MLA/Chicago)' },
      ],
      tool: [
      ...
      step: [
        {
          ...
          position: 1,
          name: '接入學術資料庫',
          text: '對接 arXiv/PubMed/IEEE/知網/萬方/CNKI 等 30+ 資料庫,定時抓取新發表論文。',
        },
        {
          '@type': 'HowToStep',
          position: 2,
          name: '上傳文獻 PDF',
          text: '批次上傳歷史 PDF 文獻,AI 自動抽取標題/作者/摘要/參考文獻,建構本地文獻庫。',
        },
        {
          '@type': 'HowToStep',
          position: 3,
          name: '配置引用樣式',
          text: '選擇 APA/MLA/Chicago/GB/T 7714 等主流引用樣式,Agent 自動生成符合規範的參考文獻。',
        },
        {
          '@type': 'HowToStep',
          position: 4,
          name: '訓練綜述模型',
          text: 'Agent 學習團隊既往綜述寫作風格,基於本地文獻庫生成符合學術規範的文獻綜述。',
        },
        {
          '@type': 'HowToStep',
          position: 5,
          name: '建構知識圖譜',
          text: '抽取論文中的實體(作者/機構/方法/資料集)與關係,生成跨學科知識圖譜,支援探索性查詢。',
        },
        {
          '@type': 'HowToStep',
          position: 6,
          name: '輸出趨勢報告',
          text: '基於時間序列與主題模型,每週輸出研究熱點/新興方法/潛在合作者報告。',
        },
      ],
    },
  ],
...
const capabilities = [
  {
    title: '30+ 資料庫跨庫檢索',
    desc: '對接 arXiv/PubMed/IEEE/知網/萬方/Springer/Elsevier 等學術資料庫,統一檢索入口,新論文每日自動入庫。',
  },
  {
    title: 'PDF 智慧解析',
    desc: '批次解析 PDF 提取標題/作者/摘要/圖表/公式/參考文獻,100 篇文獻解析時間從 40 小時縮短到 20 分鐘。',
  },
  {
    title: '引用樣式自動生成',
    desc: '支援 APA/MLA/Chicago/GB/T 7714/IEEE Vancouver 等 20+ 引用樣式,Agent 自動按期刊要求格式化參考文獻。',
  },
  {
    title: '文獻綜述生成',
    desc: 'Agent 學習團隊既往綜述寫作風格,基於本地文獻庫生成結構化綜述,人工只需潤稿,週期從 2 週縮到 2 天。',
  },
  {
    title: '跨學科知識圖譜',
    desc: '抽取論文中的實體(作者/機構/方法/資料集)與關係,生成可視化知識圖譜,支援探索性查詢與潛在合作者發現。',
  },
  {
    title: '研究趨勢分析',
    desc: '基於時間序列與主題模型,追蹤研究熱點/新興方法/高被引論文,每週輸出趨勢報告,輔助選題決策。',
  },
]
...
const toolchain = [
  { name: 'Next.js 16 + React 19', purpose: 'Web 端文獻檢索/閱讀/寫作工作台' },
      ...
      <main className="mx-auto w-full max-w-6xl px-4 py-8 min-[768px]:px-8 min-[768px]:py-8">
        ...
        <section className="space-y-5 text-center">
          ...
          <p className="mx-auto max-w-3xl text-base text-muted-foreground min-[768px]:text-lg">
            基於 IHUI AI 全棧 AI 作業系統搭建,8
            端分發(Web/桌面/小程式/瀏覽器擴充套件/RN/CLI/API/AI-Service),Apache 2.0
            開源,支援私有化部署。
          </p>
        ...
        <section className="mt-16 rounded-2xl border bg-card p-8 text-center min-[768px]:p-12">
          ...
          <div className="mt-6 flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-xs text-muted-foreground">
            <span className="flex items-center gap-1.5">
              <MessageSquare className="h-3.5 w-3.5" /> 諮詢入口 8801
            </span>
            <span className="flex items-center gap-1.5">
              <GraduationCap className="h-3.5 w-3.5" /> 教學版 8802
            </span>
            <span className="flex items-center gap-1.5">
              <Palette className="h-3.5 w-3.5" /> 實驗室部署 8803
            </span>
            <span className="flex items-center gap-1.5">
              <Globe className="h-3.5 w-3.5" /> 鏡像加速 8809
            </span>
          </div>
        </section>
      </main>
