...
const jsonLd = {
  ...
  '@graph': [
    ...
    },
    {
      ...
      step: [
        { '@type': 'HowToStep', position: 1, name: '建立術語庫', text: '錄入產品/品牌/行業術語(中英日韓繁等 50+ 語種),Agent 嚴格遵循術語一致性,避免一詞多譯。' },
        { '@type': 'HowToStep', position: 2, name: '上傳歷史譯文', text: '上傳既往優質雙語對照文件,Agent 學習團隊譯文風格,確保 AI 產出與人工歷史風格一致。' },
        { '@type': 'HowToStep', position: 3, name: '配置目標語種', text: '選擇目標語種(支援 50+ 主流語種 + 方言變體如繁體/簡體的細分地區版本),批次翻譯一鍵啟動。' },
        { '@type': 'HowToStep', position: 4, name: '訓練文化適配', text: '基於目標市場文化習慣微調翻譯(如日語敬語/阿拉伯語右起/西語拉美 vs 西班牙變體),避免文化冒犯。' },
        { '@type': 'HowToStep', position: 5, name: '設定審校規則', text: '配置術語一致性/數字格式/日期格式/單位換算/敏感詞檢查等審校規則,Agent 自動標記可疑譯文。' },
        { '@type': 'HowToStep', position: 6, name: '接入工作流', text: '對接 Git/CMS/Confluence/Notion/Figma 等內容源,翻譯更新自動同步,人工只需終審關鍵內容。' },
      ],
    },
  ],
}
...
const capabilities = [
  { title: '50+ 語種文件翻譯', desc: '支援 50+ 主流語種(中/英/日/韓/法/德/西/俄/阿拉伯/葡/意/繁簡等),批次翻譯 Word/PDF/Markdown/JSON/CSV 等格式,術語一致性 99%。' },
  { title: '本地化工作流', desc: '對接 Git/CMS/Confluence/Notion 等內容源,源文件更新後自動觸發翻譯,譯文同步推送,人工只需終審關鍵內容。' },
  { title: '術語庫管理', desc: '建立多語種術語庫,AI 嚴格遵循術語一致性,品牌名/產品名/技術術語 0 誤譯,翻譯記憶(TM)跨專案複用。' },
  { title: '譯文智慧審校', desc: '配置術語一致性/數字格式/日期格式/單位換算/敏感詞等審校規則,Agent 自動標記可疑譯文,人工審校工作量減少 75%。' },
  { title: '文化適配', desc: '基於目標市場文化習慣自動調整表達(日語敬語分級/阿拉伯語 RTL/西語拉美 vs 西班牙變體),避免文化冒犯,提升本地化品質。' },
  { title: '字幕翻譯', desc: '支援影片字幕 SRT/VTT 檔案解析與翻譯,自動對齊時間軸,匯出多語種字幕版本,字幕翻譯效率提升 8 倍。' },
]
...
const toolchain = [
  { name: 'Next.js 15 + React 19', purpose: 'Web 端翻譯工作台與術語庫管理' },
      ...
      <main className="mx-auto w-full max-w-6xl px-4 py-12 md:px-8 md:py-16">
        ...
        <section className="space-y-5 text-center">
          ...
          <p className="mx-auto max-w-3xl text-base text-muted-foreground md:text-lg">
            基於 IHUI AI 全棧 AI 作業系統搭建,8 端分發,Apache 2.0 開源,支援私有化部署,術語庫 + 文化適配雙引擎保障譯文品質。
          </p>
        ...
        <section className="mt-16 rounded-2xl border bg-card p-8 md:p-12">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-2xl font-bold tracking-tight md:text-3xl">出海團隊的本地化困境</h2>
          </div>
        ...
        <section className="mt-16 rounded-2xl border bg-primary/5 p-8 md:p-12">
          <h2 className="text-center text-2xl font-bold tracking-tight md:text-3xl">客戶落地案例</h2>
        ...
        <section className="mt-16">
          <div className="flex items-center justify-center gap-3">
            ...
            <h2 className="text-center text-2xl font-bold tracking-tight md:text-3xl">技術棧與工具鏈</h2>
          </div>
          <p className="mx-auto mt-3 max-w-3xl text-center text-sm text-muted-foreground md:text-base">
            基於 IHUI AI 全棧 AI 作業系統,8 端同源,核心元件全部開源,深度對接 Git/CMS/Confluence/Notion。
          </p>
        ...
        <section className="mt-16 rounded-2xl border bg-card p-8 text-center md:p-12">
          ...
          <h2 className="mt-4 text-2xl font-bold tracking-tight md:text-3xl">開始搭建你的 AI 多語翻譯助手</h2>
          ...
          <div className="mt-6 flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-xs text-muted-foreground">
            <span className="flex items-center gap-1.5"><MessageSquare className="h-3.5 w-3.5" /> 翻譯諮詢 8801</span>
            <span className="flex items-center gap-1.5"><GraduationCap className="h-3.5 w-3.5" /> 術語庫培訓 8805</span>
            <span className="flex items-center gap-1.5"><Palette className="h-3.5 w-3.5" /> 私有化部署 8806</span>
            <span className="flex items-center gap-1.5"><Globe className="h-3.5 w-3.5" /> 語種擴充 8809</span>
          </div>
        </section>
      </main>
    </>
