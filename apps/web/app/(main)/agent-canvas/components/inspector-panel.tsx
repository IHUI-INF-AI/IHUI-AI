  ...
  return (
    <div className="flex w-72 shrink-0 flex-col border-l bg-card">
      <div className="flex items-center justify-between border-b px-3 py-2.5">
        ...
        <Badge className={cn('border-0', meta.badge)}>{t(meta.titleKey)}</Badge>
      </div>

      <div className="flex flex-col gap-3 border-b p-3">
        <div className="flex flex-col gap-1.5">
          <Label htmlFor="canvas-node-name">{t('nodeName')}</Label>
          <Input
            id="canvas-node-name"
            value={node.label}
        ...
        {node.nodeType === 'agent' && (
          <>
            ...
            <div className="flex flex-col gap-1.5">
              <Label htmlFor="canvas-node-input-agent">{t('inputLabel')}</Label>
              <textarea
