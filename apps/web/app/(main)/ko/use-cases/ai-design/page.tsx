...
const jsonLd = {
  ...
  '@graph': [
    {
      '@type': 'WebPage',
      '@id': 'https://ihui.ai/ko/use-cases/ai-design#webpage',
      url: 'https://ihui.ai/ko/use-cases/ai-design',
    ...
    {
      '@type': 'BreadcrumbList',
      '@id': 'https://ihui.ai/ko/use-cases/ai-design#breadcrumb',
      itemListElement: [
        { '@type': 'ListItem', position: 1, name: '홈', item: 'https://ihui.ai' },
        { '@type': 'ListItem', position: 2, name: '사용 사례', item: 'https://ihui.ai/use-cases' },
        { '@type': 'ListItem', position: 3, name: 'AI 디자인', item: 'https://ihui.ai/ko/use-cases/ai-design' },
      ],
    },
    {
      '@type': 'HowTo',
      '@id': 'https://ihui.ai/ko/use-cases/ai-design#howto',
      ...
      <main className="mx-auto w-full max-w-6xl px-4 py-12 md:px-8 md:py-16">
        ...
        <section className="mt-16 rounded-2xl border bg-card p-8 md:p-12">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-2xl font-bold tracking-tight md:text-3xl">디자인 팀의 실제 페인 포인트</h2>
          </div>
        ...
        <section className="mt-16 rounded-2xl border bg-card p-8 text-center md:p-12">
          ...
          <h2 className="mt-4 text-2xl font-bold tracking-tight md:text-3xl">AI 디자인 협업 어시스턴트 구축을 시작하세요</h2>
