    ...
    },
    {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          position: 3,
          name: 'AI 디자인',
          item: 'https://aizhs.top/ko/use-cases/ai-design',
        },
      ],
    },
    {
      ...
      supply: [
        {
          '@type': 'HowToSupply',
          name: '브랜드 VI 매뉴얼 / 과거 디자인 초안 / 디자인 시스템 토큰',
        },
      ],
      tool: [
      ...
      step: [
        {
          ...
          position: 1,
          name: '브랜드 자산 업로드',
          text: '브랜드 VI/과거 포스터/Logo/디자인 시스템 토큰 업로드, AI가 팔레트/폰트/레이아웃을 추출합니다.',
        },
        {
          '@type': 'HowToStep',
          position: 2,
          name: '디자인 시스템 설정',
          text: 'Figma 토큰(컬러/폰트 크기/스페이싱/라운드/섀도우) 임포트, 이후 모든 생성이 디자인 시스템을 엄격히 준수합니다.',
        },
        {
          '@type': 'HowToStep',
          position: 3,
          name: '콘셉트 생성 학습',
          text: '과거 히트 포스터/Logo로 학습, AI가 브랜드 톤에 맞는 3-5개 크리에이티브 방향을 제안합니다.',
        },
        {
          '@type': 'HowToStep',
          position: 4,
          name: '스케치를 코드로',
          text: '수기 UI 스케치 업로드, Agent가 컴포넌트 구조 인식, 85% 이상 정확도로 React + Tailwind 코드를 생성합니다.',
        },
        {
          '@type': 'HowToStep',
          position: 5,
          name: '리뷰 규칙 설정',
          text: 'a11y/브랜드 일관성/반응형 규칙 설정, Agent가 디자인 자동 리뷰, 필요한 변경을 플래그합니다.',
        },
        {
          '@type': 'HowToStep',
          position: 6,
          name: '협업 도구 연결',
          text: 'Figma/Sketch/即时设计/兰호/Notion을 통합, AI가 기존 워크플로우에 임베드됩니다.',
        },
      ],
    },
  ],
...
const capabilities = [
  {
    title: '포스터/Logo 콘셉트',
    desc: '과거 히트 디자인과 브랜드 VI로 학습, AI가 3-5개 콘셉트 방향 자동 제안, 디자이너는 다듬기만 하면 됨, 콘셉트 효율 5배 향상.',
  },
  {
    title: 'UI 스케치를 코드로',
    desc: '수기 UI 스케치를 업로드, Agent가 컴포넌트 구조 인식, 85% 이상 정확도로 React + Tailwind 코드 생성, 개발자 왕복 70% 감소.',
  },
  {
    title: '디자인 시스템 통합',
    desc: 'Figma 토큰(컬러/폰트/스페이싱/라운드/섀도우)을 임포트, 이후 모든 생성이 디자인 시스템 엄격 준수, 일관성 99%.',
  },
  {
    title: '브랜드 자산 관리',
    desc: 'Figma/사내 NAS/로컬 PC 자산을 통합 검색, AI가 사용 시나리오에 따라 자산을 자동 추천, 자산 재사용률 60% 향상.',
  },
  {
    title: '스마트 디자인 리뷰',
    desc: 'a11y/브랜드 일관성/반응형 규칙 설정, Agent가 디자인 자동 리뷰, 출품 전 위반 사항 플래그, 리뷰 시간 80% 단축.',
  },
  {
    title: '디자인-개발 핸드오프',
    desc: 'Figma 컴포넌트와 코드 컴포넌트 매핑 자동 생성, CSS 변수/Props 자동 동기화, 핸드오프 재작업 90% 감소.',
  },
]
      ...
      <main className="mx-auto w-full max-w-6xl px-4 py-8 min-[768px]:px-8 min-[768px]:py-8">
        ...
        <section className="mt-16">
          ...
          <p className="mx-auto mt-3 max-w-3xl text-center text-sm text-muted-foreground min-[768px]:text-base">
            IHUI AI 풀스택 AI OS 기반, 8엔드포인트 소스 통합, Figma/Sketch/即时设计/兰호/Notion과
            깊이 통합.
          </p>
        ...
        <section className="mt-16 rounded-2xl border bg-card p-8 text-center min-[768px]:p-12">
          ...
          <div className="mt-6 flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-xs text-muted-foreground">
            <span className="flex items-center gap-1.5">
              <MessageSquare className="h-3.5 w-3.5" /> 디자인 상담 8801
            </span>
            <span className="flex items-center gap-1.5">
              <GraduationCap className="h-3.5 w-3.5" /> 시스템 트레이닝 8805
            </span>
            <span className="flex items-center gap-1.5">
              <Palette className="h-3.5 w-3.5" /> 온프레미스 8806
            </span>
            <span className="flex items-center gap-1.5">
              <Globe className="h-3.5 w-3.5" /> 도구 확장 8809
            </span>
          </div>
        </section>
      </main>
