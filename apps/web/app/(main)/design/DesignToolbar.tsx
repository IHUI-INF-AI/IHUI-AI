        ...
        <Tooltip content={t('design.templates.title')}>
          ...
          >
            <svg
              ...
              aria-hidden="true"
            >
              <rect x="3" y="3" width="7" height="9" rx={rnRadius.xs} />
              <rect x="14" y="3" width="7" height="5" rx={rnRadius.xs} />
              <rect x="14" y="12" width="7" height="9" rx={rnRadius.xs} />
              <rect x="3" y="16" width="7" height="5" rx={rnRadius.xs} />
            </svg>
