...
export const metadata: Metadata = {
  // 2026-07-28 P1-4 SEO 资产补全:
  // - 使用 absolute 避免与根 layout 的 template "%s | IHUI AI" 双重应用,
  //   否则 /agents 等子页面会渲染为 "工作区 ... | IHUI AI | IHUI AI"
  // - 子页面继承根 layout 的 template (子页面 metadata.title 为字符串时)
  title: { absolute: '工作区 — AI 对话 / Agent / RAG / 内容创作 | IHUI AI' },
  description:
