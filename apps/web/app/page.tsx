...
export default function MarketingHomePage() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <main className="mx-auto w-full max-w-7xl flex-1 space-y-8 px-4 py-6 md:px-8 md:py-8">
        {/* Hero 轮播 */}
        <HeroCarousel />
        ...
        {/* 智汇 AI 社区欢迎语 + 价格 */}
        <section className="overflow-hidden rounded-2xl border bg-gradient-to-br from-primary/5 via-card to-emerald-500/5">
          <div className="grid gap-6 p-6 md:grid-cols-2 md:p-10">
            <div className="space-y-4">
              ...
              <p className="text-sm text-muted-foreground md:text-base">{t('welcome.subtitle')}</p>
            ...
            <div className="flex flex-col justify-center gap-4 rounded-xl border bg-card p-6 shadow-sm">
              ...
              <p className="text-center text-xs text-muted-foreground">{te('join.consultHint')}</p>
            </div>
          </div>
        </section>
