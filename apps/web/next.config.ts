  ...
  async rewrites() {
    ...
    return {
      ...
      afterFiles: [
        ...
        { source: '/api/cost-ledger/:path*', destination: 'http://localhost:8803/api/cost-ledger/:path*' },
        { source: '/api/longterm-memory/:path*', destination: 'http://localhost:8803/api/longterm-memory/:path*' },
        {
          source: '/api/:path*',
