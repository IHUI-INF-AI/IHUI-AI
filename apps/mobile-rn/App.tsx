...
function AppInner() {
  ...
  return (
     ...
     * components/NavBar、screens/PostCreateScreen、screens/WebViewScreen 已摘;
     * packages/app 的 search/SearchScreen 仍留 `paddingTop: 48`,与这里的 inset 叠成双份顶距,
     * 是该屏顶距偏高的唯一剩余成因;DevErrorToast 是 absolute 子元素,相对本容器
