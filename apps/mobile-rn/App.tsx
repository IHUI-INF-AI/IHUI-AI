...
function AppInner() {
  ...
  return (
     ...
     * 自绘的"返回"页头没有一个处理 inset,页头与系统时钟/电量叠字(真机实测 y0=24..78)。
     * 逐屏补是 180 处改动,这里包一层是一次性收口。因此原先自带顶距的四处必须同时摘掉,
     * 否则双份:components/NavBar、screens/PostCreateScreen、screens/WebViewScreen、
