...
vi.mock('react-native', async () => {
  ...
  const mk = (name: string) =>
    function MockComp(props: { children?: ReactNode; style?: unknown; onPress?: () => void; [k: string]: unknown }) {
...
describe('IntelligentAssistant (mobile-rn)', () => {
  ...
  it('renders floating decoration image when robotImage provided', () => {
    const { container } = render(<IntelligentAssistant robotImage="https://example.com/xiaofang.png" />, { wrapper })
