...
import type { TitleSwitchOverlapItem } from '@ihui/ui-native'

// 共享类型 TitleSwitchOverlapItem 下沉到 packages/types,两端复用。
// 保留 TitleSwitchItem 别名以维持本模块公开 API(本模块内部亦使用此名)。
export type TitleSwitchItem = TitleSwitchOverlapItem
