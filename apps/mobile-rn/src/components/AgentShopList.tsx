        ...
        {onItemLike || onItemCollect ? (
          <View style={styles.reactionRow}>
            {onItemLike ? (
              ...
              >
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                  <ThumbsUp size={12} color={item.isThumbs ? tokens.brand.DEFAULT : tokens.text.secondary} />
                  <Text
            ...
            {onItemCollect ? (
              ...
              >
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                  <Star size={12} color={item.isCollect ? tokens.brand.DEFAULT : tokens.text.secondary} />
                  <Text
