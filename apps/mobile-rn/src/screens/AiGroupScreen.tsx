...
const s = StyleSheet.create({
  ...
  miniAvatar: { width: 22, height: 22, borderRadius: 6, backgroundColor: tokens.border.light, alignItems: 'center', justifyContent: 'center', borderWidth: 1.5, borderColor: tokens.surface.light },
  ...
  detailHead: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 16, paddingVertical: 12, borderBottomColor: tokens.surface.card, borderBottomWidth: 1 },
  ...
  sectionTitle: { marginTop: 20, marginBottom: 10, fontSize: 13, fontWeight: '600', color: tokens.text.primary },
  memberItem: { flexDirection: 'row', alignItems: 'center', paddingVertical: 10, borderRadius: 10, backgroundColor: tokens.surface.muted, paddingHorizontal: 12, marginBottom: 8 },
  ...
  previewBubble: { padding: 10, borderRadius: 10, backgroundColor: tokens.surface.card, marginBottom: 8 },
