...
const s = StyleSheet.create({
  ...
  summaryCard: { marginHorizontal: 16, padding: 16, borderRadius: 12, backgroundColor: tokens.purple.light },
  sumTop: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  sumLabel: { fontSize: 13, color: tokens.text.medium },
  sumAmount: { fontSize: 18, fontWeight: '700', color: tokens.purple.DEFAULT },
  withdrawBtn: {
  ...
  cardAvatarText: { fontSize: 15, fontWeight: '600', color: tokens.purple.DEFAULT },
  cardInfo: { flex: 1 },
  cardName: { fontSize: 14, fontWeight: '600', color: tokens.text.primary },
  cardMeta: { marginTop: 2, fontSize: 11, color: tokens.text.tertiary },
  cardAmount: { fontSize: 15, fontWeight: '700', color: tokens.warning.deep },
  ...
  payIcon: {
    ...
    height: 36,
    borderRadius: 8,
    backgroundColor: tokens.brand.DEFAULT, // TODO: custom color #07C160 (WeChat green)
    alignItems: 'center',
    justifyContent: 'center',
    marginRight: 12,
  },
