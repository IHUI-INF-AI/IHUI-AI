...
const s = StyleSheet.create({
  ...
  title: { fontSize: 20, fontWeight: '700', color: tokens.text.primary },
  subtitle: { marginTop: 4, fontSize: 12, color: tokens.text.secondary },
  heroCard: { marginHorizontal: 16, marginTop: 8, padding: 16, borderRadius: 12, backgroundColor: tokens.surface.dark },
  ...
  statCard: { marginHorizontal: 16, marginTop: 12, padding: 14, borderRadius: 12, borderWidth: 1, borderColor: tokens.border.light, flexDirection: 'row', flexWrap: 'wrap' },
  ...
  entryText: { marginTop: 4, fontSize: 12, color: tokens.text.medium },
  sectionHead: { marginHorizontal: 16, marginTop: 18, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  sectionTitle: { fontSize: 15, fontWeight: '600', color: tokens.text.primary },
  sectionCount: { fontSize: 11, color: tokens.text.tertiary },
  featureList: { paddingHorizontal: 16, paddingTop: 10 },
  featureGap: { height: 10 },
  featureItem: { flexDirection: 'row', alignItems: 'center', padding: 12, borderRadius: 10, borderWidth: 1, borderColor: tokens.border.light },
  ...
  featureTitle: { flex: 1, fontSize: 13, color: tokens.text.medium, lineHeight: 18 },
  footPlaceholder: { height: 88 },
  footer: { position: 'absolute', bottom: 0, left: 0, right: 0, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 16, paddingVertical: 12, backgroundColor: tokens.surface.light, shadowColor: '#000000', shadowOpacity: 0.06, shadowRadius: 8, shadowOffset: { width: 0, height: -2 }, elevation: 8 },
  footLeft: { flexDirection: 'row', alignItems: 'baseline' },
  footSymbol: { fontSize: 14, fontWeight: '600', color: tokens.text.primary },
  footPrice: { fontSize: 22, fontWeight: '700', color: tokens.text.primary },
  footHint: { fontSize: 11, color: tokens.text.tertiary },
