...
import { LiveListScreen as SharedLiveListScreen, type LiveListItem, type LiveListTab } from '@ihui/rn-app'
...
interface LivePage {
  list: Array<{
    id: string; title: string; lecturer: string
    status: 'upcoming' | 'ongoing' | 'ended'
    startAt: string; viewerCount: number; cover: string | null
  }>
  total: number
}
...
export function LiveListScreen() {
  ...
  const { items, loading, refreshing, error, refresh } = usePaginatedList<LiveListItem>(fetcher, PAGE_SIZE)
