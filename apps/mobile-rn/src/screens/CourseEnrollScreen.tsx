...
const styles = StyleSheet.create({
  ...
  searchBtn: { paddingHorizontal: 16, paddingVertical: 8, borderRadius: 8, backgroundColor: tokens.success.DEFAULT },
  searchBtnText: { color: tokens.surface.light, fontSize: 14 },
  toastText: { paddingHorizontal: 16, paddingVertical: 4, fontSize: 12, color: tokens.success.DEFAULT },
  ...
  badgeEnrolled: { paddingHorizontal: 8, paddingVertical: 2, borderRadius: 8, backgroundColor: tokens.success.lighter },
  badgeText: { fontSize: 11, color: tokens.success.deepText }, // TODO: custom color (#047857)
  ...
  priceText: { fontSize: 16, fontWeight: '600', color: tokens.success.DEFAULT },
  enrollBtn: { paddingHorizontal: 16, paddingVertical: 8, borderRadius: 8, backgroundColor: tokens.success.DEFAULT },
  enrollBtnDisabled: { backgroundColor: tokens.text.tertiary },
  enrollBtnText: { color: tokens.surface.light, fontSize: 13, fontWeight: '600' },
