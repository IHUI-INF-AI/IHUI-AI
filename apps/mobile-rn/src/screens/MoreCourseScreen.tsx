...
import { NativeScrollEvent, NativeSyntheticEvent, RefreshControl, ScrollView, StyleSheet, Text, TouchableOpacity, View } from 'react-native'
...
export function MoreCourseScreen() {
  ...
  return (
    <View style={styles.root}>
      ...
      {/* 返回顶部按钮(纯图标,滚动超过 200dp 时显示在顶部居中) */}
      {showBackToTop ? (
        <TouchableOpacity
