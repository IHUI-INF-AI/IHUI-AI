    ...
    <View style={s.container}>
      ...
      {loading && items.length === 0 ? (
        <View style={s.loadingWrap}>
          <ActivityIndicator color={tokens.purple.DEFAULT} />
        </View>
      ) : (
        <FlatList
          data={list}
          ...
          refreshControl={
            <RefreshControl refreshing={refreshing} onRefresh={onRefresh} colors={[tokens.purple.DEFAULT]} />
          }
...
const s = StyleSheet.create({
  ...
  createBtn: { paddingHorizontal: 14, paddingVertical: 6, borderRadius: 8, backgroundColor: tokens.purple.DEFAULT },
  createText: { fontSize: 13, fontWeight: '600', color: tokens.surface.light },
  ...
  tabRow: { flexDirection: 'row', marginHorizontal: 16, marginTop: 12, padding: 4, borderRadius: 10, backgroundColor: tokens.surface.card },
  ...
  errorBar: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginHorizontal: 16, marginTop: 8, paddingHorizontal: 12, paddingVertical: 8, borderRadius: 8, backgroundColor: tokens.danger.light },
  errorText: { fontSize: 12, color: tokens.danger.DEFAULT },
  retryText: { fontSize: 12, fontWeight: '600', color: tokens.purple.DEFAULT },
  ...
  dotRun: { backgroundColor: tokens.success.DEFAULT },
  dotStop: { backgroundColor: tokens.text.tertiary },
  cardName: { flex: 1, fontSize: 15, fontWeight: '600', color: tokens.text.primary },
  badge: { fontSize: 11, fontWeight: '600', paddingHorizontal: 8, paddingVertical: 3, borderRadius: 6 },
  badgeRun: { color: tokens.success.DEFAULT, backgroundColor: tokens.success.light },
  badgeStop: { color: tokens.text.secondary, backgroundColor: tokens.surface.card },
  cardDesc: { marginTop: 8, fontSize: 13, color: tokens.text.medium },
  cardUrl: { marginTop: 6, fontSize: 11, color: tokens.purple.DEFAULT },
  ...
  actionStart: { backgroundColor: tokens.success.DEFAULT },
  actionStop: { backgroundColor: tokens.warning.deep },
  actionText: { fontSize: 13, fontWeight: '600', color: tokens.surface.light },
  actionEdit: { paddingHorizontal: 16, height: 34, borderRadius: 8, borderWidth: 1, borderColor: tokens.border.light, alignItems: 'center', justifyContent: 'center' },
  actionEditText: { fontSize: 13, color: tokens.text.medium },
})
