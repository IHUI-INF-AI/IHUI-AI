...
// 用 SvgXml 渲染(RN <Image> 不支持 SVG),尺寸 447×67 等比缩放到 width 200
...
export function LoginScreen() {
  ...
  // 浅色主题用黑字,深色主题用白字;SvgXml 渲染,width 200 等比缩放(447×67 → 200×30)
    ...
    <View style={styles.container}>
      <View style={styles.body}>
        <SharedLoginScreen
          ...
          welcomeNode={<SvgXml xml={welcomeXml} width={200} height={30} />}
          // 4-tab 配置
          tabs={TABS}
          defaultTab="password"
          // email tab
