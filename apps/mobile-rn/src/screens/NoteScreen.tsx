...
const styles = StyleSheet.create({
  ...
  center: { flex: 1, alignItems: 'center', justifyContent: 'center', backgroundColor: tokens.surface.light, paddingHorizontal: 16 },
  ...
  editBtn: { paddingHorizontal: 12, paddingVertical: 6, borderRadius: 8, backgroundColor: tokens.surface.card },
  ...
  modalContent: { width: '100%', maxWidth: 400, backgroundColor: tokens.surface.light, borderRadius: 8, padding: 16 },
  modalTitle: { fontSize: 16, fontWeight: '600', color: tokens.text.primary, marginBottom: 12 },
  titleInput: { paddingHorizontal: 12, paddingVertical: 8, borderRadius: 8, borderWidth: 1, borderColor: tokens.border.light, fontSize: 14, color: tokens.text.primary },
  contentInput: { marginTop: 8, paddingHorizontal: 12, paddingVertical: 8, borderRadius: 8, borderWidth: 1, borderColor: tokens.border.light, fontSize: 14, color: tokens.text.primary, minHeight: 120, maxHeight: 200 },
  modalActions: { flexDirection: 'row', gap: 8, marginTop: 12 },
  cancelBtn: { flex: 1, paddingVertical: 10, borderRadius: 8, backgroundColor: tokens.surface.card, alignItems: 'center' },
