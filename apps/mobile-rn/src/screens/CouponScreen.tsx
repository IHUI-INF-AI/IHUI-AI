...
import { CouponScreen as SharedCouponScreen, type CouponItem, type CouponStatus } from '@ihui/rn-app'
...
interface CouponPage {
  list: Array<{
    id: string; name: string; amount: number; minSpend: number
    validUntil: string; status: 'available' | 'used' | 'expired'
  }>
  total: number
}
