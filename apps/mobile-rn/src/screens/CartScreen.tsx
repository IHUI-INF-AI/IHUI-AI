      ...
      <View style={styles.info}>
        ...
        <View style={styles.qtyRow}>
          <Pressable
            ...
            accessibilityLabel="-"
          >
            <Minus size={rpx(28)} color={item.quantity <= 1 ? tk.text.tertiary : tk.text.secondary} />
          </Pressable>
  ...
  return (
    <View style={styles.container}>
      ...
      <FlatList
        ...
        refreshControl={
          <RefreshControl refreshing={refreshing} onRefresh={() => load(true)} tintColor={tk.text.secondary} />
        }
        ListEmptyComponent={
          loading ? (
