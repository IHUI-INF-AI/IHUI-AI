...
export default {
  ...
  settings: {
    ...
    notifMessage: 'Message alerts',
    notifEmail: 'Email notifications',
    changePassword: 'Change password',
    oldPassword: 'Old password',
    newPassword: 'New password',
    confirmPassword: 'Confirm password',
    pwdFieldsRequired: 'Please fill all password fields',
  ...
  taskDispatch: {
    ...
    file: {
      attach: 'Attach',
      attached: 'Attached: {{filename}} ({{size}})',
      tooLarge: 'File too large (limit 1MB)',
      download: 'Download attachment',
      downloadSuccess: 'Downloaded {{filename}}',
      downloadFailed: 'Download failed',
      invalidBase64: 'Invalid base64 content',
      missingFilename: 'Please provide filename',
      filenamePlaceholder: 'Filename, e.g. notes.txt',
      mimePlaceholder: 'MIME type, e.g. text/plain',
      contentPlaceholder: 'Base64 content',
    },
  },
}
