...
export function AgentRuntimePanel({ agentId }: AgentRuntimePanelProps) {
  ...
  const [approvalState, setApprovalState] = useState<'idle' | 'submitting' | 'sent' | 'failed'>('idle')
  ...
  const planSteps = useMemo<RenderPlanStep[]>(
          ...
          <section className="px-2.5 py-2 border border-warning rounded-md text-xs bg-warning/10">
            ...
            <div className="flex items-center gap-1.5 mt-2">
              <button
                ...
                disabled={!permission.approvalId || approvalState === 'submitting' || approvalState === 'sent'}
