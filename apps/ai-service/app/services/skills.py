...
from __future__ import (
    annotations,  # 2026-07-23:SkillRegistry.list() 方法名 shadow 内置 list,注解 lazy 化避免 class body 内 list[Skill] 求值失败
)
...
class SkillRegistry:
    ...
    def _load_auto_skills(self) -> None:
        ...
        self.last_reload = datetime.now(UTC).timestamp()
...
class SkillEvolutionService:
    ...
    def _render_skill_md(
        ...
        return (
            ...
            "license: MIT\n"
            "source: auto\n"
            f"autoGeneratedAt: {datetime.now(UTC).isoformat()}\n"
