...
def build_handoff(session_ctx: dict[str, Any], **kwargs: Any) -> HandoffPacket:
...
def apply_handoff(handoff: HandoffPacket, **kwargs: Any) -> dict[str, Any]:
    """Convenience wrapper over SessionHandoff.apply_handoff (see class docs)."""
    return session_handoff.apply_handoff(handoff, **kwargs)


def recommend_with_cost(handoff: HandoffPacket, ledger: Any = None) -> list[dict[str, Any]]:
