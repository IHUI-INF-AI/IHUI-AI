...
_CREATOR_URL = "https://baijiahao.baidu.com"
_EDIT_URL = "https://baijiahao.baidu.com/builder/rc/edit?type=news"
_TITLE_SELECTOR = 'input.article-title, #articleTitle'
        ...
        try:
            async with async_playwright() as p:
                ...
                try:
                    ...
                    published = False
                    if "/edit" not in page.url and "login" not in page.url.lower():
                        published = True
