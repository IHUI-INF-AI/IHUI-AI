...
凭证:{ SCF, ALF, SUB } — 均为 .sina.com.cn 域 cookie
...
class SinaAdapter(PlaywrightBaseAdapter):
    """新浪看点适配器。"""
    ...
    home_url = "https://mp.sina.com.cn"
    create_url = "https://mp.sina.com.cn/editor/article"
    ...
    cookie_specs = [
        CookieSpec("SCF", ".sina.com.cn"),
        CookieSpec("ALF", ".sina.com.cn"),
        CookieSpec("SUB", ".sina.com.cn", http_only=True),
    ]
    primary_cookie = "SUB"
