  ...
  <view class="popular-courses-container">
    <view class="popular-courses-title">
      <view class="popular-courses-title-text">
        <view class="popular-courses-title-text-icon">
          <image
            :src="'https://mp-aab956eb-2e97-4b81-823e-69195b354e49.cdn.bspapp.com/tabbar/home/zhongxia/popular-courser.png'"
            mode="aspectFill"
            style="width: 100%; height: 100%"
          >
          </image>
        </view>
        <text class="popular-courses-title-text-text">热门课程</text>
      </view>

      <view class="popular-courses-more">
        <text class="popular-courses-more-text" @click="handleMoreClick"
          >查看全部</text
        >
        <view class="popular-courses-more-arrow">
          <image
            :src="'https://mp-aab956eb-2e97-4b81-823e-69195b354e49.cdn.bspapp.com/tabbar/home/zhongxia/right-arrow.png'"
            mode="aspectFill"
            style="width: 100%; height: 100%"
          ></image>
        </view>
    ...
    <view class="popular-courses-tab-box">
      ...
      <view class="popular-courses-nav-img">
        <image
          :src="'https://mp-aab956eb-2e97-4b81-823e-69195b354e49.cdn.bspapp.com/tabbar/home/zhongxia/popular-courses-nav.png'"
          mode="aspectFill"
          style="width: 100%; height: 100%"
        >
        </image>
...
import PopularCoursesList1 from './PopularCoursesList1.vue'
import PopularCoursesList2 from './PopularCoursesList2.vue'
