    ...
    <view style="display: flex; align-items: center; position: relative"
      ...
      <view v-if="dual"  class="back back-right-moved" :style="{ width: paddingRightWidth }">
        ...
        <view v-if="image" class="back-box" style="width: 48rpx; height: 48rpx; display: flex; align-items: center; justify-content: center; overflow: hidden;">
          <image class="backi-img" mode="aspectFill" style="width: 30rpx; height: 48rpx;" :src="image" @click="packClick"></image>
        </view>
      ...
      <view v-else class="back-bak back-right-moved">
        <image v-if="image" mode="heightFix" style="width: 34rpx; height: 48rpx;padding: 0 20rpx;" :src="image" @click="packClick">
        </image>
        <image
        v-if="showFenLei"
        @click="handleNavClick" style="width: 40rpx;height: 40rpx;margin-left: 5rpx;"
      ...
      <view class="center-row-absolute">
        <image :src="logo" mode="widthFix" style="width: 40rpx;height: 40rpx;margin-right: 10rpx;"></image>
  ...
  <view v-else :style="{ height: topBarHeight }">
    ...
    <view style="display: flex; justify-content: space-between; align-items: center"
      ...
      <view :style="{ width: paddingRightWidth }">
        <image v-if="image" mode="aspectFill" style="width: 30rpx; height: 30rpx" :src="image" @click="packClick">
        </image>
      </view>
