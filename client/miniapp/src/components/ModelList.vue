<template>
  <view v-if="sourceIs" class="chu-box model-list-container" style="bottom: calc(100% + 20rpx); top: auto;">
        ...
        <view class="chu_row_wn" v-if="currentModelType === 'talk'">
          ...
          <view 
            ...
            <view class="chu-row-left">
              <view class="image_logo">
                <image
                  src="/static/images/default/mian_label.png"
                  class="chu-icon"></image>
              </view>
              <view class="chu-text" style="margin-left: 18rpx;">
                Agent模式
              </view>
              <image src="/static/images/default/mian_label.png" class="chu-power" mode="widthFix">
              </image>
            </view>
          ...
          <view 
            ...
            <view class="chu-row-left">
              ...
              <image v-if="0 === index" src="/static/images/default/rankone.png" class="chu-power" mode="widthFix">
              </image>
              <image src="/static/images/default/mian_label.png" class="chu-power" mode="widthFix">
              </image>
              <image v-if="item.is_new == 1" src="/static/images/xtk/new.png" class="chu-power" mode="widthFix">
              </image>
            </view>
            <view class="chu-row-right">
...
watch(
  ...
  (arr) => {
    ...
    protoList.value.forEach(item => {
      ...
      if (item.type == 5) {
        _videoaList.push(item)
      }
    })
    
    _talkList.sort((a, b) => (b.is_top || 0) - (a.is_top || 0))
    _imageList.sort((a, b) => (b.is_top || 0) - (a.is_top || 0))
    _videoList.sort((a, b) => (b.is_top || 0) - (a.is_top || 0))
    _videoaList.sort((a, b) => (b.is_top || 0) - (a.is_top || 0))
    _audioList.sort((a, b) => (b.is_top || 0) - (a.is_top || 0))
    _otherList.sort((a, b) => (b.is_top || 0) - (a.is_top || 0))
    
    talkList.value = _talkList
    imageList.value = _imageList
    videoList.value = _videoList
    videoaList.value = _videoaList
    audioList.value = _audioList
    otherList.value = _otherList
  },
  { immediate: true }
)
