  ...
  <view class="personal-card">
    <view class="personal-card-title">
      <view style="
        ...
        ">
        <view class="nickname">
          <image src="/static/images/3_01.png" mode="heightFix"></image>
          <view class="nickname_text">{{ user.thirdPartyAccounts.nickname }}</view>
          <image src="/static/images/3_03.png" mode="heightFix"></image>
...
.personal-card {
  width: 750rpx;
  height: 444rpx;
  background-image: url("/static/images/bjcspNew.png");
  ...
  .nickname {
    ...
    position: relative;
    .nickname_text{
      background: url('/static/images/3_02.png') repeat-x;
