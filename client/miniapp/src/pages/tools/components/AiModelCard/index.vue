    ...
    <view class="card_body">
        <view class="top">
            ...
            <view class="top_footer" style="margin-top: 30rpx;" v-if="root == 'group'">
                ...
                <view class="footer-right">
                    <image class="icons" src="/static/images/warning.png" mode="widthFix" />
                    <image class="icons" src="/static/images/unlike.png" mode="widthFix" />
                    <image class="icons" src="/static/images/unstore.png" mode="widthFix" />
                    <image class="icons" src="/static/images/uninfo.png" mode="widthFix" />
                    <image class="icons" src="/static/images/unshare.png" mode="widthFix" />
        ...
        <view class="top_footer-model" v-if="root == 'model'">
            <view class="top_footer-model-image_body">
                <image class="top_footer-model-image" src="/static/images/model_card_btn_bg.png" mode="widthFix" lazy-load="false"></image>
