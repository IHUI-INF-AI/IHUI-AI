...
async function listFallback(apiName: string, params: ListParams = {}): Promise<ApiResponse<PaginationResponse<unknown>>> {
  ...
  return {
    ...
    success: true,
    timestamp: Date.now(),
  } as unknown as ApiResponse<PaginationResponse<unknown>>
}
...
const rawAdminApi = {
  ...
  // === 课程/学习 ===
  learnLessonList: (params: ListParams = {}) => http.get<ApiResponse<PaginationResponse<unknown>>>('/admin/learn/lesson/list', { params }),
  learnLessonTrash: (params: ListParams = {}) => http.get<ApiResponse<PaginationResponse<unknown>>>('/admin/learn/lesson/trash', { params }),
  learnCategoryList: (params: ListParams = {}) => http.get<ApiResponse<unknown[]>>('/admin/learn/category/list', { params }),
  learnCategoryTree: () => http.get<ApiResponse<unknown[]>>('/admin/learn/category/tree'),
  learnMapList: (params: ListParams = {}) => http.get<ApiResponse<PaginationResponse<unknown>>>('/admin/learn/map/list', { params }),
  learnTopicList: (params: ListParams = {}) => http.get<ApiResponse<PaginationResponse<unknown>>>('/admin/learn/topic/list', { params }),
  learnTopicCategoryList: (params: ListParams = {}) => http.get<ApiResponse<unknown[]>>('/admin/learn/topic/category/list', { params }),
  learnOrderList: (params: ListParams = {}) => http.get<ApiResponse<PaginationResponse<unknown>>>('/admin/learn/order/list', { params }),
  learnOrderInvoiceTitle: (params: ListParams = {}) => http.get<ApiResponse<PaginationResponse<unknown>>>('/admin/learn/order/invoice-title', { params }),
  learnOrderInvoiceApplication: (params: ListParams = {}) => http.get<ApiResponse<PaginationResponse<unknown>>>('/admin/learn/order/invoice-application', { params }),
  learnSignupList: (params: ListParams = {}) => http.get<ApiResponse<PaginationResponse<unknown>>>('/admin/learn/signup/list', { params }),
  learnReportLesson: (params: ListParams = {}) => http.get<ApiResponse<unknown>>('/admin/learn/report/lesson', { params }),
  learnReportMember: (params: ListParams = {}) => http.get<ApiResponse<unknown>>('/admin/learn/report/member', { params }),
  ...
  // 课程/学习
  learnCategoryCreate: (payload: Record<string, unknown>) => http.post<ApiResponse<unknown>>('/admin/learn/category', payload),
  learnCategoryUpdate: (id: string | number, payload: Record<string, unknown>) => http.put<ApiResponse<unknown>>(`/admin/learn/category/${id}`, payload),
  learnCategoryDelete: (id: string | number) => http.delete<ApiResponse<void>>(`/admin/learn/category/${id}`),
  learnMapCreate: (payload: Record<string, unknown>) => http.post<ApiResponse<unknown>>('/admin/learn/map', payload),
  learnMapUpdate: (id: string | number, payload: Record<string, unknown>) => http.put<ApiResponse<unknown>>(`/admin/learn/map/${id}`, payload),
  learnMapDelete: (id: string | number) => http.delete<ApiResponse<void>>(`/admin/learn/map/${id}`),
  learnTopicCreate: (payload: Record<string, unknown>) => http.post<ApiResponse<unknown>>('/admin/learn/topic', payload),
  learnTopicUpdate: (id: string | number, payload: Record<string, unknown>) => http.put<ApiResponse<unknown>>(`/admin/learn/topic/${id}`, payload),
  learnTopicDelete: (id: string | number) => http.delete<ApiResponse<void>>(`/admin/learn/topic/${id}`),
  learnTopicCategoryCreate: (payload: Record<string, unknown>) => http.post<ApiResponse<unknown>>('/admin/learn/topic/category', payload),
  learnTopicCategoryUpdate: (id: string | number, payload: Record<string, unknown>) => http.put<ApiResponse<unknown>>(`/admin/learn/topic/category/${id}`, payload),
  ...
  learnCategoryBatchDelete: (ids: (string | number)[]) =>
    http.post<ApiResponse<{ success: number; failed: number }>>('/admin/learn/category/batch-delete', { ids }),
  /** P23.4: 批量删除 */
  learnMapBatchDelete: (ids: (string | number)[]) =>
    http.post<ApiResponse<{ success: number; failed: number }>>('/admin/learn/map/batch-delete', { ids }),
  /** P23.4: 批量删除 */
  learnTopicBatchDelete: (ids: (string | number)[]) =>
    http.post<ApiResponse<{ success: number; failed: number }>>('/admin/learn/topic/batch-delete', { ids }),
  /** P23.4: 批量删除 */
