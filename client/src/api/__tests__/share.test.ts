...
describe('share', () => {
  ...
  it('generateShareLink 应能正常调用', async () => {
    const fn = (api as any).generateShareLink
  ...
  it('recordShare 应能正常调用', async () => {
    const fn = (api as any).recordShare
    expect(typeof fn).toBe('function')
    try {
      const result = await fn()
      expect(result).toBeDefined()
  ...
  it('getShareStats 应能正常调用', async () => {
    const fn = (api as any).getShareStats
    expect(typeof fn).toBe('function')
    try {
      const result = await fn()
      expect(result).toBeDefined()
  ...
  it('getWechatShareConfig 应能正常调用', async () => {
    const fn = (api as any).getWechatShareConfig
    expect(typeof fn).toBe('function')
    try {
      const result = await fn()
      expect(result).toBeDefined()
