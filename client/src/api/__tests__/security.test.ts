...
import * as api from '../system/security'
...
describe('security', () => {
  ...
  it('trustDevice 应能正常调用', async () => {
    const fn = (api as any).trustDevice
    expect(typeof fn).toBe('function')
    try {
      const result = await fn()
      expect(result).toBeDefined()
  ...
  it('getLoginHistory 应能正常调用', async () => {
    const fn = (api as any).getLoginHistory
    expect(typeof fn).toBe('function')
    try {
      const result = await fn()
      expect(result).toBeDefined()
  ...
  it('terminateSession 应能正常调用', async () => {
    const fn = (api as any).terminateSession
    expect(typeof fn).toBe('function')
    try {
      const result = await fn()
      expect(result).toBeDefined()
  ...
  it('terminateAllOtherSessions 应能正常调用', async () => {
    const fn = (api as any).terminateAllOtherSessions
    expect(typeof fn).toBe('function')
    try {
      const result = await fn()
      expect(result).toBeDefined()
  ...
  it('bindEmail 应能正常调用', async () => {
    const fn = (api as any).bindEmail
    expect(typeof fn).toBe('function')
    try {
      const result = await fn()
      expect(result).toBeDefined()
  ...
  it('unbindEmail 应能正常调用', async () => {
    const fn = (api as any).unbindEmail
    expect(typeof fn).toBe('function')
    try {
      const result = await fn()
      expect(result).toBeDefined()
  ...
  it('bindPhone 应能正常调用', async () => {
    const fn = (api as any).bindPhone
    expect(typeof fn).toBe('function')
    try {
      const result = await fn()
      expect(result).toBeDefined()
  ...
  it('unbindPhone 应能正常调用', async () => {
    const fn = (api as any).unbindPhone
    expect(typeof fn).toBe('function')
    try {
      const result = await fn()
      expect(result).toBeDefined()
