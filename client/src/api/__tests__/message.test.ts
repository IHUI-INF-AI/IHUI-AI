...
describe('message', () => {
  ...
  it('getMessages 应能正常调用', async () => {
    const fn = (api as any).getMessages
  ...
  it('getMessageStats 应能正常调用', async () => {
    const fn = (api as any).getMessageStats
    expect(typeof fn).toBe('function')
    try {
      const result = await fn()
      expect(result).toBeDefined()
  ...
  it('markMessageAsRead 应能正常调用', async () => {
    const fn = (api as any).markMessageAsRead
    expect(typeof fn).toBe('function')
    try {
      const result = await fn()
      expect(result).toBeDefined()
  ...
  it('markMessagesAsRead 应能正常调用', async () => {
    const fn = (api as any).markMessagesAsRead
    expect(typeof fn).toBe('function')
    try {
      const result = await fn()
      expect(result).toBeDefined()
  ...
  it('deleteMessages 应能正常调用', async () => {
    const fn = (api as any).deleteMessages
    expect(typeof fn).toBe('function')
    try {
      const result = await fn()
      expect(result).toBeDefined()
  ...
  it('markAllAsRead 应能正常调用', async () => {
    const fn = (api as any).markAllAsRead
    expect(typeof fn).toBe('function')
    try {
      const result = await fn()
      expect(result).toBeDefined()
