...
export function createWebSocketConnection(
  ...
  // 2026-06-29 联调: 对齐后端实际 WS 端点 /ws/user/{user_uuid} (app/api/ws/public_socket.py)
  // 走 vite /ws 代理转发, 不再走不存在的 /api/v1/ws/chat/{userUuid}
  const wsUrl = `${protocol}//${host}/ws/user/${userUuid}`
