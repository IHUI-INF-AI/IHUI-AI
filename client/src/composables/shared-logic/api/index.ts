...
export function get<T = any>(url: string, data?: unknown): Promise<ApiResponse<T>> {
  return request({ url, method: 'GET', data })
}

export function post<T = any>(url: string, data?: unknown): Promise<ApiResponse<T>> {
  return request({ url, method: 'POST', data })
}

export function put<T = any>(url: string, data?: unknown): Promise<ApiResponse<T>> {
  return request({ url, method: 'PUT', data })
}

export function del<T = any>(url: string, data?: unknown): Promise<ApiResponse<T>> {
