...
:where(.home-index-page) {
 ...
 @media (width <= 768px) { grid-template-columns: 1fr; } }
  ...
  .quick-icon { width: 48px; height: 48px; border-radius: var(--global-border-radius); display: flex; align-items: center; justify-content: center; color: var(--app-button-text-on-primary); /* 2026-07-04 修复: var(--el-bg-color) 是背景 token, 误用作文字色 */ }
 ...
 @media (width <= 768px) { grid-template-columns: 1fr; } }
  ...
  .live-item { cursor: pointer; .live-thumb { position: relative; aspect-ratio: 16 / 9; border-radius: var(--global-border-radius); overflow: hidden; background: var(--el-fill-color-light); img { width: 100%; height: 100%; object-fit: cover; display: block; } } .live-status { position: absolute; top: 6px; left: 6px; background: var(--el-color-danger); color: var(--app-button-text-on-primary); /* 2026-07-04 修复: var(--el-bg-color) 是背景 token, 误用作文字色 */ padding: 2px 6px; border-radius: var(--global-border-radius); font-size: 12px; } .live-title { margin: 6px 0 2px; font-size: 13px; color: var(--el-text-color-primary); overflow: hidden; text-overflow: ellipsis; white-space: nowrap; } .live-host { margin: 0; font-size: 12px; color: var(--el-text-color-secondary); } &:hover { .live-title { color: var(--el-color-primary); } } }
