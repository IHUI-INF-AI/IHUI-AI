<template>
  <section id="about" class="about-section">
    ...
    <section class="section values-section">
      <div class="section-head">
        <span class="section-tag">{{ t('aboutUs.coreValues.tag') }}</span>
        <h2 class="section-title">{{ t('aboutUs.coreValues.title') }}</h2>
      </div>
      <div class="values-grid">
        <div v-for="v in coreValues" :key="v.id" class="value-card">
          <el-icon class="value-icon"><component :is="v.icon" /></el-icon>
