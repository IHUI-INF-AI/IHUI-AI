...
const columns: Column<any>[] = [
  ...
  { key: 'title', dataKey: 'title', title: '题目标题', width: 300 },
  { key: 'type', dataKey: 'type', title: '类型', width: 100 },
...
const reload = async () => {
  loading.value = true
  try {
    const res = await adminApi.examQuestionList({ current: page.value, size: size.value, keyword: keyword.value })
