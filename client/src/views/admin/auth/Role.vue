...
const formFields: FormField[] = [
  { prop: 'name', label: t('adminCommon.label.roleName'), required: true, minLength: 1, maxLength: 50 },
  { prop: 'code', label: t('adminCommon.label.roleCode'), required: true, minLength: 2, maxLength: 50, pattern: '^[a-zA-Z][a-zA-Z0-9_]*$', patternMessage: t('adminCommon.label.codePatternMsg') },
]
...
const columns: Column<unknown>[] = [
  ...
  { key: 'name', dataKey: 'name', title: t('adminCommon.label.roleName'), width: 180 },
  { key: 'code', dataKey: 'code', title: t('adminCommon.label.roleCode'), width: 180 },
  { key: 'userCount', dataKey: 'userCount', title: t('adminCommon.label.memberCountInRole'), width: 100 },
  {
    key: 'actions',
    title: '操作',
    width: 180,
