...
const formFields: FormField[] = [
  { prop: 'name', label: '分组名称', required: true, minLength: 1, maxLength: 50 },
]
...
const columns: Column<any>[] = [
  ...
  { key: 'name', dataKey: 'name', title: '分组名称', width: 180 },
  { key: 'memberCount', dataKey: 'memberCount', title: '成员数', width: 100 },
