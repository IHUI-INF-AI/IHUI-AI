...
const formFields: FormField[] = [
  { prop: 'name', label: '企业名称', required: true, minLength: 1, maxLength: 50 },
  { prop: 'type', label: '类型', maxLength: 200 },
  { prop: 'scale', label: '规模', maxLength: 200 },
]
...
const columns: Column<any>[] = [
  ...
  { key: 'name', dataKey: 'name', title: '企业名称', width: 220 },
  { key: 'type', dataKey: 'type', title: '类型', width: 120 },
  { key: 'scale', dataKey: 'scale', title: '规模', width: 120 },
  {
    key: 'actions',
    title: '操作',
    width: 180,
