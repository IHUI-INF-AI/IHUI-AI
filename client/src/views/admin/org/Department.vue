...
const formFields: FormField[] = [
  { prop: 'name', label: '部门名称', required: true, minLength: 1, maxLength: 50 },
  { prop: 'manager', label: '负责人', maxLength: 200 },
]
...
const columns: Column<any>[] = [
  ...
  { key: 'name', dataKey: 'name', title: '部门名称', width: 180 },
  { key: 'manager', dataKey: 'manager', title: '负责人', width: 140 },
