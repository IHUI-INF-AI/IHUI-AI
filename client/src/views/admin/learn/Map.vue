...
const formFields: FormField[] = [
  { prop: 'name', label: '路径名称', required: true, minLength: 1, maxLength: 50 },
  { prop: 'lessonCount', label: '课程数', type: 'number', min: 0, max: 999 },
]
...
const columns: Column<any>[] = [
  ...
  { key: 'name', dataKey: 'name', title: '路径名称', width: 220 },
