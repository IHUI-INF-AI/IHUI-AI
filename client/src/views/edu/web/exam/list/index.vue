<template>
  <div class="content-list-container">
    ...
    <div class="content-list">
      <rectangle link="/exam/detail" v-for="item in itemList" :key="item.id" width="calc(25% - 20px);" :item="item" class="content-item"/>
...
<script>
  ...
  import {getExamList} from "@/api/edu/web/exam"
