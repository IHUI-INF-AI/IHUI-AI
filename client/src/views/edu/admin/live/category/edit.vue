  ...
  <div class="app-container">
    <el-form ref="categoryRef" :rules="rules" :model="category" label-width="120px">
      ...
      <el-form-item label="是否显示" prop="isShow">
        <el-switch id="isShow" active-color="#13ce66" v-model="category.isShow"></el-switch>
      </el-form-item>
      <el-form-item label="是否在首页显示" prop="isShowIndex">
        <el-switch id="isShowIndex" active-color="#13ce66" v-model="category.isShowIndex"></el-switch>
      </el-form-item>
    </el-form>
