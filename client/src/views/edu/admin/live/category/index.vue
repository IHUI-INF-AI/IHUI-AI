        ...
        <Card class="box-card">
          <CardHeader>
            <div class="category-head clearfix">
              ...
              <Button variant="outline" size="sm" className="category-btn" v-if="type !== 'edit' && category.id" @click="addChildren(category.id)">新增子类目</Button>
              <Button variant="outline" size="sm" className="category-btn" v-if="type !== 'edit' && category.id" @click="edit(category.pid, category)">编辑</Button>
              <Button variant="outline" size="sm" className="category-btn" v-if="type !== 'edit' && category.id" @click="remove(category)">删除</Button>
              <Button variant="outline" size="sm" className="category-btn" v-if="type !== 'edit'" @click="add(category.pid)">新增同级类目</Button>
            </div>
          </CardHeader>
              <CardContent>
          <!-- 详情 -->
...
const { getCategory, removeCategory } = liveApi;
