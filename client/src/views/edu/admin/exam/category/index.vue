        ...
        <el-card class="box-card">
          <template #header>
            <div class="category-head clearfix">
              ...
              <el-button size="small" class="category-btn" v-if="type !== 'edit' && category.id" @click="addChildren(category.id)">新增子分类</el-button>
              ...
              <el-button size="small" class="category-btn" v-if="type !== 'edit'" @click="add(category.pid)">新增同级分类</el-button>
            </div>
          </template>
          <!-- 详情 -->
