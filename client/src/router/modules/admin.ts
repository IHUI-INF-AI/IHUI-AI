...
export const adminRoutes: Array<RouteRecordRaw> = [
  ...
  // P12 admin 后台迁移
  {
    ...
    children: [
      ...
      { path: 'notification-center', name: 'adminNotificationCenter', component: safeImport(() => import('@/views/admin/NotificationCenter.vue'), 'adminNotificationCenter'), meta: { title: 'routes.adminNotificationCenter', description: 'seo.adminNotificationCenter.desc', keywords: 'seo.adminNotificationCenter.keywords' } },
      { path: 'agent-management', name: 'adminAgentManagement', component: safeImport(() => import('@/views/admin/AgentManagement.vue'), 'adminAgentManagement'), meta: { title: 'routes.adminAgentManagement', description: 'seo.adminAgentManagement.desc', keywords: 'seo.adminAgentManagement.keywords' } },
      { path: 'ai-capability-management', name: 'adminAiCapabilityManagement', component: safeImport(() => import('@/views/admin/AiCapabilityManagement.vue'), 'adminAiCapabilityManagement'), meta: { title: 'routes.adminAiCapabilityManagement', description: 'seo.adminAiCapabilityManagement.desc', keywords: 'seo.adminAiCapabilityManagement.keywords' } },
      { path: 'content-management', name: 'adminContentManagement', component: safeImport(() => import('@/views/admin/ContentManagement.vue'), 'adminContentManagement'), meta: { title: 'routes.adminContentManagement', description: 'seo.adminContentManagement.desc', keywords: 'seo.adminContentManagement.keywords' } },
      { path: 'auth-management', name: 'adminAuthManagement', component: safeImport(() => import('@/views/admin/AuthManagement.vue'), 'adminAuthManagement'), meta: { title: 'routes.adminAuthManagement', description: 'seo.adminAuthManagement.desc', keywords: 'seo.adminAuthManagement.keywords' } },
      { path: 'rbac-management', name: 'adminRbacManagement', component: safeImport(() => import('@/views/admin/AdminRbacManagement.vue'), 'adminRbacManagement'), meta: { title: 'routes.adminRbacManagement', description: 'seo.adminRbacManagement.desc', keywords: 'seo.adminRbacManagement.keywords' } },
      { path: 'business-management', name: 'adminBusinessManagement', component: safeImport(() => import('@/views/admin/BusinessManagement.vue'), 'adminBusinessManagement'), meta: { title: 'routes.adminBusinessManagement', description: 'seo.adminBusinessManagement.desc', keywords: 'seo.adminBusinessManagement.keywords' } },
      { path: 'course-category-management', name: 'adminCourseCategoryManagement', component: safeImport(() => import('@/views/admin/CourseCategoryManagement.vue'), 'adminCourseCategoryManagement'), meta: { title: 'routes.adminCourseCategoryManagement', description: 'seo.adminCourseCategoryManagement.desc', keywords: 'seo.adminCourseCategoryManagement.keywords' } },
