...
const AUTHED_ROUTES: Array<[string, string]> = [
  ...
  ['/admin/exam/list', 'ID'],
  ['/admin/exam/paper', 'ID'],
  ['/admin/exam/paper-mock', 'ID'],
  ['/admin/exam/paper-normal', 'ID'],
  ['/admin/exam/paper-random', 'ID'],
  ['/admin/exam/paper-category', 'ID'],
  ['/admin/exam/question', 'ID'],
  ['/admin/exam/question-category', 'ID'],
  ['/admin/exam/question-single', 'ID'],
  ['/admin/exam/question-multi', 'ID'],
  ['/admin/exam/question-judgment', 'ID'],
  ['/admin/exam/question-fill', 'ID'],
  ['/admin/exam/question-subjective', 'ID'],
  ['/admin/exam/answer', 'ID'],
  ['/admin/exam/answer-detail', 'ID'],
]
