...
- [ ] 📋(2026-07-15) audit P1-frontend: admin/exam 题库试卷系列 13 页(单选/多选/判断/填空/主观题+模拟/普通/随机试卷)
- [ ] 📋(2026-07-15) audit P1-frontend: SettlementManager 结算管理 + admin/WithdrawalList 提现审批
- [ ] 📋(2026-07-15) audit P1-frontend: Statistics 用户数据统计页
- [ ] 📋(2026-07-15) audit P1-frontend: admin 各业务分类管理 6 页(ask/circle/article/resource/live/learn Category)
- [ ] 📋(2026-07-15) audit P1-frontend: admin 会员运营 3 页(member Level/Company/Unaudited)
- [ ] 📋(2026-07-15) audit P1-frontend: admin 运营配置 5 页(point Record/Channel,comment Sensitive,search Hot,aiworld Site)
- [ ] 📋(2026-07-15) audit P1-frontend: member/Fans 我的粉丝页
- [ ] 📋(2026-07-15) audit P1-components: OpenClaw 面板套件 8 组件(AI平台核心扩展能力)
- [ ] 📋(2026-07-15) audit P1-components: DramaScriptExcel UI层 13 组件(hook已迁移,UI缺失)
- [ ] 📋(2026-07-15) audit P1-components: 高级主题系统 ~25 文件(预设/转场/快捷键/同步等)
- [ ] 📋(2026-07-15) audit P1-backend: video_preload 视频预加载分片管理补全
- [ ] 📋(2026-07-15) audit P1-backend: user_agent_image 用户Agent图片CRUD补全
- [ ] 📋(2026-07-15) audit P1-backend: user_video_comment 用户端评论CRUD补全
- [ ] 📋(2026-07-15) audit P1-backend: bots Bot CRUD+聊天流程对齐
- [ ] 📋(2026-07-15) audit P1-backend: docs API文档自动生成补全
- [ ] 📋(2026-07-15) audit P1-backend: crew 多智能体协作(确认ai-service是否替代)
- [ ] 📋(2026-07-15) audit P1-backend: service_catalog 服务注册发现

#### P2 缺失(可选补齐 — AI能力扩展,~15 项)

- [ ] 📋(2026-07-15) audit P2: AgenticDashboard/AgenticAIPage/AIAssistant/N8NAssistant/N8NAgents/Variables/Tasks/DesignerAgent
- [ ] 📋(2026-07-15) audit P2: AiWorldBannerDetail/WebView/Forbidden(403)
- [ ] 📋(2026-07-15) audit P2: Monaco代码编辑器/EnhancedPdfViewer/PDF标注
- [ ] 📋(2026-07-15) audit P2: 全局命令面板/高级搜索/敏感操作确认对话框

#### P3 不补齐(Demo/展示/架构决策,~30 项)

- DesignSystemDemo/ComponentShowcase/AizhsDemo/BusinessDocs(开发工具)
- admin运维监控系列(BackendHealth/DatabaseOptimization/DependencyManager等)
- p19/p20演示页
- uniCloud云函数/uni_modules(架构变更,Taro替代)
- 多数据源路由/跨源同步(架构变更,单库无需)
- WangEditor/Tinymce(已被markdown-utils替代)
- 数据修复脚本/日志文件(一次性产物)
...
2. 导入 `{ testDb, closeTestDb, resetTestDb }` from `./helpers/test-db`
