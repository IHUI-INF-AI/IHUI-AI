...
- [ ] mypy 防回归守门(scripts/check-mypy.mjs + guardian-runner #35)— 防止 ai-service Python 类型回退(批次 4 mypy 全库清零 256→0 errors/226 files 成果防回退);任务描述原要求 id '31',但 '31' 已被 verify-auth-shell.mjs 占用('34' 也被 check-ts-ignore.mjs 占用),故用下一个可用编号 '35'
