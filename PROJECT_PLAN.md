...
#### P2 缺失(可选补齐 — AI能力扩展,~15 项)✅(2026-07-15) 残留风险已处理 / goal
...
- [ ] 📋(2026-07-15) audit P2: AgenticDashboard/AgenticAIPage/AIAssistant/N8NAssistant/N8NAgents/Variables/Tasks/DesignerAgent(未开始,可选)
- [ ] 📋(2026-07-15) audit P2: AiWorldBannerDetail/WebView/Forbidden(403)(未开始,可选)
- [ ] 📋(2026-07-15) audit P2: Monaco代码编辑器/EnhancedPdfViewer/PDF标注(未开始,可选)
- [ ] 📋(2026-07-15) audit P2: 全局命令面板/高级搜索/敏感操作确认对话框(未开始,可选)
