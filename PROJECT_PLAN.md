...
- [ ] O3 `/v1` 全端点族补 `requireCapability`（assistants/threads/batches/responses/mcp-gateway/midjourney/rerank-moderations/protocol-*/realtime/shared）+ `v1-codebase-search`/`v1-apply-diff` 从 JWT-only 改为认 API Key
